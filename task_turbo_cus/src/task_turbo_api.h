...
/* hook */
int tt_vip_algo(int ct_vip_qualified, int launch_vip_qualified, int inputDispatcher_tgid, int systemui_tgid, int surfaceFlinger_tgid, bool touching);
extern int (*tt_vip_algo_hook)(int, int, int, int, int, bool);
...
extern unsigned long get_tgid_util(int tgid);
extern bool is_util_overhigh(unsigned long util);
