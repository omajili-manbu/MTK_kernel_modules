...
extern struct misight_mievent *cdev_tevent_alloc(unsigned int eventid);
extern void cdev_tevent_destroy(struct misight_mievent *event);
extern int cdev_tevent_add_int(struct misight_mievent *event, const char *key, long value);
extern int cdev_tevent_add_str(struct misight_mievent *event, const char *key, const char *value);
extern int cdev_tevent_write(struct misight_mievent *event);
