...
#define MTK_POI_KTRACE_ADD_CSF(kbdev, code, group, queue, flags, info_val) \
	mtk_poi_ktrace_add_csf_wrap(kbdev, KBASE_KTRACE_CODE(code), group, queue, flags, info_val)
#define MTK_POI_KTRACE_ADD_CSF_KCPU(kbdev, code, queue, info_val1, info_val2) \
	mtk_poi_ktrace_add_csf_kcpu_wrap(kbdev, KBASE_KTRACE_CODE(code), queue, info_val1, info_val2)
...
void mtk_poi_ktrace_add_csf_kcpu_wrap(struct kbase_device *kbdev, enum kbase_ktrace_code code,
				...
				u64 info_val2);
#else /* CONFIG_MALI_MTK_POI_KTRACE */
#define MTK_POI_KTRACE_ADD_CSF(kbdev, code, group, queue, flags, info_val) \
	do {                                                                  \
		CSTD_UNUSED(kbdev);                                           \
		CSTD_NOP(code);                                               \
...
#define KBASE_KTRACE_ADD_CSF_GRP(kbdev, code, group, info_val)                         \
	do {                                                                           \
		...
		/* CONFIG_MALI_MTK_POI_KTRACE */                                       \
		MTK_POI_KTRACE_ADD_CSF(kbdev, code, __group, NULL, 0u, __info_val);    \
	} while (0)
...
#define KBASE_KTRACE_ADD_CSF_GRP_Q(kbdev, code, group, queue, info_val)                   \
	do {                                                                              \
		...
		/* CONFIG_MALI_MTK_POI_KTRACE */                                          \
		MTK_POI_KTRACE_ADD_CSF(kbdev, code, __group, __queue, 0u, __info_val);    \
	} while (0)
...
#define KBASE_KTRACE_ADD_CSF_KCPU(kbdev, code, queue, info_val1, info_val2)                     \
	do {                                                                                    \
		...
		/* CONFIG_MALI_MTK_POI_KTRACE */                                                \
		MTK_POI_KTRACE_ADD_CSF_KCPU(kbdev, code, __queue, __info_val1, __info_val2);    \
	} while (0)
