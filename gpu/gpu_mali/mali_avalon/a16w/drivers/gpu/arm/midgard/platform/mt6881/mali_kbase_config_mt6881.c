...
#define MTK_DVFS_STEP_LOW (2)
#define MTK_DVFS_STEP_MED (2)
#define MTK_DVFS_STEP_HIGH (2)
#define MTK_DVFS_ULTRA_STEP_LOW (5)
#define MTK_DVFS_ULTRA_STEP_MED (5)
#define MTK_DVFS_ULTRA_STEP_HIGH (5)
...
int mtk_platform_pm_init(struct kbase_device *kbdev)
{
    ...
    gpu_dvfs_status_reset_footprint();
		...
		if (mtk_common_ged_dvfs_update_platform_step_size(
				MTK_DVFS_STEP_LOW, MTK_DVFS_STEP_MED, MTK_DVFS_STEP_HIGH,
				MTK_DVFS_ULTRA_STEP_LOW, MTK_DVFS_ULTRA_STEP_MED, MTK_DVFS_ULTRA_STEP_HIGH) == 0)
			dev_info(kbdev->dev, "[GPU DVFS] update step size by platform: low(%d) med(%d) high(%d) ultra_low(%d) ultra_med(%d) ultra_high(%d)",
					MTK_DVFS_STEP_LOW, MTK_DVFS_STEP_MED, MTK_DVFS_STEP_HIGH,MTK_DVFS_ULTRA_STEP_LOW, MTK_DVFS_ULTRA_STEP_MED, MTK_DVFS_ULTRA_STEP_HIGH);
		else
