...
#if IS_ENABLED(CONFIG_MALI_MTK_POWER_RESET_MFG0)
...
#elif IS_ENABLED(CONFIG_MALI_MTK_POWER_RESET_MFG0)
		/* power off and on once to reset MFG0 */
		mfg0_pwr_reset();
...
#if IS_ENABLED(CONFIG_MIEV)
	mi_disp_mievent_report(MI_EVENT_GPU_SOFT_RESET_FAULT);
#endif
...
#if IS_ENABLED(CONFIG_MIEV)
		mi_disp_mievent_report(MI_EVENT_GPU_HARD_RESET_FAULT);
#endif
