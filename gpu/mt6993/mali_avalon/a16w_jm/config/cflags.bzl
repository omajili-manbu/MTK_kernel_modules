...
COPTS_KBASE = [
    ...
    "MALI_USE_CSF=0",
	"DEFAULT_PM_POWEROFF_TICK_SHADER=25",
    "MALI_RELEASE_NAME=\"r54p1-12eac0\"",
] + select({
    ...
    "//vendor/mediatek/kernel_modules/gpu/gpu_mali/mali_avalon/a16w_jm/config:mali_has_cl": ["MALI_HAS_CL=1"],
    "//conditions:default": ["MALI_HAS_CL=0"],
}) + select({
    "//vendor/mediatek/kernel_modules/gpu/gpu_mali/mali_avalon/a16w_jm/config:mali_has_gles": ["MALI_HAS_GLES=1"],
    "//conditions:default": ["MALI_HAS_GLES=0"],
}) + select({
    "//vendor/mediatek/kernel_modules/gpu/gpu_mali/mali_avalon/a16w_jm/config:mali_customer_release": ["MALI_CUSTOMER_RELEASE=0"],
    "//conditions:default": ["MALI_CUSTOMER_RELEASE=0"],
}) + select({
    "//vendor/mediatek/kernel_modules/gpu/gpu_mali/mali_avalon/a16w_jm/config:mali_expert_debug": ["MALI_KERNEL_TEST_API=1"],
