...
#define GDL_HW_CHECK_CONN_INFRA_VER(p_poll_okay, p_poll_ver)             \
	GDL_HW_POLL_ENTRY_VERBOSE(GPS_DL_CONN_INFRA_BUS,                 \
		...
		p_poll_okay, p_poll_ver, POLL_DEFAULT, (                 \
			...
			(*p_poll_ver == GDL_HW_CONN_INFRA_VER_MT6993))   \
	)
...
#define GDL_HW_CHECK_BGF_IP_VER(p_poll_okay, p_poll_ver)             \
	GDL_HW_POLL_ENTRY_VERBOSE(GPS_DL_GPS_BUS,                 \
		...
		p_poll_okay, p_poll_ver, (10 * POLL_DEFAULT2), (                 \
			...
			(*p_poll_ver == GDL_HW_BGF_VER_MT6993))   \
	)
...
/* NO need dump address list in V062*/
...
extern const struct gps_dl_hw_host_csr_dump_range * const g_gps_v06x_bgf_on_dump_range_ptr;
extern const int g_gps_v06x_bgf_on_dump_range_num;

extern const unsigned int * const g_gps_cirq_dump_range_ptr;
extern const int g_gps_cirq_dump_range_num;
