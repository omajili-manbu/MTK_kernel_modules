...
#define GPS_L5_USRT_APB_MCU_D2A2_ADDR                          (GPS_L5_USRT_APB_BASE + 0x0058)
#define GPS_L5_USRT_APB_MCU_D2A3_ADDR                          (GPS_L5_USRT_APB_BASE + 0x005C)
#define GPS_L5_USRT_APB_MCU_D2A4_ADDR                          (GPS_L5_USRT_APB_BASE + 0x0060)
#define GPS_L5_USRT_APB_MCU_D2A5_ADDR                          (GPS_L5_USRT_APB_BASE + 0x0064)
#define GPS_L5_USRT_APB_MCU_D2A6_ADDR                          (GPS_L5_USRT_APB_BASE + 0x0068)
#define GPS_L5_USRT_APB_MCU_D2A7_ADDR                          (GPS_L5_USRT_APB_BASE + 0x006C)
#define GPS_L5_USRT_APB_MCU_D2A8_ADDR                          (GPS_L5_USRT_APB_BASE + 0x0070)
