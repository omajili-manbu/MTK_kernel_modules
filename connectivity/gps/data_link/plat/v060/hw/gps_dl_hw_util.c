...
const struct gps_dl_hw_host_csr_dump_range g_gps_v06x_host_csr_dump_ranges[] = {
	{0xC0040101,  8}, /* core_prob1/2, MCU PC, LR, SP... */
	{0xC0040300,  1}, /*0xdb90002*/
	{0xC0040500,  1}, /*0xdb90003*/
	{0xC0040700,  1}, /*0xdb90004*/
	{0xC0040900,  4}, /*mcu_peri_busy, peri_busy...*/
	{0xC0040B00, 10}, /* AHB, AXI dbg */
	{0xC0040D20,  1}, /* debug pc log */
	{0xC0040F00,  1}, /* p2p vio status */
	{0xC0041100,  5}, /* axi2ahb cmd vio */
	{0xC004110F, 30}, /* mem status */
	{0xC0041940,  7}, /* AHB vdnr */
	{0xC0041980,  8}, /* AXI vdnr */
	{0xC0041B01, 13}, /* conn, gps, mcu */
	{0xC0041F00, 17}, /* BGF bus status */
	{0xC0042500,  8}, /* BGF DMA status */
};
...
const struct gps_dl_hw_host_csr_dump_range g_gps_v06x_bgf_on_dump_ranges[] = {
	{0x00300FC0,  1}, /* MET data */
	{0x00300E00,  32}, /* interrupt related */
	{0x00300E23,  1}, /* interrupt related */
};
const struct gps_dl_hw_host_csr_dump_range * const g_gps_v06x_bgf_on_dump_range_ptr =
	&g_gps_v06x_bgf_on_dump_ranges[0];
const int g_gps_v06x_bgf_on_dump_range_num = ARRAY_SIZE(g_gps_v06x_bgf_on_dump_ranges);

const unsigned int g_gps_cirq_dump_ranges[] = {
	0x40c28400, /* irq_src */
	0x40c2806c, /* reg_fiq */
	0x40c28070, /* reg_mask */
	0x40c280b0, /* reg_sens */
	0x40c280c0, /* reg_soft */
	0x40c280d0, /* fir_con */
	0x40c280e0, /* irq_astatus */
	0x40c281f4, /* dbg_sel */
	0x40c2840c, /* int_dis */
};

const unsigned int * const g_gps_cirq_dump_range_ptr =
	&g_gps_cirq_dump_ranges[0];
const int g_gps_cirq_dump_range_num = ARRAY_SIZE(g_gps_cirq_dump_ranges);
