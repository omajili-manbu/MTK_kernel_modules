...
#define GPS_USRT_APB_GPS_APB_DATA_ADDR                         (GPS_USRT_APB_BASE + 0x000)
#define GPS_USRT_APB_APB_CTRL_ADDR                             (GPS_USRT_APB_BASE + 0x004)
#define GPS_USRT_APB_APB_INTEN_ADDR                            (GPS_USRT_APB_BASE + 0x008)
#define GPS_USRT_APB_APB_STA_ADDR                              (GPS_USRT_APB_BASE + 0x00C)
#define GPS_USRT_APB_MONF_ADDR                                 (GPS_USRT_APB_BASE + 0x010)
#define GPS_USRT_APB_APB_DCODE_ADDR                            (GPS_USRT_APB_BASE + 0x01c)
#define GPS_USRT_APB_MCUB_A2DF_ADDR                            (GPS_USRT_APB_BASE + 0x020)
#define GPS_USRT_APB_MCUB_D2AF_ADDR                            (GPS_USRT_APB_BASE + 0x024)
#define GPS_USRT_APB_MCU_A2D0_ADDR                             (GPS_USRT_APB_BASE + 0x030)
#define GPS_USRT_APB_MCU_A2D1_ADDR                             (GPS_USRT_APB_BASE + 0x034)
#define GPS_USRT_APB_MCU_D2A0_ADDR                             (GPS_USRT_APB_BASE + 0x050)
#define GPS_USRT_APB_MCU_D2A1_ADDR                             (GPS_USRT_APB_BASE + 0x054)
#define GPS_USRT_APB_MCU_D2A2_ADDR                             (GPS_USRT_APB_BASE + 0x058)
#define GPS_USRT_APB_MCU_D2A3_ADDR                             (GPS_USRT_APB_BASE + 0x05C)
#define GPS_USRT_APB_MCU_D2A4_ADDR                             (GPS_USRT_APB_BASE + 0x060)
#define GPS_USRT_APB_MCU_D2A5_ADDR                             (GPS_USRT_APB_BASE + 0x064)
#define GPS_USRT_APB_MCU_D2A6_ADDR                             (GPS_USRT_APB_BASE + 0x068)
#define GPS_USRT_APB_MCU_D2A7_ADDR                             (GPS_USRT_APB_BASE + 0x06C)
#define GPS_USRT_APB_MCU_D2A8_ADDR                             (GPS_USRT_APB_BASE + 0x070)
