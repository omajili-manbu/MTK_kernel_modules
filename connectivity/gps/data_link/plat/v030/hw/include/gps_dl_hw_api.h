...
struct gps_dl_hw_usrt_status_struct {
	...
	unsigned int mcub_d2a_d2;
	unsigned int mcub_d2a_d3;
	unsigned int mcub_d2a_d4;
	unsigned int mcub_d2a_d5;
	unsigned int mcub_d2a_d6;
	unsigned int mcub_d2a_d7;
	unsigned int mcub_d2a_d8;
...
extern struct gps_dl_hw_usrt_status_struct g_gps_early_rec_usrt_status[GPS_DATA_LINK_NUM];
