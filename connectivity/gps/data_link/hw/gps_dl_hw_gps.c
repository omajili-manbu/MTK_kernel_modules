	...
	enum gps_dl_link_id_enum link_id, struct gps_dl_hw_usrt_status_struct *p)
{
	...
	p->mcub_d2a_d2 = GDL_HW_RD_GPS_REG(GPS_USRT_APB_MCU_D2A2_ADDR + offset);
	p->mcub_d2a_d3 = GDL_HW_RD_GPS_REG(GPS_USRT_APB_MCU_D2A3_ADDR + offset);
	p->mcub_d2a_d4 = GDL_HW_RD_GPS_REG(GPS_USRT_APB_MCU_D2A4_ADDR + offset);
	p->mcub_d2a_d5 = GDL_HW_RD_GPS_REG(GPS_USRT_APB_MCU_D2A5_ADDR + offset);
	p->mcub_d2a_d6 = GDL_HW_RD_GPS_REG(GPS_USRT_APB_MCU_D2A6_ADDR + offset);
	p->mcub_d2a_d7 = GDL_HW_RD_GPS_REG(GPS_USRT_APB_MCU_D2A7_ADDR + offset);
	p->mcub_d2a_d8 = GDL_HW_RD_GPS_REG(GPS_USRT_APB_MCU_D2A8_ADDR + offset);
	...
	enum gps_dl_link_id_enum link_id, struct gps_dl_hw_usrt_status_struct *p)
{
	...
	GDL_LOGXW(link_id,
		"mcub d2a flag=0x%08x, d0/1/2/3/4/5/6/7/8=0x%08x/0x%08x/0x%08x/0x%08x/0x%08x/0x%08x/0x%08x/0x%08x",
		p->mcub_d2a_flag, p->mcub_d2a_d0, p->mcub_d2a_d1, p->mcub_d2a_d2, p->mcub_d2a_d3,
		p->mcub_d2a_d4, p->mcub_d2a_d5, p->mcub_d2a_d6, p->mcub_d2a_d7, p->mcub_d2a_d8);
...
{
	GDL_LOGXE(link_id, "NOT SUPPORT ATF %d 0x%lx", is_cw_dsp, (unsigned long)bootup_info);
	return false;
}
