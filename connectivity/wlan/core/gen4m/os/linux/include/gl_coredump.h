...
#define COREDUMP_MAX_BLOCK_SZ_MEM_REGION	0x8
...
enum ENUM_COREDUMP_STATUS {
	ENUM_COREDUMP_NOT_TRIGGER = 0x0,
	ENUM_COREDUMP_TRIGGERED,
	ENUM_COREDUMP_ONGOING,
	ENUM_COREDUMP_STATUS_NUM
};
...
struct coredump_ctx {
	...
	u_int8_t enable;
	enum ENUM_COREDUMP_STATUS eCoredumpStatus;
...
void wifi_coredump_set_status(enum ENUM_COREDUMP_STATUS eStatus);
enum ENUM_COREDUMP_STATUS wifi_coredump_get_status(void);
...
static inline void wifi_coredump_set_status(
	enum ENUM_COREDUMP_STATUS eStatus) {}
static inline enum ENUM_COREDUMP_STATUS wifi_coredump_get_status(void)
{ return ENUM_COREDUMP_NOT_TRIGGER; }
