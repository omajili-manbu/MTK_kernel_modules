...
#define NL80211_VENDOR_SUBCMD_SET_FAST_ACS 52
...
enum MTK_WIFI_VENDOR_SUB_COMMAND {
	...
	MTK_SUBCMD_NAN_PASN_CONFIRM = 98,
...
int wlan_cfg80211_set_fast_acs(struct wiphy *wiphy,
		 struct wireless_dev *wdev, const void *data, int data_len);
// END WIFI_BugFixUpstream
