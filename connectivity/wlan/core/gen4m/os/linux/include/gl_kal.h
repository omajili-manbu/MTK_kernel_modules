...
#ifdef CFG_WON_NUM
#define KAL_WON_NUM CFG_WON_NUM
#else
#define KAL_WON_NUM 1
#endif
...
/* kalGetTput() use them, defined in adapter.h */
...
#define kalkStrtou64(cp, base, resp)       kstrtou64(cp, base, resp)
#define kalkStrtos64(cp, base, resp)       kstrtos64(cp, base, resp)
...
uint8_t kalQuery80211HeaderLength(void *prPacket);
