...
static void radiotap_fill_tsft(
	struct IEEE80211_RADIOTAP_INFO *p_radiotap_info, uint8_t *p_data)
{
	struct TSFT *p_tsft = (struct TSFT *)p_data;

	p_tsft->u8MacTime = (uint64_t)p_radiotap_info->u4Timestamp;
}
