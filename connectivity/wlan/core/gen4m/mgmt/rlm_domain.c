...
#if CFG_EXT_FEATURE
#define COUNTRY_PWR_MODE_6G_SUPPORT_TBL_USED \
				g_rCountryPwrMode6GSupport_Ext
#define COUNTRY_PWR_MODE_6G_SUPPORT_TBL_USED_SIZE \
				COUNTRY_PWR_MODE_6G_SUPPORT_TABLE_SIZE_EXT
#define COUNTRY_PWR_LMT_GROUPS_TBL_USED \
				arSupportCountryPowerLmtGrps_Ext
#define COUNTRY_PWR_LMT_GROUPS_TBL_USED_SIZE \
				COUNTRY_LIMIT_GROUP_EXT_NUM
#else
#define COUNTRY_PWR_MODE_6G_SUPPORT_TBL_USED \
				g_rCountryPwrMode6GSupport
#define COUNTRY_PWR_MODE_6G_SUPPORT_TBL_USED_SIZE \
				COUNTRY_PWR_MODE_6G_SUPPORT_TABLE_SIZE
#define COUNTRY_PWR_LMT_GROUPS_TBL_USED \
				arSupportCountryPowerLmtGrps
#define COUNTRY_PWR_LMT_GROUPS_TBL_USED_SIZE \
				COUNTRY_LIMIT_GROUP_NUM
#endif /* CFG_EXT_FEATURE */
/*******************************************************************************
 *                            P U B L I C   D A T A
 *******************************************************************************
 */
...
static const uint16_t g_u2CountryGroup0[] = {
	COUNTRY_CODE_AF, COUNTRY_CODE_BF, COUNTRY_CODE_BI, COUNTRY_CODE_BJ,
	COUNTRY_CODE_BT, COUNTRY_CODE_CD, COUNTRY_CODE_CF, COUNTRY_CODE_CG,
	...
	COUNTRY_CODE_GW, COUNTRY_CODE_IM, COUNTRY_CODE_JE, COUNTRY_CODE_KM,
	COUNTRY_CODE_LI, COUNTRY_CODE_LS, COUNTRY_CODE_MC, COUNTRY_CODE_ML,
	COUNTRY_CODE_MQ, COUNTRY_CODE_MR, COUNTRY_CODE_MU, COUNTRY_CODE_NE,
	COUNTRY_CODE_NR, COUNTRY_CODE_PF, COUNTRY_CODE_PM, COUNTRY_CODE_RE,
	COUNTRY_CODE_SM, COUNTRY_CODE_ST, COUNTRY_CODE_SZ, COUNTRY_CODE_TD,
	COUNTRY_CODE_TF, COUNTRY_CODE_TG, COUNTRY_CODE_TV, COUNTRY_CODE_VA,
...
static const uint16_t g_u2CountryGroup1[] = {
	...
	COUNTRY_CODE_BS, COUNTRY_CODE_BV, COUNTRY_CODE_BZ, COUNTRY_CODE_FJ,
	COUNTRY_CODE_FK, COUNTRY_CODE_FM, COUNTRY_CODE_GD, COUNTRY_CODE_GI,
	COUNTRY_CODE_GS, COUNTRY_CODE_GY, COUNTRY_CODE_HT, COUNTRY_CODE_IO,
	COUNTRY_CODE_IR, COUNTRY_CODE_KN, COUNTRY_CODE_KP, COUNTRY_CODE_KY,
	COUNTRY_CODE_LC, COUNTRY_CODE_LR, COUNTRY_CODE_MH, COUNTRY_CODE_MN,
	COUNTRY_CODE_MS, COUNTRY_CODE_MW, COUNTRY_CODE_NA, COUNTRY_CODE_NU,
	COUNTRY_CODE_PN, COUNTRY_CODE_PS, COUNTRY_CODE_PW, COUNTRY_CODE_RW,
	COUNTRY_CODE_SB, COUNTRY_CODE_SC, COUNTRY_CODE_SD, COUNTRY_CODE_SH,
	COUNTRY_CODE_SJ, COUNTRY_CODE_SN, COUNTRY_CODE_SS, COUNTRY_CODE_SX,
	COUNTRY_CODE_SY, COUNTRY_CODE_TC, COUNTRY_CODE_TK, COUNTRY_CODE_TO,
	COUNTRY_CODE_TT, COUNTRY_CODE_VC, COUNTRY_CODE_VG, COUNTRY_CODE_VU,
...
static const uint16_t g_u2CountryGroup2[] = {
	...
	COUNTRY_CODE_SL, COUNTRY_CODE_SR
};
static const uint16_t g_u2CountryGroup3[] = {
	COUNTRY_CODE_CU, COUNTRY_CODE_DM, COUNTRY_CODE_GU, COUNTRY_CODE_MP,
	COUNTRY_CODE_UM, COUNTRY_CODE_VI
};
...
static const uint16_t g_u2CountryGroup5[] = {
	COUNTRY_CODE_CN, COUNTRY_CODE_MV, COUNTRY_CODE_UY, COUNTRY_CODE_VE
};
...
/* XM_MOD:  belongs to ETSI,
 * 5G shutdown Band 2/3 and 6E support for 1-93.
 */
static const uint16_t g_u2CountryGroup12[] = {
	COUNTRY_CODE_AM, COUNTRY_CODE_JO
};
...
/* XM_MOD: belongs to ETSI,
 * the only channel difference from Group11 is that 6E adds support for 1-93.
 */
static const uint16_t g_u2CountryGroup15[] = {
	COUNTRY_CODE_EG, COUNTRY_CODE_MA, COUNTRY_CODE_TN
};
/* XM_MOD: belongs to ETSI,
 * The difference between Group 37 and 5G is that 5G is disabled (ch165).
 */
static const uint16_t g_u2CountryGroup16[] = {
	COUNTRY_CODE_UG
};
/* XM_MOD: belongs to ETSI,
 * the only channel difference from Group16 is that 6E adds support for 1-93.
 */
static const uint16_t g_u2CountryGroup17[] = {
	COUNTRY_CODE_GH
};
/* XM_MOD: belongs to ETSI,
 * the only channel difference from Group0 is that 6E adds support for 1-93.
 */
static const uint16_t g_u2CountryGroup18[] = {
	COUNTRY_CODE_AL, COUNTRY_CODE_AZ, COUNTRY_CODE_BA, COUNTRY_CODE_KE,
	COUNTRY_CODE_KW, COUNTRY_CODE_MD, COUNTRY_CODE_ME, COUNTRY_CODE_MK,
	COUNTRY_CODE_MT, COUNTRY_CODE_TJ, COUNTRY_CODE_TZ
};
/* XM_MOD: belongs to ETSI,
 * the only channel difference from Group1 is that 6E adds support for 1-93.
 */
static const uint16_t g_u2CountryGroup19[] = {
	COUNTRY_CODE_AD, COUNTRY_CODE_AE, COUNTRY_CODE_AT, COUNTRY_CODE_BE,
	...
	COUNTRY_CODE_FI, COUNTRY_CODE_FR, COUNTRY_CODE_GB, COUNTRY_CODE_GR,
	COUNTRY_CODE_HR, COUNTRY_CODE_HU, COUNTRY_CODE_IE, COUNTRY_CODE_IL,
	COUNTRY_CODE_IT, COUNTRY_CODE_KG, COUNTRY_CODE_KZ, COUNTRY_CODE_LK,
	COUNTRY_CODE_LT, COUNTRY_CODE_LU, COUNTRY_CODE_LV, COUNTRY_CODE_MO,
	COUNTRY_CODE_NL, COUNTRY_CODE_NO, COUNTRY_CODE_NZ, COUNTRY_CODE_PH,
	COUNTRY_CODE_PK, COUNTRY_CODE_PL, COUNTRY_CODE_PT, COUNTRY_CODE_QA,
	COUNTRY_CODE_RO, COUNTRY_CODE_RS, COUNTRY_CODE_SE, COUNTRY_CODE_SG,
	COUNTRY_CODE_SI, COUNTRY_CODE_SK, COUNTRY_CODE_TR, COUNTRY_CODE_ZA
};

static const uint16_t g_u2CountryGroup20[] = {
	COUNTRY_CODE_PR, COUNTRY_CODE_AS
};
/* XM_MOD:
 * ADD 5G CH100-128, CH165.
 */
static const uint16_t g_u2CountryGroup21[] = {
	COUNTRY_CODE_NP
};
/* XM_MOD: belongs to ETSI, and 6E support 1-93,
 * the corresponding content in 2.4G/5G and Group6 is the same.
 */
static const uint16_t g_u2CountryGroup22[] = {
	COUNTRY_CODE_BD
};
/* XM_MOD: belongs to FCC, 
 * The corresponding content in 2.4G/5G and Group3 is the same.
 */
static const uint16_t g_u2CountryGroup23[] = {
	COUNTRY_CODE_EC, COUNTRY_CODE_PA
};
/* XM_MOD:
 * belongs to ETSI.
 */
...
/* XM_MOD: belongs to FCC,
 * The corresponding content in 2.4G/5G/6E and Group22 is the same.
 */
static const uint16_t g_u2CountryGroup25[] = {
	COUNTRY_CODE_KR, COUNTRY_CODE_SA, COUNTRY_CODE_SV, COUNTRY_CODE_PE
};
/* XM_MOD: belongs to FCC,
 * The corresponding content in 2.4G/5G/6E and Group20 is the same.
 */
...
/* XM_MOD:
 * The corresponding content in 2.4G/5G/6E and Group19 is the same.
 */
static const uint16_t g_u2CountryGroup27[] = {
	COUNTRY_CODE_CK, COUNTRY_CODE_KI, COUNTRY_CODE_TL
};
/* XM_MOD:
 * belongs to FCC.
 */
...
/* XM_MOD: belongs to FCC,
 * the corresponding content in 2.4G/5G/6E and Group18 is the same.
 */
static const uint16_t g_u2CountryGroup30[] = {
	COUNTRY_CODE_TH
};
/* XM_MOD: belongs to ETSI,
 * 5G band1 is the DFS channel, and 6E supports 1-93.
 */
static const uint16_t g_u2CountryGroup31[] = {
	COUNTRY_CODE_HK
};
/* XM_MOD: belongs to ETSI,
 * 5G band1 is the DFS channel, no support 5G BAND3 and 6E.
 */
static const uint16_t g_u2CountryGroup32[] = {
	COUNTRY_CODE_ID
};
/* XM_MOD: belongs to ETSI,
 * 2.4G support 1-11, and 6E supports 1-93.
 */
static const uint16_t g_u2CountryGroup33[] = {
	COUNTRY_CODE_TW
};
/* XM_MOD: belongs to ETSI,
 * 2.4G support 1-11, and 6E supports 1-229.
 * The corresponding content in 2.4G/5G/6E and Group20 is the same.
 */
static const uint16_t g_u2CountryGroup34[] = {
	COUNTRY_CODE_GT
};
/* XM_MOD: belongs to FCC,
 * 5GBAND3 support 100-116, 136-144, and 6E supports 1-89.
 */
static const uint16_t g_u2CountryGroup35[] = {
	COUNTRY_CODE_MX
};
/* XM_MOD: belongs to ETSI,
 * The corresponding content in 2.4G/5G and Group0 is the same.
 */
static const uint16_t g_u2CountryGroup36[] = {
	COUNTRY_CODE_BY, COUNTRY_CODE_LB, COUNTRY_CODE_CI, COUNTRY_CODE_BW,
	COUNTRY_CODE_LA, COUNTRY_CODE_LY, COUNTRY_CODE_MZ, COUNTRY_CODE_SO,
	COUNTRY_CODE_TM
};
/* XM_MOD: belongs to ETSI,
 * The corresponding content in 2.4G/5G and Group1 is the same.
 */
static const uint16_t g_u2CountryGroup37[] = {
	COUNTRY_CODE_AO, COUNTRY_CODE_BN, COUNTRY_CODE_BO, COUNTRY_CODE_IN,
	COUNTRY_CODE_PG, COUNTRY_CODE_VN
};
/* XM_MOD:
 * The corresponding content in 2.4G/5G/6E and Group18 is the same.
 */
static const uint16_t g_u2CountryGroup38[] = {
	COUNTRY_CODE_IS, COUNTRY_CODE_NC, COUNTRY_CODE_WF, COUNTRY_CODE_XK
};
/* XM_MOD: belongs to FCC,
 * the corresponding content in 2.4G/5G and Group1 is the same.
 */
static const uint16_t g_u2CountryGroup39[] = {
	COUNTRY_CODE_PY
};
/* XM_MOD: belongs to ETSI,
 * 5G band1 is the DFS channel.
 */
static const uint16_t g_u2CountryGroup40[] = {
	COUNTRY_CODE_UA
};
/* XM_MOD: belongs to ETSI, and 6E supports 1-93.
 * The corresponding content in 2.4G/5G and Group5 is the same.
 */
static const uint16_t g_u2CountryGroup41[] = {
	COUNTRY_CODE_BH
};
/* XM_MOD: belongs to ETSI, and 6E supports 1-93.
 * Turn off 5G Band4.
 */
static const uint16_t g_u2CountryGroup42[] = {
	COUNTRY_CODE_IQ, COUNTRY_CODE_OM
};
/* XM_MOD: belongs to FCC, and 2.4G supports 1-11.
 * the corresponding content in 5G/6E and Group19 is the same.
 */
static const uint16_t g_u2CountryGroup43[] = {
	COUNTRY_CODE_CL
};
/* XM_MOD: belongs to FCC,
 * the corresponding content in 2.4G/5G/6E and Group19 is the same.
 */
static const uint16_t g_u2CountryGroup44[] = {
	COUNTRY_CODE_HN
};
/* XM_MOD: belongs to ETSI
 * the corresponding content in 2.4G/5G and Group6 is the same.
 */
static const uint16_t g_u2CountryGroup45[] = {
	COUNTRY_CODE_MM
};
/* XM_MOD: belongs to ETSI
 * the corresponding content in 2.4G/5G and Group2 is the same.
 */
static const uint16_t g_u2CountryGroup46[] = {
	COUNTRY_CODE_GE, COUNTRY_CODE_KH, COUNTRY_CODE_ZW
};
/* XM_MOD: belongs to ETSI
 * the corresponding content in 2.4G/5G and Group11 is the same.
 */
static const uint16_t g_u2CountryGroup47[] = {
	COUNTRY_CODE_UZ
};
/* XM_MOD: belongs to ETSI
 * the corresponding content in 2.4G/5G and Group3 is the same.
 */
static const uint16_t g_u2CountryGroup48[] = {
	COUNTRY_CODE_NI
};
...
struct DOMAIN_INFO_ENTRY arSupportedRegDomains[] = {
	...
	,
	{
		(uint16_t *) g_u2CountryGroup8, sizeof(g_u2CountryGroup8) / 2,
		{
			...
			,	/*CH_SET_UNII_UPPER_149_165 */
#if (CFG_SUPPORT_WIFI_6G == 1)
			{131, BAND_6G, CHNL_SPAN_20, 1, 58, FALSE}
				/* 6G_CH_1_229 */
#endif
		}
	}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup33, sizeof(g_u2CountryGroup33) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 11, FALSE}
			,	/* CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup34, sizeof(g_u2CountryGroup34) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 11, FALSE}
			,	/* CH_SET_2G4_1_11 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup35, sizeof(g_u2CountryGroup35) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/* CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
			...
			{121, BAND_5G, CHNL_SPAN_20, 100, 5, TRUE}
			,	/* CH_SET_UNII_WW_100_116 */
			{121, BAND_5G, CHNL_SPAN_20, 136, 4, TRUE}
			,	/* CH_SET_UNII_WW_136_144 */
			{125, BAND_5G, CHNL_SPAN_20, 149, 5, FALSE}
			,	/* CH_SET_UNII_UPPER_149_165 */
#if (CFG_SUPPORT_WIFI_6G == 1)
			{131, BAND_6G, CHNL_SPAN_20, 1, 23, FALSE}
				/* 6G_CH_1_89 */
#endif
		},
		REG_CAT_FCC
	...
	,
	{
		(uint16_t *) g_u2CountryGroup36, sizeof(g_u2CountryGroup36) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/*CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup37, sizeof(g_u2CountryGroup37) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/* CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup38, sizeof(g_u2CountryGroup38) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/*CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup39, sizeof(g_u2CountryGroup39) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/* CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup40, sizeof(g_u2CountryGroup40) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/* CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, TRUE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup41, sizeof(g_u2CountryGroup41) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/* CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup42, sizeof(g_u2CountryGroup42) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/*CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup43, sizeof(g_u2CountryGroup43) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 11, FALSE}
			,	/* CH_SET_2G4_1_11 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup44, sizeof(g_u2CountryGroup44) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/* CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup45, sizeof(g_u2CountryGroup45) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/*CH_SET_2G4_1_13 */
			{115, BAND_NULL, 0, 0, 0, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup46, sizeof(g_u2CountryGroup46) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,			/* CH_SET_2G4_1_13 */
	...
	,
	{
		(uint16_t *) g_u2CountryGroup47, sizeof(g_u2CountryGroup47) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 13, FALSE}
			,	/*CH_SET_2G4_1_13 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	...
	,
	{
		(uint16_t *) g_u2CountryGroup48, sizeof(g_u2CountryGroup48) / 2,
		{
			{81, BAND_2G4, CHNL_SPAN_5, 1, 11, FALSE}
			,	/* CH_SET_2G4_1_11 */
			{115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
...
struct COUNTRY_LIMIT_CHNL_GRP_TABLE g_rCountryLmtChGrpTbl[] = {
	...
	{BAND_6G, COUNTRY_LMT_CH_GRP_KEY_6G_UNII_6, 95, 115},   /* key = -11 */
	{BAND_6G, COUNTRY_LMT_CH_GRP_KEY_6G_UNII_7, 117, 185},  /* key = -12 */
	{BAND_6G, COUNTRY_LMT_CH_GRP_KEY_6G_UNII_8, 187, 233}   /* key = -13 */
#endif
};
#endif
...
static uint8_t g_ucSarApplyActAnt[SAR_NUM];
				...
				enum ENUM_BAND eBand, int16_t i2CentralCh)
{
	...
	for (i = PWR_LMT_SUBBAND_2G4; i < PWR_LMT_SUBAND_NUM; i++) {
		if ((eBand == BAND_NULL || eBand == g_rRlmSubBand[i].eBand) &&
			...
			if (i2CentralCh == 221 || i2CentralCh == 229)
				return TRUE;
	...
	enum ENUM_PWR_LIMIT_DEFAULT_BASE eDefBase)
{
	...
	u2CountryCodeTemp = u2CountryCode;

	for (i = 0; i < COUNTRY_PWR_LMT_GROUPS_TBL_USED_SIZE; i++) {
		prCountryGrpInfo = &COUNTRY_PWR_LMT_GROUPS_TBL_USED[i];
	...
	if (i < COUNTRY_PWR_LMT_GROUPS_TBL_USED_SIZE) {
		DBGLOG(RLM, TRACE,
			"find Country = (%c%c) in group (%c%c)!\n",
			((u2CountryCodeTemp & 0xff00) >> 8),
			(u2CountryCodeTemp & 0x00ff),
			((u2CountryCodeTable & 0xff00) >> 8),
			(u2CountryCodeTable & 0x00ff));
	}
	...
	uint16_t u2DefaultTableIndex)
{
	...
	int8_t cLmtBand = 0;
	uint8_t u1PwrIdx = 0;
	uint8_t ucDefaultTblByPassFlag = 0;

	ASSERT(prCmd);

	/* ucCountryPwrLimitCtrl BIT(0) pull high
	 * will by pass default table setting.
	 */
	ucDefaultTblByPassFlag =
		prAdapter->rWifiVar.ucCountryPwrLimitCtrl &
		BIT(COUNTRY_POWER_DISABLE_DEFAULT);
			...
			struct CMD_SET_COUNTRY_CHANNEL_POWER_LIMIT *prCmd)
{
	...
	uint8_t ucCentCh;
	uint8_t ucConfigTblByPassFlag = 0;
	...
	/* ucCountryPwrLimitCtrl BIT(1) pull high
	 * will by pass config table setting.
	 */
	ucConfigTblByPassFlag =
		prAdapter->rWifiVar.ucCountryPwrLimitCtrl &
		BIT(COUNTRY_POWER_DISABLE_CONFIG);

	DBGLOG(RLM, WARN,
		"ucCountryPwrLimitCtrl setting[%x]",
		prAdapter->rWifiVar.ucCountryPwrLimitCtrl);

	if (ucConfigTblByPassFlag)
		return;
...
#else
	timer_delete_sync(&prAdapter->prGlueInfo->rTxPowerLimitTimer);
#endif
...
/*----------------------------------------------------------------------------*/
/*!
 * \brief This func is use to set extent to check VLP mode or not
 *
 * \param[in] prAdapter : Flag for HE 6G info have present
 *
 * \return value : WLAN_STATUS
 */
/*----------------------------------------------------------------------------*/
uint32_t rlmDomainSet6GPwrModeVlpExtChk(
	struct ADAPTER *prAdapter)
{
	if (!prAdapter)
		return WLAN_STATUS_INVALID_DATA;
...
#if WLAN_INCLUDE_SYS
	if (prAdapter->ucRfTestMode == 0 || prAdapter->ucRfTestMode == 2)
		prAdapter->rWifiVar.fgVlpExtChk = TRUE;
	else
		prAdapter->rWifiVar.fgVlpExtChk = FALSE;

	DBGLOG(RLM, STATE,
		"Set Vlp extent check[%d]RfTestMode[%d]\n",
		prAdapter->rWifiVar.fgVlpExtChk,
		prAdapter->ucRfTestMode);
#endif
...
{
	enum ENUM_PWR_MODE_6G_TYPE ePwrMode6G = PWR_MODE_6G_LPI;
	uint8_t ucRfTestMode = 0;
...
#if WLAN_INCLUDE_SYS
		ucRfTestMode = prAdapter->ucRfTestMode;

		/* .psm.info = 1, ucRfTestMode = 0, nomral mode (LPI/VLP)
		 * .psm.info = 0, ucRfTestMode = 1, test mode (Only LPI)
		 * .psm.info = 2, ucRfTestMode = 2, test mode (LPI/VLP)
		 * .psm.info = 3, ucRfTestMode = 3, test mode (only VLP)
		 * .psm.info = 4, ucRfTestMode = 4, test mode (only SP)
		 */
		if (ucRfTestMode == 3)
			ePwrMode6G = PWR_MODE_6G_VLP;
		else if (ucRfTestMode == 4)
			ePwrMode6G = PWR_MODE_6G_SP;
		else
#endif
			ePwrMode6G = PWR_MODE_6G_LPI;
	...
	DBGLOG(RLM, TRACE,
		"HE6GPre[%d]HeRegInfo[%d]6GPwrMode[%d]RfTestMode[%d]\n",
		fgIsHE6GPresent,
		uc6GHeRegInfo,
		ePwrMode6G,
		ucRfTestMode);
	...
	uint8_t *pfgSupport)
{
	...
	/* .psm.info = 1, ucRfTestMode = 0, nomral mode (LPI/VLP/SP)
	 * .psm.info = 0, ucRfTestMode = 1, test mode (Only LPI)
	 * .psm.info = 2, ucRfTestMode = 2, test mode (LPI/VLP/SP)
	 * .psm.info = 3, ucRfTestMode = 3, test mode (only VLP)
	 * .psm.info = 4, ucRfTestMode = 4, test mode (only SP)
	 */
	if (ucRfTestMode == 1 && eMode != PWR_MODE_6G_LPI) {
		*pfgSupport = FALSE;
		return WLAN_STATUS_SUCCESS;
	} else if (ucRfTestMode == 3 && eMode != PWR_MODE_6G_VLP) {
		*pfgSupport = FALSE;
		return WLAN_STATUS_SUCCESS;
	} else if (ucRfTestMode == 4 && eMode != PWR_MODE_6G_SP) {
		*pfgSupport = FALSE;
		return WLAN_STATUS_SUCCESS;
	}
#endif
	...
	for (i = 0; i < COUNTRY_PWR_MODE_6G_SUPPORT_TBL_USED_SIZE; i++) {
		WLAN_GET_FIELD_BE16(
		&COUNTRY_PWR_MODE_6G_SUPPORT_TBL_USED[i].aucCountryCode[0],
		&u2TblCntryCode);

		if (u2TblCntryCode == u2CntryCode) {
			/* Found */
			pCntryTbl = &COUNTRY_PWR_MODE_6G_SUPPORT_TBL_USED[i];
			break;
		}

		if (u2TblCntryCode == COUNTRY_CODE_NULL)
			pDefault = &COUNTRY_PWR_MODE_6G_SUPPORT_TBL_USED[i];
	}
...
)
{
	...
	DBGLOG(RLM, TRACE,
		"Band[%d]PwrMode[%d]Support[%d]LPI_SP[%d]SP[%d]LPI[%d]VLP[%d]",
		u1Band,
		eMode,
		fgSupport,
		PWR_MODE_6G_LPI_SP,
...
#else
			timer_delete(&prGlueInfo->rTxPowerLimitTimer);
#endif
...
void rlmDomainSetPwrLimitPayload(struct ADAPTER *prAdapter)
{
	...
	uint16_t u1ChCnt = 0;
#endif /* CFG_SUPPORT_MULTIBAND_PWR_LMT_EMI == 1 */
	bool fgDefTblEn = true;
	bool fgCfgTblEn = true;

	/*
	 * ucCountryPwrLimitCtrl BIT(0) high will by pass default table
	 * ucCountryPwrLimitCtrl BIT(1) high will by pass config table
	 */
	DBGLOG(RLM, WARN,
		"ucCountryPwrLimitCtrl setting[%x]",
		prAdapter->rWifiVar.ucCountryPwrLimitCtrl);
	...
	fgDefTblEn =
		(prAdapter->rWifiVar.ucCountryPwrLimitCtrl &
		BIT(COUNTRY_POWER_DISABLE_DEFAULT)) ? false : true;
	fgCfgTblEn =
		(prAdapter->rWifiVar.ucCountryPwrLimitCtrl &
		BIT(COUNTRY_POWER_DISABLE_CONFIG)) ? false : true;
	...
	uint16_t u2CountryCode)
{
	...
	DBGLOG(RLM, INFO,
		"rlmDomainPwrLmt detect country code %c%c!\n",
		prPwrLimitDefaultTable->aucCountryCode[0],
		prPwrLimitDefaultTable->aucCountryCode[1]);
 ...
 */
/*----------------------------------------------------------------------------*/
uint32_t rlmDomainGetSarApplyActAntStatus(
...
)
{
	...
	DBGLOG(RLM, INFO, "[SAR]Sar Scenario Type[%d] apply_ant[%d]\n",
		eType,
		g_ucSarApplyActAnt[eType]);

	return g_ucSarApplyActAnt[eType];
}
/*----------------------------------------------------------------------------*/
/*!
...
void rlmDomainSarSub6BandInfoDisableApplyAnt(void)
{
	...
	for (i = SAR_NR_SUB6_BAND_INFO_2; i <= SAR_NR_SUB6_BAND_INFO_78; i++)
		g_ucSarApplyAnt[i] = SAR_APPLY_DISABLE_ANT_ALL;
}
	...
	uint8_t ucInfo)
{
	...
	bool fgSub6BandInfoApply = FALSE;
	uint8_t i = 0;
	enum ENUM_SAR_TYPE eSarType = SAR_HEAD;

	DBGLOG(RLM, INFO,
		"[SAR]SAR bitmap start: Cmd type[%d]id[%d]info[%d]\n",
		eCmdType,
		eId,
		ucInfo);
	...
	if (eCmdType == SAR_TX_POWER_CALLING) {
		...
		if (fgSub6BandInfoValid) {
			 ...
			 */
			rlmDomainSarSub6BandInfoDisableApplyAnt();
			g_ucSarApplyAnt[eSarType] = SAR_APPLY_ENABLE_ANT_ALL;

			/* Sub6_Band_info & Sub6/mmWave have same priority,
			 * If Sub6_Band_info is enable, Sub6/mmWave
			 * should be disable.
			 */
			g_ucSarApplyAnt[SAR_NR_SUB6] =
						SAR_APPLY_DISABLE_ANT_ALL;
			g_ucSarApplyAnt[SAR_NR_MMWAVE] =
						SAR_APPLY_DISABLE_ANT_ALL;
		}
	}

	kalMemCopy(g_ucSarApplyActAnt,
			g_ucSarApplyAnt,
			sizeof(g_ucSarApplyActAnt));
	 ...
	 */
	for (i = SAR_NR_SUB6_BAND_INFO_2; i <= SAR_NR_SUB6_BAND_INFO_78; i++) {
		if (g_ucSarApplyAnt[i] != SAR_APPLY_DISABLE_ANT_ALL) {
			fgSub6BandInfoApply = TRUE;
			break;
		}
	}

	if (g_ucSarApplyAnt[SAR_NR_MMWAVE] != SAR_APPLY_DISABLE_ANT_ALL ||
	    g_ucSarApplyAnt[SAR_NR_SUB6] != SAR_APPLY_DISABLE_ANT_ALL ||
		fgSub6BandInfoApply == TRUE) {
		g_ucSarApplyActAnt[SAR_MHS] = SAR_APPLY_DISABLE_ANT_ALL;
	}
}
/*----------------------------------------------------------------------------*/
/*!
 ...
 */
/*----------------------------------------------------------------------------*/
uint8_t rlmDomainIsSarEventConcurrent(uint32_t *pu4BitMap)
{
	uint8_t i = 0;
	uint8_t ucCnt = 0;
	...
	*pu4BitMap = 0;
	...
	for (i = 0; i < SAR_NUM; i++) {
		if (rlmDomainGetSarApplyActAntStatus(i) != 0) {
			*pu4BitMap |= BIT(i);
			ucCnt++;
			DBGLOG(RLM, INFO,
 ...
 */
/*----------------------------------------------------------------------------*/
int32_t rlmDomainSarGetRemapSubIdx(uint16_t *pu2SubIdx)
{
	uint32_t i = 0;
	uint32_t u4Size = (sizeof(g_SarSubIndxReMapTbl) /
				sizeof(struct SAR_SUB_IDX_REMAP_TBL_INFO));
	uint8_t ucAntAppy = SAR_APPLY_DISABLE_ANT_ALL;
	uint16_t u2SubIdxOfst = 0;
	uint32_t u4BitMap = 0;

	if (rlmDomainIsSarEventConcurrent(&u4BitMap)) {
		ucAntAppy = SAR_APPLY_ENABLE_ANT_ALL;
	} else {
		for (i = 0; i < SAR_NUM; i++) {
			if (rlmDomainGetSarApplyActAntStatus(i) != 0) {
				ucAntAppy = rlmDomainGetSarApplyActAntStatus(i);
				DBGLOG(RLM, INFO,
	...
	DBGLOG(RLM, INFO, "[SAR]bit map = 0x%X\n", u4BitMap);

	if (ucAntAppy == SAR_APPLY_ENABLE_ANT_ALL)
		u2SubIdxOfst = 0;
	else if (ucAntAppy == SAR_APPLY_ENABLE_ONLY_WF0)
		u2SubIdxOfst = 1000;
	else if (ucAntAppy == SAR_APPLY_ENABLE_ONLY_WF1)
		u2SubIdxOfst = 2000;

	for (i = 0; i < u4Size; i++) {
		if (u4BitMap == g_SarSubIndxReMapTbl[i].u4BitMap) {

			if (ucAntAppy == SAR_APPLY_DISABLE_ANT_ALL) {
				*pu2SubIdx = 0;
			} else {
