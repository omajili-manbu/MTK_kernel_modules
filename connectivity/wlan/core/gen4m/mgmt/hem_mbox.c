...
static const char * const apucDebugMsg[] = {
	...
	"MID_CNM_WON_CH_GRANT",
	"MID_WON_DATA_MGMT_TX",
...
static struct MSG_HNDL_ENTRY arMsgMapTable[] = {
	...
	{MID_MNY_NAN_MGMT_TX, nanRunEventMgmtFrameTx},
	{MID_MNY_NAN_MGMT_TX_CANCEL_WAIT, nanFsmRunEventCancelTxWait},
#endif
#endif
...
#if CFG_SUPPORT_PASN
	{MID_PASN_RESP, pasnHandlePasnResp},
	{MID_PASN_SECURE_RANGING_CTX, pasnHandleSecureRangingCtx},
#endif
...
#endif /* CFG_ENABLE_WIFI_DIRECT */
#if CFG_SUPPORT_WONDERTAP
	{MID_CNM_WON_CH_GRANT, wonChGrant},
	{MID_WON_DATA_MGMT_TX, wonTxDataMgmt},
#endif /* CFG_SUPPORT_WONDERTAP */
#if CFG_FLUSH_TX_PENDING_PKT
