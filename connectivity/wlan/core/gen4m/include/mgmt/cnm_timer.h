...
#define NSEC_TO_SEC(_nsec)		(kal_div_u64((_nsec), NSEC_PER_SEC))
#define NSEC_TO_MSEC(_nsec)		(kal_div_u64((_nsec), NSEC_PER_MSEC))
...
#define SEC_TO_TU(_sec)		((uint32_t)(_sec) * USEC_PER_SEC / USEC_PER_TU)
