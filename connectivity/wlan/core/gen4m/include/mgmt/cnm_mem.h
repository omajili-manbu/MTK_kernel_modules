...
struct STA_RECORD {
	...
	/* (4) System Timestamp of Successful Rx Auth */
	uint32_t rAuthInitTime;
...
#ifndef CFG_SUPPORT_NAN_R4_PAIRING
	u_int8_t ucPairingFsmIdx;
