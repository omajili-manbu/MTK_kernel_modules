...
enum ENUM_ROAMING_REPORT_REASON {
	ROAMING_REPORT_REASON_POOR_RSSI = 0,
	ROAMING_REPORT_REASON_TX_ERR = 1,
	ROAMING_REPORT_REASON_RETRY = 2,
	ROAMING_REPORT_REASON_IDLE = 3,
	ROAMING_REPORT_REASON_BEACON_TIMEOUT = 4,
	ROAMING_REPORT_REASON_INACTIVE = 5,
	ROAMING_REPORT_REASON_SAA_FAIL = 6,
	ROAMING_REPORT_REASON_UPPER_LAYER_TRIGGER = 7,
	ROAMING_REPORT_REASON_BTM = 8,
	ROAMING_REPORT_REASON_TEMP_REJECT = 9,
	ROAMING_REPORT_REASON_UNSPECIFIC = 10,
};

static uint8_t apucRoamingReasonConvert[ROAMING_REASON_NUM] = {
	ROAMING_REPORT_REASON_POOR_RSSI,	/* POOR_RCPI(0) */
	ROAMING_REPORT_REASON_TX_ERR,		/* TX_ERR(1) */
	ROAMING_REPORT_REASON_RETRY,		/* RETRY(2) */
	ROAMING_REPORT_REASON_IDLE,		/* IDLE(3) */
	ROAMING_REPORT_REASON_UNSPECIFIC,	/* HIGH_CU(4)*/
	ROAMING_REPORT_REASON_UNSPECIFIC,	/* BT_COEX(5) */
	ROAMING_REPORT_REASON_BEACON_TIMEOUT,	/* BEACON_TIMEOUT(6) */
	ROAMING_REPORT_REASON_INACTIVE,		/* INACTIVE(7) */
	ROAMING_REPORT_REASON_SAA_FAIL,		/* SAA_FAIL(8) */
	ROAMING_REPORT_REASON_UPPER_LAYER_TRIGGER,/* UPPER_LAYER(9) */
	ROAMING_REPORT_REASON_BTM,		/* BTM(10) */
	ROAMING_REPORT_REASON_UNSPECIFIC,	/* SCAN_TIMER(11) */
	ROAMING_REPORT_REASON_UNSPECIFIC,	/* INACTIVE_TIMER(12) */
};
