...
enum ENUM_MLR_STATE_SRC_CTRL {
	MLR_STATE_UPDATE_BY_DRV_OR_MLR_MODULE = 0,
	MLR_STATE_UPDATE_BY_RA,
	MLR_STATE_UPDATE_BY_CMD
};

enum ENUM_MLR_STATE_UPDATE_REASON {
	MLR_STATE_UPDATE_REASON_BY_LOW_RSSI = 0,
	MLR_STATE_UPDATE_REASON_BY_RA,
	MLR_STATE_UPDATE_REASON_BY_BOTH,
	MLR_STATE_UPDATE_REASON_BY_IGNORE
};
