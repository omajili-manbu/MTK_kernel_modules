...
#ifndef __NAN_INTF_H__
#define __NAN_INTF_H__
...
/* The macro to check if the MAC address is a NAN Cluster ID */
#define IS_NAN_CLUSTER_ID(_pucDestAddr)                 \
	((*(uint8_t *)(_pucDestAddr) == 0x50) &&         \
	(*(uint8_t *)(_pucDestAddr+1) == 0x6F) &&       \
	(*(uint8_t *)(_pucDestAddr+2) == 0x9A) &&       \
	(*(uint8_t *)(_pucDestAddr+3) == 0x01))
...
#define NAN_FW_MAX_TX_FOLLOW_UP_SDEA_LEN  255
#endif
