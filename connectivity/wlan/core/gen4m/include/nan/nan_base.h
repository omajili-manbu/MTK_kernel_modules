...
enum NAN_ATTRIBUTE_ID {
	NAN_ATTR_ID_MASTER_INDICATION = 0x00,
	NAN_ATTR_ID_CLUSTER = 0x01,
	NAN_ATTR_ID_SERVICE_ID_LIST = 0x02,
	NAN_ATTR_ID_SERVICE_DESCRIPTOR = 0x03,
	NAN_ATTR_ID_NAN_CONNECTION_CAPABILITY = 0x04,
	NAN_ATTR_ID_WLAN_INFRASTRUCTURE = 0x05,
	NAN_ATTR_ID_P2P_OPERATION = 0x06,
	NAN_ATTR_ID_IBSS = 0x07,
	NAN_ATTR_ID_MESH = 0x08,
	NAN_ATTR_ID_FSD = 0x09,
	NAN_ATTR_ID_FURTHER_AVAILABILITY_MAP = 0x0A,
	NAN_ATTR_ID_COUNTRY_CODE = 0x0B,
	NAN_ATTR_ID_RANGING = 0x0C,
	NAN_ATTR_ID_CLUSTER_DISCOVERY = 0x0D,
	NAN_ATTR_ID_SDEA = 0x0E,
	NAN_ATTR_ID_DEVICE_CAPABILITY = 0x0F,
	NAN_ATTR_ID_NDP = 0x10,
	NAN_ATTR_ID_NMSG = 0x11,
	NAN_ATTR_ID_NAN_AVAILABILITY = 0x12,
	NAN_ATTR_ID_NDC = 0x13,
	NAN_ATTR_ID_NDL = 0x14,
	NAN_ATTR_ID_NDL_QOS = 0x15,
	NAN_ATTR_ID_MULTICAST_SCHEDULE = 0x16,
	NAN_ATTR_ID_UNALIGNED_SCHEDULE = 0x17,
	NAN_ATTR_ID_PAGING_UNICAST = 0x18,
	NAN_ATTR_ID_PAGING_MULTICAST = 0x19,
	NAN_ATTR_ID_RANGING_INFORMATION = 0x1A,
	NAN_ATTR_ID_RANGING_SETUP = 0x1B,
	NAN_ATTR_ID_FTM_RANGING_REPORT = 0x1C,
	NAN_ATTR_ID_ELEMENT_CONTAINER = 0x1D,
	NAN_ATTR_ID_EXT_WLAN_INFRASTRUCTURE = 0x1E,
	NAN_ATTR_ID_EXT_P2P_OPERATION = 0x1F,
	NAN_ATTR_ID_EXT_IBSS = 0x20,
	NAN_ATTR_ID_EXT_MESH = 0x21,
	NAN_ATTR_ID_CIPHER_SUITE_INFO = 0x22,
	NAN_ATTR_ID_SECURITY_CONTEXT_INFO = 0x23,
	NAN_ATTR_ID_SHARED_KEY_DESCRIPTOR = 0x24,
	NAN_ATTR_ID_MULTICAST_SCHEDULE_CHANGE = 0x25,
	NAN_ATTR_ID_MULTICAST_SCHEDULE_OWNER_CHANGE = 0x26,
	NAN_ATTR_ID_PUBLIC_AVAILABILITY = 0x27,
	NAN_ATTR_ID_SUBSCRIBE_SERVICE_ID_LIST = 0x28,
	NAN_ATTR_ID_NDP_EXTENSION = 0x29,
	NAN_ATTR_ID_DEVICE_CAPABILITY_EXT = 0x2A,
	NAN_ATTR_ID_NAN_IDENTITY_RESOLUTION = 0x2B,
	NAN_ATTR_ID_NAN_PAIRING_BOOTSTRAPPING = 0x2C,
	NAN_ATTR_ID_S3 = 0x2D,
	NAN_ATTR_ID_TRANSMIT_POWER_ENVELOPE = 0x2E,
	NAN_ATTR_ID_VENDOR_SPECIFIC = 0xDD,
};
...
#define NAN_ATTR_NDPE_CTRL_GTK_REQUIRED BIT(5)
...
#if (CFG_NAN_SUPPORT_R4_GROUP_ADDR_FRAME_PROT == 1)
#define NAN_SDEA_CTRL_GTK_REQUIRED BIT(10)
#endif /* CFG_NAN_SUPPORT_R4_GROUP_ADDR_FRAME_PROT */
...
#if (CFG_NAN_SUPPORT_R4_GROUP_ADDR_FRAME_PROT == 1)
#define NAN_CIPHER_SUITE_ID_NCS_PK_2WDH_128 3
#define NAN_CIPHER_SUITE_ID_NCS_PK_2WDH_256 4
#define NAN_CIPHER_SUITE_ID_NCS_GTK_CCM_128 5
#define NAN_CIPHER_SUITE_ID_NCS_GTK_GCM_256 6
#endif /* CFG_NAN_SUPPORT_R4_GROUP_ADDR_FRAME_PROT */
#define NAN_CIPHER_SUITE_ID_NCS_PK_PASN_128 7
#define NAN_CIPHER_SUITE_ID_NCS_PK_PASN_256 8
#define NAN_CIPHER_SUITE_ID_MAX 9

/* NAN Cipher Suite Information Capabilities */
#if (CFG_NAN_SUPPORT_R4_GROUP_ADDR_FRAME_PROT == 1)
#define CSIA_CAP_GTKSA_IGTKSA_BIGTKSA_SUPPORT_MASK		BITS(1, 2)
#define CSIA_CAP_GTKSA_IGTKSA_BIGTKSA_SUPPORT_SHFT		1
#define CSIA_CAP_GTKSA_IGTKSA_BIGTKSA_UNSUPPORTED		0
#define CSIA_CAP_GTKSA_IGTKSA_SUP_BIGTKSA_UNSUP			1
#define CSIA_CAP_GTKSA_IGTKSA_BIGTKSA_SUPPORTED			2
#define CSIA_CAP_GTKSA_IGTKSA_BIGTKSA_RESERVED			3

#define CSIA_CAP_IGTKSA_BIGTKSA_CS_MASK			BIT(4)
#define CSIA_CAP_IGTKSA_BIGTKSA_CS_SHFT			4
#define CSIA_CAP_IGTKSA_BIGTKSA_NCS_BIP_128		0
#define CSIA_CAP_IGTKSA_BIGTKSA_NCS_BIP_256		1
#endif /* CFG_NAN_SUPPORT_R4_GROUP_ADDR_FRAME_PROT */
...
enum _ENUM_TIME_BITMAP_CTRL_DURATION {
	ENUM_TIME_BITMAP_CTRL_DURATION_16 = 0, /* 16TU, 1 NAN slot */
	ENUM_TIME_BITMAP_CTRL_DURATION_32,     /* 32TU, 2 NAN slots */
	ENUM_TIME_BITMAP_CTRL_DURATION_64,     /* 64TU, 4 NAN slots */
	ENUM_TIME_BITMAP_CTRL_DURATION_128,    /* 128TU, 8 NAN slots */
};

enum _ENUM_TIME_BITMAP_CTRL_PERIOD_T {
	ENUM_TIME_BITMAP_CTRL_PERIOD_128 = 1, /* 128TU, 8 NAN slots */
	ENUM_TIME_BITMAP_CTRL_PERIOD_256,     /* 256TU, 16 NAN slots */
	ENUM_TIME_BITMAP_CTRL_PERIOD_512,     /* 512TU, 32 NAN slots */
	ENUM_TIME_BITMAP_CTRL_PERIOD_1024,    /* 104TU, 64 NAN slots */
	ENUM_TIME_BITMAP_CTRL_PERIOD_2048,    /* 2048TU, 128 NAN slots */
	ENUM_TIME_BITMAP_CTRL_PERIOD_4096,    /* 4096TU, 256 NAN slots */
	ENUM_TIME_BITMAP_CTRL_PERIOD_8192,    /* 8192TU, 512 NAN slots */
};
...
struct _NAN_ATTR_NAN_ATTRIBUTE_CONTROL_T {
	uint16_t b4MapID : 4,
		 b1CommittedChanged : 1,
		 b1PotentialChanged : 1,
		 b1PublicAvailabilityChanged : 1,
		 b1NDCChanged : 1,
		 b1McastScheduleChanged : 1,
		 b1McastScheduleChangeChanged : 1,
		 b6Reserved : 6;
} __KAL_ATTRIB_PACKED__;
...
/* NAN 4.0 Table 109. Unaligned schedule attribute format */
__KAL_ATTRIB_PACKED_FRONT__
struct _NAN_ATTR_UNALIGNED_SCHEDULE_T {
	uint8_t ucAttrId; /* NAN_ATTR_ID_UNALIGNED_SCHEDULE */
	uint16_t u2Length;

	/* NAN 4.0 Table 110 Attribute Control field format for ULW attribute */
	union {
		uint16_t u2AttributeControl;
		struct {
	...
	/* u4StartingTime: the starting time of the first indicated ULW express
	 * in therms of the lower 4 bytes of the NAN TSF
	 */
	uint32_t u4StartingTime;
	/* u4Duration: the duration for each ULW in units of microseconds */
	uint32_t u4Duration;
	/* u4Period: the time between consecutive ULWs in units of microseconds
	 */
	uint32_t u4Period;
	/* ucCountDown: number of indicated ULWs.
	 * 255: not end until next schedule update
	 * 0: remaining ULWs are cancelled
	 */
	uint8_t ucCountDown;

	/* NAN 4.0 Table 111 ULW Overwrite field format */
	union {
		uint8_t ucULWOverwrite;
		struct {
			/**
			 * b1OverwriteAll
			 * 1: the unaligned schedule takes precedence over all
			 *    NAN availability
			 */
			uint8_t b1OverwriteAll :1;
			/**
			 * When b1OverwriteAll == 0,
			 * identify the NAN availability attribute which the ULW
			 * schedule takes precedence over
			 */
	...
	/* optional field present if fgNoAvailability == FALSE */
	/* ULW Control (Optional) struct _NAN_ATTR_ULW_CONTROL +
	 * BandID Table 99 enum NAN_SUPPORTED_BANDS, or
	 * ChannelEntry Table 100 struct _NAN_SIMPLE_CHNL_ENTRY_T,
	 * struct _NAN_CHNL_ENTRY_NO_AUX_T or
	 * struct _NAN_CHNL_ENTRY_T
	 */
...
enum _NUN_ULW_CONTROL_TYPE {
	ULW_CTRL_BY_BAND, /* enum NAN_SUPPORTED_BANDS */
	ULW_CTRL_BY_CHANNEL, /* struct _NAN_CHNL_ENTRY_NO_AUX_T  */
	ULW_CTRL_BY_CHANNEL_AUX, /* struct _NAN_CHNL_ENTRY_T */
	ULW_CTRL_BY_RESERVED,
};

/* NAN 4.0 Table 112 ULW Control field format */
struct _NAN_ATTR_ULW_CONTROL {
	struct {
		uint8_t b2Type :2, /* _NUN_ULW_CONTROL_TYPE */
			b1ChannelAvail :1,
			b4RxNss :4,
			b1Reserved : 1;
	};
...
/* NAN 4.0 Table 75 NAN Country Code attribute format */
__KAL_ATTRIB_PACKED_FRONT__
struct _NAN_ATTR_COUNTRY_CODE_T {
	uint8_t  ucAttrId; /* NAN_ATTR_ID_COUNTRY_CODE */
	uint16_t u2Length; /* 2 */
	char     acCountryString[2];
} __KAL_ATTRIB_PACKED__;
