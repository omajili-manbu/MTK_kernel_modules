...
#define CONNAC2X_WTBL_RESP_RCPI0_MASK           BITS(0, 7)
#define CONNAC2X_WTBL_RESP_RCPI0_OFFSET         0
#define CONNAC2X_WTBL_RESP_RCPI1_MASK           BITS(8, 15)
#define CONNAC2X_WTBL_RESP_RCPI1_OFFSET         8
#define CONNAC2X_WTBL_RESP_RCPI2_MASK           BITS(16, 23)
#define CONNAC2X_WTBL_RESP_RCPI2_OFFSET         16
#define CONNAC2X_WTBL_RESP_RCPI3_MASK           BITS(24, 31)
#define CONNAC2X_WTBL_RESP_RCPI3_OFFSET         24
