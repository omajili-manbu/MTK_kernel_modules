...
#define WLAN_CFG_REC_ENTRY_NUM_MAX 700
#else
#define WLAN_CFG_REC_ENTRY_NUM_MAX 670
#endif
...
#define WLAN_DRV_READY_CHECK_ALL \
...
uint32_t wlanSetFixRate(struct ADAPTER *prAdapter,
		      void *pvSetBuffer,
