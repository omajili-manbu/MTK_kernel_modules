...
#ifndef CFG_SUPPORT_TX_DELAY_TIMEOUT_PROFILE
#define CFG_SUPPORT_TX_DELAY_TIMEOUT_PROFILE    0
...
#define CFG_WIFI_AUTO_RECOVER		1
...
#endif
#ifndef CFG_SUPPORT_WFD_1NSS_BW40_CONFIG
#define CFG_SUPPORT_WFD_1NSS_BW40_CONFIG          0
#endif
...
#define CFG_SUPPORT_UV 0 /* S11 + Skyhawk POC */ /* (CFG_EXT_FEATURE) */
 ...
 *------------------------------------------------------------------------------
 */
#define CFG_SAP_DEAUTH_DURING_CHNL_SWITCH    1
...
#define CFG_SUPPORT_NAN_SERVICE_EXPIRED 1
...
#define CFG_SUPPORT_NAN_R4 (CFG_SUPPORT_NAN)
#endif

#ifndef CFG_SUPPORT_NAN_RANGING
#define CFG_SUPPORT_NAN_RANGING 1
#endif

#if (CFG_SUPPORT_NAN_R4 == 1)
#define CFG_SUPPORT_NAN_R4_DALE_PAIRING 0
#define CFG_SUPPORT_NAN_R4_DALE_HOST_KEY 0
#define CFG_NAN_SUPPORT_R4_GROUP_ADDR_DATA 1
#define CFG_NAN_SUPPORT_R4_GROUP_ADDR_FRAME_PROT 1
#else
#define CFG_SUPPORT_NAN_R4_DALE_PAIRING 0
#define CFG_SUPPORT_NAN_R4_DALE_HOST_KEY 0
#define CFG_NAN_SUPPORT_R4_GROUP_ADDR_DATA 0
#define CFG_NAN_SUPPORT_R4_GROUP_ADDR_FRAME_PROT 0
#endif
...
#ifndef CFG_SUPPORT_NAN_EVENT_ALIGNMENT
#define CFG_SUPPORT_NAN_EVENT_ALIGNMENT 0
#endif

#ifndef CFG_SUPPORT_NAN_MGMT_TX
#define CFG_SUPPORT_NAN_MGMT_TX  (CFG_SUPPORT_NAN)
#endif
...
#ifndef CFG_SUPPORT_WONDERTAP
#define CFG_SUPPORT_WONDERTAP 1
#endif

#ifndef CFG_WONDERTAP_TX_RX_DEBUG
#define CFG_WONDERTAP_TX_RX_DEBUG 0
#endif

#ifndef CFG_SUPPORT_WONDERTAP_RX_BYPASS
#define CFG_SUPPORT_WONDERTAP_RX_BYPASS 0
#endif

#ifndef CFG_SUPPORT_WON_DBDC
#define CFG_SUPPORT_WON_DBDC 0
#endif

#ifndef CFG_SUPPORT_WON_11AX
#define CFG_SUPPORT_WON_11AX 0
#endif

#ifndef CFG_SUPPORT_WON_11BE
#define CFG_SUPPORT_WON_11BE 0
#endif

#ifndef CFG_SUPPORT_WON_HW
#define CFG_SUPPORT_WON_HW 1
#endif

#ifndef CFG_SUPPORT_WON_11BE_MLO
#define CFG_SUPPORT_WON_11BE_MLO 0
#endif
...
/*------------------------------------------------------------------------------
 * Just partial wifi.cfg be allow to modied from user load
 * Config CFG_RM_WIFI_LIMIT will allow all wifi.cfg be modified from user load
 *------------------------------------------------------------------------------
 */
#ifndef CFG_RM_WIFI_LIMIT
#define CFG_RM_WIFI_LIMIT 1
#endif
