...
#define IPV4_HDR_IP_TOTAL_LENGTH_OFFSET         2
...
#define TCP_HDR_HEADER_LEN_OFFSET               12
#define TCP_HDR_HEADER_LEN_MASK                 BITS(4, 7)
#define TCP_HDR_HEADER_LEN_SHIFT                4
#define TCP_HDR_FLAG_OFFSET                     13
...
#define WLAN_MAC_CTS_ACK_HEADER_LEN             10
#define WLAN_MAC_CF_END_HEADER_LEN              20
...
#define STATUS_REJECTED_WITH_SUGGESTED_BSS_TRANSITION 82
...
/* OWE: (re)association response without PMKID when using PMKID */
#define STATUS_CODE_ASSOC_RSP_OWE_NO_PMKID          0xFFF6
...
#define MTK_OUI_ID_DFS_CONTROL		    7
...
#define IPV4_HDR_LEN_MIN		IPV4_HDR_LEN
