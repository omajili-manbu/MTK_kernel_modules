...
#define P2P_DFS_TRAFFIC_IE_REMOVE       0
#define P2P_DFS_TRAFFIC_IE_CTRL_EN      1
#define P2P_DFS_TRAFFIC_IE_CTRL_DIS     0
#define P2P_DFS_TRAFFIC_IE_ADD_CTRL_EN  2
#define P2P_DFS_TRAFFIC_IE_ADD_CTRL_DIS 1
