...
#define CONNAC3X_RX_STATUS_FLAG_COSR             BIT(16)
#else
...
#define CONNAC3X_RX_STATUS_FLAG_BIPN_REPLY_CHECK_FAIL    BIT(29)
...
#define CONNAC3X_RX_STATUS_FLAG_MUBAR_BIT        BIT(21)
...
#if (CFG_CONNAC3X_DS_VER >= 3600)
#define CONNAC3X_RX_STATUS_FLAG_IP_BIT           BIT(26)
#define CONNAC3X_RX_STATUS_FLAG_UT_BIT           BIT(27)
#define CONNAC3X_RX_STATUS_FLAG_SMESH_BIT        BIT(30)
#endif
...
#if (CFG_CONNAC3X_DS_VER >= 3600)
#define CONNAC3X_RX_STATUS_ETH_TYPE_MASK         BITS(7, 14)
#define CONNAC3X_RX_STATUS_ETH_TYPE_OFFSET       7
#endif
...
#define HAL_MAC_CONNAC3X_RX_STATUS_IS_COSR(_prHwMacRxDesc)	\
(((_prHwMacRxDesc)->u4DW0 & CONNAC3X_RX_STATUS_FLAG_COSR) \
	? TRUE : FALSE)
#else
#define HAL_MAC_CONNAC3X_RX_STATUS_GET_ETH_TYPE_OFFSET(_prHwMacRxDesc)	\
RX_DESC_GET_FIELD((_prHwMacRxDesc)->u4DW0, \
...
#define HAL_MAC_CONNAC3X_RX_STATUS_IS_BIPN_ERROR(_prHwMacRxDesc) \
(((_prHwMacRxDesc)->u4DW3 & CONNAC3X_RX_STATUS_FLAG_BIPN_REPLY_CHECK_FAIL) \
	? TRUE:FALSE)
...
#if (CFG_CONNAC3X_DS_VER >= 3600)
#define HAL_MAC_CONNAC3X_RX_STATUS_IS_IP_CHECKSUM_OFFLOAD(_prHwMacRxDesc) \
(((_prHwMacRxDesc)->u4DW3 & CONNAC3X_RX_STATUS_FLAG_IP_BIT) \
	? TRUE : FALSE)
#define HAL_MAC_CONNAC3X_RX_STATUS_IS_TCPUDP_CHECKSUM_OFFLOAD(_prHwMacRxDesc) \
(((_prHwMacRxDesc)->u4DW3 & CONNAC3X_RX_STATUS_FLAG_UT_BIT) \
	? TRUE : FALSE)
#define HAL_MAC_CONNAC3X_RX_STATUS_IS_SMESH_FORWARD_FLAME(_prHwMacRxDesc) \
(((_prHwMacRxDesc)->u4DW3 & CONNAC3X_RX_STATUS_FLAG_SMESH_BIT) \
	? TRUE : FALSE)
#endif
...
#define HAL_MAC_CONNAC3X_RX_STATUS_GET_BSSID(_prHwMacRxDesc) \
RX_DESC_GET_FIELD((_prHwMacRxDesc)->u4DW2, \
CONNAC3X_RX_STATUS_BSSID_MASK, CONNAC3X_RX_STATUS_BSSID_OFFSET)
...
#define HAL_MAC_CONNAC3X_RX_STATUS_IS_MUBAR(_prHwMacRxDesc) \
(((_prHwMacRxDesc)->u4DW2 & CONNAC3X_RX_STATUS_FLAG_MUBAR_BIT)?TRUE:FALSE)
...
/* Group3 C-B-3 */
#define HAL_MAC_CONNAC3X_RX_VT_GET_RCPI0_G3(_prHwMacRxStsGroup3)	\
(((_prHwMacRxStsGroup3)->u4Rcpi & CONNAC3X_RX_C_RXV_RCPI0_MASK) >> \
	CONNAC3X_RX_C_RXV_RCPI0_OFFSET)
#define HAL_MAC_CONNAC3X_RX_VT_GET_RCPI1_G3(_prHwMacRxStsGroup3)	\
(((_prHwMacRxStsGroup3)->u4Rcpi & CONNAC3X_RX_C_RXV_RCPI1_MASK) >> \
