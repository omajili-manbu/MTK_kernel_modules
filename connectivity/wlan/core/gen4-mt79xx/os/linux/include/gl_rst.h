...
#define RST_D0_L0P5_MAX_TIME               1500
...
struct DYNAMIC_POWER_CTRL_INFO {
	uint32_t busId;
	u_int8_t fgIsPendingForPowerOffReady;
};
#endif
 ...
 */
#if CFG_CONN_DYNAMIC_POWER_CTRL
extern struct DYNAMIC_POWER_CTRL_INFO
	g_dynamicPowerCtrlInfo[CFG_MAX_WLAN_DEVICES];
#endif
