...
enum WIFI_SUB_COMMAND {
	...
	WIFI_SUBCMD_GET_ROAM_IMPROVE_FEATURE = 0x000f,	/*0x000f*/
};
...
#define APF_MAX_PROGRAM_LEN	4096
#else
...
enum WIFI_ROAMING_IMPROVE_ATTRIBUTE {
	ROAMING_IMPROVE_ATTRIBUTE_FEATURE_ENABLE,
};
#endif
