...
/* Format: "wlanName BusNumber PortNumer */
...
struct GL_HIF_INFO {
	...
	uint32_t u4TxCompleteTcMap;
	struct QUE rTxCompleteMsduList;
#endif
#if CFG_CHIP_RESET_SUPPORT
...
struct BUS_INFO {
	...
	void (*asicUdmaInit)(IN struct ADAPTER *prAdapter);
