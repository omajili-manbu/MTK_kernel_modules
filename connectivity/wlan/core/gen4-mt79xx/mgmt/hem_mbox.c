...
static struct MSG_HNDL_ENTRY arMsgMapTable[] = {
	...
	{MID_MNY_P2P_NAN_MAP_UPDATED, p2pDevFsmRunEventChnlMapUpdated},
...
#if (CFG_NAN_P2P_CONCURRENT_SUPPORT == 1)
	{MID_NAN_P2P_DP_UPDATE, p2pRoleFsmRunEventNanDPUpdate},
	{MID_P2P_NAN_DP_UPDATE, nanSchedP2pNotifyNanConnectMode},
#endif /* CFG_NAN_P2P_CONCURRENT_SUPPORT */
#endif
