...
/*Management MIC length 18 bytes*/
#define MMIC_IE_LENGTH 18
#endif
...
#define NDBM_LOW_BOUND_FOR_RCPI                 110U
#define RCPI_LOW_BOUND                          0
#define RCPI_HIGH_BOUND                         220U
...
#if (CFG_SUPPORT_NAN == 1 || CFG_SUPPORT_RTT == 1)
/* Table 9-258 Format and Bandwidth field */
enum FTM_FORMAT_BW_TYPE {
	FTM_FORMAT_BW_NO_PREFERENCE = 0x0,
	FTM_FORMAT_BW_HT_MIXED_BW20 = 0x9,
	FTM_FORMAT_BW_VHT_BW20  = 0xa,
	FTM_FORMAT_BW_HT_MIXED_BW40 = 0xb,
	FTM_FORMAT_BW_VHT_BW40 = 0xc,
	FTM_FORMAT_BW_VHT_BW80 = 0xd,
	FTM_FORMAT_BW_VHT_BW160 = 0x10,
	FTM_FORMAT_BW_HE_BW80 = 0x13,
	FTM_FORMAT_BW_HE_BW160 = 0x16,
};
#endif /* CFG_SUPPORT_NAN == 1 || CFG_SUPPORT_RTT == 1 */
/*******************************************************************************
 *                             D A T A   T Y P E S
 *******************************************************************************
 */
...
struct WLAN_ASSOC_RSP_FRAME {
	...
	uint8_t aucInfoElem[];	/* Information elements, such as */
...
struct IE_COUNTRY {
	...
	struct COUNTRY_INFO_SUBBAND_TRIPLET arCountryStr[];
} __KAL_ATTRIB_PACKED__;
...
struct IE_TX_PWR_ENV_FRAME {
	...
	uint8_t ucTxPwrInfo;   /* Bits[0:2] : Max TxPwr Count
				...
				*/
	int8_t acMaxTxPwr[TX_PWR_ENV_INFO_TXPWR_COUNT_MAX];
} __KAL_ATTRIB_PACKED__;
#endif  /* CFG_SUPPORT_6G_PWR_REGS == 1 */
...
#define RCPI_TO_dBm(_rcpi)                          \
	...
	RCPI_HIGH_BOUND : (_rcpi)) >> 1U) - NDBM_LOW_BOUND_FOR_RCPI)
...
#define COPY_SSID(pucDestSsid, ucDestSsidLen, pucSrcSsid, ucSrcSsidLen) \
	do { \
		if (ucSrcSsidLen > ELEM_MAX_LEN_SSID) { \
			ucDestSsidLen = ELEM_MAX_LEN_SSID; \
		} else { \
