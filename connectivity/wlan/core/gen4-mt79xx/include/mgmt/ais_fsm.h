...
#define IS_AIS_ROAMING(_adapter, _bss_idx) \
	...
	aisGetAisFsmInfo(_adapter, _bss_idx)->fgIsStaRoaming)
#else
...
struct AIS_FSM_INFO {
	...
	struct TIMER rDelayCarrierOffTimer;
#if CFG_SUPPORT_802_11W
	struct TIMER rPmfWaitReconnectTimer;
#endif
#endif
