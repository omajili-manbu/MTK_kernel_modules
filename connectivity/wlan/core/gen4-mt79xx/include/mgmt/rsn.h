...
#define RSN_AKM_SUITE_8021X_SUITE_B_BIT	BIT(9)
#define RSN_AKM_SUITE_8021X_SUITE_B_192_BIT	BIT(10)
#define RSN_AKM_SUITE_SAE_BIT			BIT(11)
#define RSN_AKM_SUITE_OWE_BIT			BIT(12)
#define RSN_AKM_SUITE_802_1X_SHA256_BIT	BIT(13)
#define RSN_AKM_SUITE_PSK_SHA256_BIT	BIT(14)
#define RSN_AKM_SUITE_DPP_BIT			BIT(15)
...
#if (CFG_MTK_SUPPLICANT_ROAMING_ENHANCE && CFG_SUPPORT_802_11W)
#define PMF_WAIT_RECONNECT_MARGIN 1000 /*Unit: ms*/
#if CFG_MTK_SUPPLICANT_ROAMING_PMF_DELAY_RECONNECT_BY_AUTH
#define PMF_DEFAULT_ASSOC_COMEBACK 1000  /*Unit: TU*/
#endif
#endif
