...
#define UNII4_LOWER_BOUND    167
#define UNII4_UPPER_BOUND    177
/* 6G SubBand FCC spec */
...
#define RLM_GET_ACTIVE_CHANNEL_COUNT(X) \
				rlmDomainGetActiveChannelCount(prAdapter, (X))
#define RLM_GET_ACTIVE_CHANNELS() \
				rlmDomainGetActiveChannels(prAdapter)
...
static const char * const apucPwrModeType[PWR_MODE_6G_NUM] = {
	"LPI_SP",
	"SP",
	"LPI",
	"VLP",
...
#if (CFG_SUPPORT_UNII4 == 1)
	PWR_LMT_SUBBAND_UNII4,
#endif /* CFG_SUPPORT_UNII4 */
#if (CFG_SUPPORT_WIFI_6G == 1)
	PWR_LMT_SUBBAND_UNII5A,
	PWR_LMT_SUBBAND_UNII5B,
	PWR_LMT_SUBBAND_UNII6,
	PWR_LMT_SUBBAND_UNII7A,
	PWR_LMT_SUBBAND_UNII7B,
...
#if (CFG_SUPPORT_UNII4 == 1)
	PWR_LMT_SUBBAND_PWR_UNII4,
#endif /* CFG_SUPPORT_UNII4 */
#if (CFG_SUPPORT_WIFI_6G == 1)
	PWR_LMT_SUBBAND_PWR_UNII5,
	PWR_LMT_SUBBAND_PWR_UNII6,
	PWR_LMT_SUBBAND_PWR_UNII7,
	PWR_LMT_SUBBAND_PWR_UNII8,
#endif /* CFG_SUPPORT_WIFI_6G */
	PWR_LMT_DEF_PWR_NUM
};
...
enum ENUM_REGULATORY_CATEGORY {
	REG_CAT_NULL = 0,
	REG_CAT_FCC = 1,
	REG_CAT_ETSI = 2,   /* ETSI_2017 */
	REG_CAT_ARIB = 3,
	REG_CAT_ETSI_2023 = 4,
	REG_CAT_ETSI_ARIB = 5,
	REG_CAT_ETSI_2023_ARIB = 6,
	REG_CAT_NUM
};

static const char * const apucRegCatType[REG_CAT_NUM] = {
	"Default",
	"FCC",
	"ETSI",
	"ARIB",
...
void rlmDomainParsingChannel(struct wiphy *pWiphy);
 ...
 */
/*----------------------------------------------------------------------------*/
uint32_t rlmDomainGetSubBandIdx(
	enum ENUM_BAND eBand,
	uint8_t ucCenterCh,
