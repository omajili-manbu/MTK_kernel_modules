...
enum ENUM_P2P_DEV_STATE {
	...
	/* Remain on channel when NAN existed. */
	P2P_DEV_STATE_NUM
};
...
struct MSG_P2P_NAN_MAP_UPDATED {
	struct MSG_HDR rMsgHdr;	/* Must be the first member */
};
...
#define P2P_LISTEN_NAN_UPDATED_TIMEOUT_MS  100
...
struct P2P_DEV_FSM_INFO {
	...
	struct TIMER rP2pListenNanUpdatedTimer;
	u_int8_t fgIsP2pListenConcurrent;
