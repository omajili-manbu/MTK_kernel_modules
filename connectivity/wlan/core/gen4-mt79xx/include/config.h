...
#ifndef CFG_WIFI_RAM_MQM_BA_DELAY_SUPPORT
#define CFG_WIFI_RAM_MQM_BA_DELAY_SUPPORT             0
#endif
...
/* Turn off connectivity HW power after all connectivity modules off.
 * Turn on connectivity HW power when any one of connectivity module
 * need to be on.
 */
#ifndef CFG_CONN_DYNAMIC_POWER_CTRL
#define CFG_CONN_DYNAMIC_POWER_CTRL 0
#endif
...
#ifndef CFG_CSI_DYNAMIC_BUFFER
#define CFG_CSI_DYNAMIC_BUFFER 0
#endif
#endif
...
#ifndef CFG_WIFI_TESTMODE_FW_REDOWNLOAD
#define CFG_WIFI_TESTMODE_FW_REDOWNLOAD 0
#endif

#ifndef CFG_SUPPORT_ANT_SMART_DIVERSITY
#define CFG_SUPPORT_ANT_SMART_DIVERSITY		0
#endif
/*------------------------------------------------------------------------------
...
#define CFG_IP_FRAG_DISABLE_HW_CHECKSUM         0
#define CFG_FORCE_HW_CHECKSUM                   0
#else
#define CFG_TCP_IP_CHKSUM_OFFLOAD               1
#define CFG_TCP_IP_CHKSUM_OFFLOAD_NDIS_60       0
#define CFG_TX_MAX_PKT_SIZE                     1600
#define CFG_NATIVE_802_11                       0
#define CFG_IP_FRAG_DISABLE_HW_CHECKSUM         1
#define CFG_FORCE_HW_CHECKSUM                   1
#endif
 ...
 * 0: Disable
 */
#define CFG_SDIO_MAILBOX_EXTENSION                   1
...
#ifndef CFG_SUPPORT_PCIE_DISABLE_ASPM_IN_SUSPEND_FLOW
#define CFG_SUPPORT_PCIE_DISABLE_ASPM_IN_SUSPEND_FLOW        0
#endif

#ifndef CFG_SUPPORT_DISABLE_DATA_DDONE_INTR
#define CFG_SUPPORT_DISABLE_DATA_DDONE_INTR   0
#endif

#if (CFG_TX_DIRECT == 0)
#undef CFG_SUPPORT_DISABLE_DATA_DDONE_INTR
#define CFG_SUPPORT_DISABLE_DATA_DDONE_INTR   0
#endif

/* Flag of Supporting 6G Passive Scan */
#ifndef CFG_SUPPORT_6G_PASSIVE_SCAN
#define CFG_SUPPORT_6G_PASSIVE_SCAN 1
#endif
...
#define CFG_TX_MAX_CMD_PKT_NUM                  144
...
/*Enable this debug flag for PMF SAP send broadcast deauth*/
#define CFG_SUPPORT_802_11W_DEBUG_SAP_MMIC 0
#else
#define CFG_SUPPORT_802_11W_DEBUG_SAP_MMIC 0
#endif
...
#ifndef CFG_SUPPORT_NFC_BEAM_PLUS
...
/*------------------------------------------------------------------------------
 * Flags of Tx Power 6G REGULATIONS
 *------------------------------------------------------------------------------
 */
#ifndef CFG_SUPPORT_6G_PWR_REGS
#define CFG_SUPPORT_6G_PWR_REGS 0
#endif
/*------------------------------------------------------------------------------
 * Single Sku
 *------------------------------------------------------------------------------
...
/* define SKU tbl file name */
#define WIFI_TXPWR_FN          CFG_WIFI_TXPWR_FN
#define WIFI_TXPWR_6G_LPI_FN   CFG_WIFI_TXPWR_6G_LPI_FN
#define WIFI_TXPWR_6G_VLP_FN   CFG_WIFI_TXPWR_6G_VLP_FN
#define WIFI_TXPWR_6G_SP_FN    CFG_WIFI_TXPWR_6G_SP_FN
/*------------------------------------------------------------------------------
 ...
 *------------------------------------------------------------------------------
 */
#ifndef CFG_WIFI_SUPPORT_GET_NOISE
#define CFG_WIFI_SUPPORT_GET_NOISE  0
#endif
...
#define CFG_SUPPORT_TX_BEACON_RESP_STA_MODE      0
#else
#define CFG_SUPPORT_TX_BEACON_RESP_STA_MODE      0
#endif
...
#ifndef CFG_SUPPORT_APFV6
#define CFG_SUPPORT_APFV6 0
#endif
/*------------------------------------------------------------------------------
...
/* nonDBDC NAN shall disable this */
#define CFG_SUPPORT_NAN_DBDC (CFG_SUPPORT_DBDC)
...
/* DW channel controlled by timeline not by CNM */
#define CFG_SUPPORT_NAN_CUST_DW_CHNL		0
#define CFG_SUPPORT_NAN_AVAILABILITY_CONTROL_BY_UPPER_LAYER	1
#define CFG_SUPPORT_NAN_SCHED_PARALLEL_NEGO		1
#define CFG_SUPPORT_NAN_REDIRECT_VENDOR_CMD		1
/* should set to 1, if CFG_SUPPORT_NAN_SCHED_PARALLEL_NEGO == 1,
 * to prevent externel thread access Scheduler Negotiation data base
 */
#define CFG_NAN_SUPPORT_FAST_DISC	1
#define CFG_NAN_SUPPORT_OOB_AF_SLOT_BASE	1

#ifndef CFG_SUPPORT_NAN_R4
#define CFG_SUPPORT_NAN_R4 0
#endif
...
/*------------------------------------------------------------------------------
 * Flags of Radar Feature
 * This is the control flag. Please enable the feature option flag in Makefile.
 *------------------------------------------------------------------------------
 */
#ifndef CFG_SUPPORT_FMCW_RADAR
#define CFG_SUPPORT_FMCW_RADAR 0
#endif

/* Sending the CTS-to-self control frame */
#ifndef CFG_WIFI_FMCW_RADAR_CTS2SELF
#define CFG_WIFI_FMCW_RADAR_CTS2SELF 0
#endif
...
#ifndef CFG_WIFI_ULTRA_RADIO_OFF_CTRL
#define CFG_WIFI_ULTRA_RADIO_OFF_CTRL		1
#endif
...
/*------------------------------------------------------------------------------
 * Support SW Fast Path or not.
 *------------------------------------------------------------------------------
 */
#ifndef CFG_SUPPORT_SW_FAST_PATH
#define CFG_SUPPORT_SW_FAST_PATH  0
#endif
...
/*------------------------------------------------------------------------------
 * Flags of FW Log Index Support
 *------------------------------------------------------------------------------
 */
#ifndef CFG_SUPPORT_FW_IDX_LOG_TRANS
#define CFG_SUPPORT_FW_IDX_LOG_TRANS  0
#endif

/*------------------------------------------------------------------------------
 * Flags of Radar Support
 *------------------------------------------------------------------------------
 */
#ifndef CFG_SUPPORT_RADAR_CMD
#define CFG_SUPPORT_RADAR_CMD 0
#endif

/*------------------------------------------------------------------------------
 * Flags of One Driver Multi-Card Support
 *------------------------------------------------------------------------------
 */
#ifndef CFG_SUPPORT_MULTI_CARD
#define CFG_SUPPORT_MULTI_CARD 0
...
#ifndef CFG_USB_RECYCLE_REQ_IN_IRQ
#define CFG_USB_RECYCLE_REQ_IN_IRQ 0
#endif

#ifndef CFG_MTK_SUPPLICANT_ROAMING_ENHANCE
#define CFG_MTK_SUPPLICANT_ROAMING_ENHANCE 0
#elif (CFG_SUPPORT_SUPPLICANT_SME == 0)
#undef CFG_MTK_SUPPLICANT_ROAMING_ENHANCE
#define CFG_MTK_SUPPLICANT_ROAMING_ENHANCE 0
#endif

#if CFG_MTK_SUPPLICANT_ROAMING_ENHANCE
#define CFG_MTK_SUPPLICANT_ROAMING_PMF_DELAY_RECONNECT_BY_AUTH 1
#else
#define CFG_MTK_SUPPLICANT_ROAMING_PMF_DELAY_RECONNECT_BY_AUTH 0
#endif

/*------------------------------------------------------------------------------
 * Flags for FPGA Environment
 *------------------------------------------------------------------------------
 */
...
/*------------------------------------------------------------------------------
 * Flags of FW Log Support Timesync
 *------------------------------------------------------------------------------
 */
#ifndef CFG_SUPPORT_FW_LOG_TIMESYNC
#define CFG_SUPPORT_FW_LOG_TIMESYNC  0
#endif

/*------------------------------------------------------------------------------
 * Flags for multi SKB size.
 *------------------------------------------------------------------------------
 */
#ifndef CFG_SUPPORT_MULTI_SKB_SIZE
#define CFG_SUPPORT_MULTI_SKB_SIZE 0
#endif
/*******************************************************************************
 *                             D A T A   T Y P E S
 *******************************************************************************
