...
#define CONNAC2X_UDMA_DBGCNT_CTRL_DBGCNT_EN_ADDR    (CONNAC2X_UDMA_BASE + 0x3BC)
#define CONNAC2X_UDMA_DBGCNT_CTRL_DBGCNT_EN_MASK    BIT(0)
...
#define CONNAC2X_HAL_RX_VECTOR_GET_BW(_prHwRxVector) \
	((((_prHwRxVector)->u4RxVector[0]) & CONNAC2X_RX_VT_DBW_MASK) >> \
		CONNAC2X_RX_VT_DBW_OFFSET)
