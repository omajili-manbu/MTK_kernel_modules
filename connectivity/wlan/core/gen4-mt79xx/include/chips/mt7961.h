...
void mt7961_DmashdlGetRefill(
	struct ADAPTER *prAdapter);

void mt7961_DmashdlGetPktMaxPage(
	struct ADAPTER *prAdapter);

void mt7961_DmashdlGetGroupControl(
	struct ADAPTER *prAdapter,
	uint8_t ucGroup);

uint32_t mt7961_DmashdlGetRsvCount(
	struct ADAPTER *prAdapter,
	uint8_t ucGroup);

uint32_t mt7961_DmashdlGetSrcCount(
	struct ADAPTER *prAdapter,
	uint8_t ucGroup);

void mt7961_DmashdlGetPKTCount(
	struct ADAPTER *prAdapter,
	uint8_t ucGroup);
