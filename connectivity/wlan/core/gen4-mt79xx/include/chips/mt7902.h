...
void mt7902_DmashdlGetRefill(
	struct ADAPTER *prAdapter);

void mt7902_DmashdlGetPktMaxPage(
	struct ADAPTER *prAdapter);

void mt7902_DmashdlGetGroupControl(
	struct ADAPTER *prAdapter,
	uint8_t ucGroup);

uint32_t mt7902_DmashdlGetRsvCount(
	struct ADAPTER *prAdapter,
	uint8_t ucGroup);

uint32_t mt7902_DmashdlGetSrcCount(
	struct ADAPTER *prAdapter,
	uint8_t ucGroup);

void mt7902_DmashdlGetPKTCount(
	struct ADAPTER *prAdapter,
	uint8_t ucGroup);
