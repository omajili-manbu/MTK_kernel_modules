...
#if defined(CFG_CONN_DYNAMIC_POWER_CTRL) && (CFG_CONN_DYNAMIC_POWER_CTRL == 1)
#define CFG_RESETKO_CONN_DYNAMIC_POWER_CTRL 1
#else
#define CFG_RESETKO_CONN_DYNAMIC_POWER_CTRL 0
#endif

#define INVALID_BUS_ID 0xFFFFFFFF
...
struct ResetInfo {
	...
	struct ResetGpioInfo resetGpioInfo;
	bool isResetGpioReleased;
	struct PowerGpioInfo powerGpioInfo;
...
***********************************************************************
*/
extern struct ResetInfo resetInfo[MAX_DONGLE_NUM];
