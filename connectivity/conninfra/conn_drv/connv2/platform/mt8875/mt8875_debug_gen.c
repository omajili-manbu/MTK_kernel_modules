 ...
 *
 * This file, mt8875_debug_gen.c was automatically generated
...
#include "mt8875_consys_reg_offset.h"
#include "mt8875_debug_gen.h"
#include "conninfra.h"
#include "pmic_mng.h"

mapped_addr vir_addr_consys_dbg_gen_vlpcfg_base_mt8875;
mapped_addr vir_addr_0x1c00d000_mt8875;
mapped_addr vir_addr_consys_dbg_gen_cksys_base_mt8875;
mapped_addr vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875;
mapped_addr vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875;
mapped_addr vir_addr_0x4004c000_mt8875;
mapped_addr vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt8875;
mapped_addr vir_addr_consys_dbg_gen_pbus_base_mt8875;
mapped_addr vir_addr_0x1c011000_mt8875;
mapped_addr vir_addr_0x40001000_mt8875;
mapped_addr vir_addr_0x40049100_mt8875;

void consys_debug_init_mt8875_debug_gen(void)
{
	vir_addr_consys_dbg_gen_vlpcfg_base_mt8875
		= ioremap(CONSYS_DBG_GEN_VLPCFG_BASE_ADDR, 0xE04);
	vir_addr_0x1c00d000_mt8875
		= ioremap(0x1C00D000, 0x77C);
	vir_addr_consys_dbg_gen_cksys_base_mt8875
		= ioremap(CONSYS_DBG_GEN_CKSYS_BASE_ADDR, 0x40);
	vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875
		= ioremap(CONSYS_DBG_GEN_CONN_DBG_CTL_BASE_ADDR, 0x41c);
	vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875
		= ioremap(CONSYS_DBG_GEN_CONN_INFRA_SYSRAM_OFFSET_ADDR, 0xACC);
	vir_addr_0x4004c000_mt8875
		= ioremap(0x4004c000, 0x10);
	vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt8875
		= ioremap(CONSYS_DBG_GEN_APIFRBUS_AO_IO_REG_BASE_ADDR, 0xC);
	vir_addr_consys_dbg_gen_pbus_base_mt8875
		= ioremap(0x4000d000, 0x80);
	vir_addr_0x1c011000_mt8875
		= ioremap(0x1c011000, 0x1000);
	vir_addr_0x40001000_mt8875
		= ioremap(0x40001000, 0x10);
	vir_addr_0x40049100_mt8875
		= ioremap(0x40049100, 0x10);
}

void consys_debug_deinit_mt8875_debug_gen(void)
{
	if (vir_addr_consys_dbg_gen_vlpcfg_base_mt8875)
		iounmap(vir_addr_consys_dbg_gen_vlpcfg_base_mt8875);

	if (vir_addr_0x1c00d000_mt8875)
		iounmap(vir_addr_0x1c00d000_mt8875);

	if (vir_addr_consys_dbg_gen_cksys_base_mt8875)
		iounmap(vir_addr_consys_dbg_gen_cksys_base_mt8875);

	if (vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875)
		iounmap(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875);

	if (vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875)
		iounmap(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875);

	if (vir_addr_0x4004c000_mt8875)
		iounmap(vir_addr_0x4004c000_mt8875);

	if (vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt8875)
		iounmap(vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt8875);

	if (vir_addr_consys_dbg_gen_pbus_base_mt8875)
		iounmap(vir_addr_consys_dbg_gen_pbus_base_mt8875);

	if (vir_addr_0x1c011000_mt8875)
		iounmap(vir_addr_0x1c011000_mt8875);

	if (vir_addr_0x40001000_mt8875)
		iounmap(vir_addr_0x40001000_mt8875);

	if (vir_addr_0x40049100_mt8875)
		iounmap(vir_addr_0x40049100_mt8875);
}

void update_debug_read_info_mt8875_debug_gen(
		struct conn_debug_info_mt8875 *info,
		char *tag,
...
void update_debug_write_info_mt8875_debug_gen(
		struct conn_debug_info_mt8875 *info,
		char *tag,
...
void consys_print_power_debug_dbg_level_0_mt8875_debug_gen(
		int level,
		struct conn_debug_info_mt8875 *pdbg_level_0_info)
{
	int val = 0;
	...
	memset(pdbg_level_0_info, 0, sizeof(struct conn_debug_info_mt8875));

	if (level < 0)
		return;

	if (!vir_addr_consys_dbg_gen_vlpcfg_base_mt8875) {
		pr_notice("vir_addr_consys_dbg_gen_vlpcfg_base_mt8875(%x) ioremap fail\n",
				CONSYS_DBG_GEN_VLPCFG_BASE_ADDR);
		return;
	}

	if (!vir_addr_0x1c00d000_mt8875) {
		pr_notice("vir_addr_0x1c00d000_mt8875(%x) ioremap fail\n",
				0x1C00D000);
		return;
	}

	if (!vir_addr_consys_dbg_gen_cksys_base_mt8875) {
		pr_notice("vir_addr_consys_dbg_gen_cksys_base_mt8875(%x) ioremap fail\n",
				CONSYS_DBG_GEN_CKSYS_BASE_ADDR);
		return;
	}

	/* A0 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A0", 0x1C001000 + 0x85C,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_vlpcfg_base_mt8875 + 0x85C));

	/* A1 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A1", 0x1C00D000 + 0x100,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x100));

	/* A2 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A2", 0x1C00D000 + 0x104,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x104));

	/* A3 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A3", 0x1C00D000 + 0x108,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x108));

	/* A4 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A4", 0x1C00D000 + 0x10C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x10C));

	/* A5 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A5", 0x1C00D000 + 0x110,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x110));

	/* A6 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A6", 0x1C00D000 + 0x114,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x114));

	/* A7 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A7", 0x1C00D000 + 0x118,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x118));

	/* A8 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A8", 0x1C00D000 + 0x11C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x11C));

	/* A9 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A9", 0x1C00D000 + 0x120,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x120));

	/* A10 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A10", 0x1C00D000 + 0x124,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x124));

	/* A11 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A11", 0x1C00D000 + 0x128,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x128));

	/* A12 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A12", 0x1C00D000 + 0x12C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x12C));

	/* A13 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A13", 0x1C00D000 + 0x130,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x130));

	/* A14 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A14", 0x1C00D000 + 0x134,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x134));

	/* A15 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A15", 0x1C00D000 + 0x138,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x138));

	/* A16 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A16", 0x1C00D000 + 0x13C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x13C));

	/* A17 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A17", 0x1C00D000 + 0x140,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x140));

	/* A18 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A18", 0x1C00D000 + 0x144,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x144));

	/* A19 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A19", 0x1C00D000 + 0x148,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x148));

	/* A20 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A20", 0x1C00D000 + 0x14C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x14C));

	/* A21 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A21", 0x1C00D000 + 0x150,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x150));

	/* A22 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A22", 0x1C001000 + 0xE04,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_vlpcfg_base_mt8875 + 0xE04));

	/* A23 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A23", 0x10000000 + CONSYS_DBG_GEN_CLK_CFG_3_OFFSET_ADDR,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_cksys_base_mt8875 +
			CONSYS_DBG_GEN_CLK_CFG_3_OFFSET_ADDR));

	/* A24 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A24", 0x1C00D000 + 0x700,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x700));

	/* A25 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A25", 0x1C00D000 + 0x704,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x704));

	/* A26 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A26", 0x1C00D000 + 0x708,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x708));

	/* A27 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A27", 0x1C00D000 + 0x70C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x70C));

	/* A28 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A28", 0x1C00D000 + 0x710,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x710));

	/* A29 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A29", 0x1C00D000 + 0x714,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x714));

	/* A30 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A30", 0x1C00D000 + 0x718,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x718));

	/* A31 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A31", 0x1C00D000 + 0x71C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x71C));

	/* A32 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A32", 0x1C00D000 + 0x720,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x720));

	/* A33 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A33", 0x1C00D000 + 0x724,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x724));

	/* A34 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A34", 0x1C00D000 + 0x728,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x728));

	/* A35 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A35", 0x1C00D000 + 0x72C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x72C));

	/* A36 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A36", 0x1C00D000 + 0x730,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x730));

	/* A37 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A37", 0x1C00D000 + 0x734,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x734));

	/* A38 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A38", 0x1C00D000 + 0x738,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x738));

	/* A39 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A39", 0x1C00D000 + 0x73C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x73C));

	/* A40 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A40", 0x1C00D000 + 0x740,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x740));

	/* A41 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A41", 0x1C00D000 + 0x744,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x744));

	/* A42 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A42", 0x1C00D000 + 0x748,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x748));

	/* A43 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A43", 0x1C00D000 + 0x74C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x74C));

	/* A44 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A44", 0x1C00D000 + 0x750,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x750));

	/* A45 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A45", 0x1C00D000 + 0x754,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x754));

	/* A46 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A46", 0x1C00D000 + 0x758,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x758));

	/* A47 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A47", 0x1C00D000 + 0x75C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x75C));

	/* A48 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A48", 0x1C00D000 + 0x760,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x760));

	/* A49 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A49", 0x1C00D000 + 0x764,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x764));

	/* A50 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A50", 0x1C00D000 + 0x768,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x768));

	/* A51 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A51", 0x1C00D000 + 0x76C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x76C));

	/* A52 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A52", 0x1C00D000 + 0x770,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x770));

	/* A53 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A53", 0x1C00D000 + 0x774,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x774));

	/* A54 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A54", 0x1C00D000 + 0x778,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x778));

	/* A55 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A55", 0x1C00D000 + 0x77C,
		CONSYS_REG_READ(vir_addr_0x1c00d000_mt8875 + 0x77C));

	/* A56 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A56", 0x1C011000 + 0x518,
		CONSYS_REG_READ(vir_addr_0x1c011000_mt8875 + 0x518));

	/* A57 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A57", 0x1C011000 + 0x524,
		CONSYS_REG_READ(vir_addr_0x1c011000_mt8875 + 0x524));

	/* A58 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A58", 0x1C011000 + 0x598,
		CONSYS_REG_READ(vir_addr_0x1c011000_mt8875 + 0x598));

	/* A59 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A59", 0x1C011000 + 0x5a4,
		CONSYS_REG_READ(vir_addr_0x1c011000_mt8875 + 0x5a4));

	/* A60 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A60", 0x1C011000 + 0x70c,
		CONSYS_REG_READ(vir_addr_0x1c011000_mt8875 + 0x70c));

	/* A61 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A61", 0x1C011000 + 0x71c,
		CONSYS_REG_READ(vir_addr_0x1c011000_mt8875 + 0x71c));

	/* A62 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A62", 0x1C011000 + 0x72c,
		CONSYS_REG_READ(vir_addr_0x1c011000_mt8875 + 0x72c));

	/* A63 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		"A63", 0x40001000 + 0x10,
		CONSYS_REG_READ(vir_addr_0x40001000_mt8875 + 0x10));
...
void consys_print_power_debug_dbg_level_1_mt8875_debug_gen(
		int level,
		struct conn_debug_info_mt8875 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
		return;

	memset(pdbg_level_1_info, 0, sizeof(struct conn_debug_info_mt8875));

	if (level < 1)
		return;

	if (!vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875) {
		pr_notice("vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875(%x) ioremap fail\n",
	...
	update_debug_write_info_mt8875_debug_gen(pdbg_level_1_info,
		"B0", 0x40060000 + CONSYS_DBG_GEN_CR_CONN_INFRA_CFG_ON_DBG_MUX_SEL_OFFSET_ADDR,
		0, 2, 0x0);

	update_debug_read_info_mt8875_debug_gen(pdbg_level_1_info,
	...
	update_debug_read_info_mt8875_debug_gen(pdbg_level_1_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875 +
...
void consys_print_power_debug_dbg_level_2_mt8875_debug_gen(
		int level,
		struct conn_debug_info_mt8875 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
		return;

	memset(pdbg_level_2_info, 0, sizeof(struct conn_debug_info_mt8875));

	if (level < 2)
		return;

	if (!vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875) {
		pr_notice("vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875(%x) ioremap fail\n",
	...
	/* C0 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
	...
	update_debug_write_info_mt8875_debug_gen(pdbg_level_2_info,
	...
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875 + 0xAC4));

	/* C16 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"C16", 0x40050000 + 0xAC8,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875 + 0xAC8));

	/* C17 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"C17", 0x40050000 + 0xACC,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_conn_infra_sysram_offset_mt8875 + 0xACC));
...
void consys_print_bus_debug_dbg_level_1_mt8875_debug_gen(
		int level,
		struct conn_debug_info_mt8875 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
	...
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875 +
...
void consys_print_bus_debug_dbg_level_2_mt8875_debug_gen(
		int level,
		struct conn_debug_info_mt8875 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
	...
	if (!vir_addr_0x4004c000_mt8875) {
		pr_notice("vir_addr_0x4004c000_mt8875(%x) ioremap fail\n",
				0x4004c000);
		return;
	}
	...
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"36", 0x4004c000 + 0x4,
		CONSYS_REG_READ(vir_addr_0x4004c000_mt8875 + 0x4));

	/* 37 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"37", 0x4004c000 + 0xc,
		CONSYS_REG_READ(vir_addr_0x4004c000_mt8875 + 0xc));
	...
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"48", 0x4004c000 + 0x10,
		CONSYS_REG_READ(vir_addr_0x4004c000_mt8875 + 0x10));
	...
	/* 51 */
	CONSYS_SET_BIT(vir_addr_0x40049100_mt8875, 1);
	CONSYS_REG_WRITE(vir_addr_consys_dbg_gen_conn_dbg_ctl_base_mt8875 +
		CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_SEL_OFFSET_ADDR, 0x3);
	update_debug_write_info_mt8875_debug_gen(pdbg_level_2_info,
		"51", 0x40023000 + CONSYS_DBG_GEN_CONN_INFRA_OFF_BUS_DBG_SEL_OFFSET_ADDR,
...
void consys_print_bus_slpprot_debug_dbg_level_2_mt8875_debug_gen(
		int level,
		struct conn_debug_info_mt8875 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
...
void consys_print_bus_slpprot_debug_dbg_level_0_mt8875_debug_gen(
		int level,
		struct conn_debug_info_mt8875 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
	...
	if (!vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt8875) {
		pr_notice("vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt8875(%x) ioremap fail\n",
	...
	update_debug_read_info_mt8875_debug_gen(pdbg_level_0_info,
		...
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_apifrbus_ao_io_reg_base_mt8875 +
...
void consys_print_top_power_debug_dbg_level_0_mt8875_debug_gen(
		struct conn_debug_info_mt8875 *pdbg_level_0_info)
{
	if (pdbg_level_0_info == NULL)
		return;
	...
	update_debug_write_info_mt8875_debug_gen(pdbg_level_0_info,
...
void consys_print_top_power_debug_dbg_level_1_mt8875_debug_gen(
		struct conn_debug_info_mt8875 *pdbg_level_1_info)
{
	if (pdbg_level_1_info == NULL)
		return;
...
void consys_print_top_power_debug_dbg_level_2_mt8875_debug_gen(
		struct conn_debug_info_mt8875 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
		return;
...
void consys_print_pbus_debug_dbg_level_2_mt8875_debug_gen(
		struct conn_debug_info_mt8875 *pdbg_level_2_info)
{
	if (pdbg_level_2_info == NULL)
		return;
	...
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A0", 0x4000d000,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x0));
	/* A1 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A1", 0x4000d004,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x4));
	/* A2 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A2", 0x4000d008,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x8));
	/* A3 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A3", 0x4000d00c,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0xc));
	/* A4 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A4", 0x4000d010,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x10));
	/* A5 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A5", 0x4000d014,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x14));
	/* A6 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A6", 0x4000d018,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x18));
	/* A7 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A7", 0x4000d01c,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x1c));
	/* A8 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A8", 0x4000d020,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x20));
	/* A9 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A9", 0x4000d024,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x24));
	/* A10 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A10", 0x4000d028,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x28));
	/* A11 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A11", 0x4000d02c,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x2c));
	/* A12 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A12", 0x4000d030,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x30));
	/* A13 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A13", 0x4000d034,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x34));
	/* A14 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A14", 0x4000d038,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x38));
	/* A15 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A15", 0x4000d03c,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x3c));
	/* A16 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A16", 0x4000d040,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x40));
	/* A17 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A17", 0x4000d044,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x44));
	/* A18 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A18", 0x4000d048,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x48));
	/* A19 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A19", 0x4000d04c,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x4c));
	/* A20 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A20", 0x4000d050,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x50));
	/* A21 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A21", 0x4000d054,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x54));
	/* A22 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A22", 0x4000d058,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x58));
	/* A23 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A23", 0x4000d05c,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x5c));
	/* A24 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A24", 0x4000d060,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x60));
	/* A25 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A25", 0x4000d064,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x64));
	/* A26 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A26", 0x4000d068,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x68));
	/* A27 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A27", 0x4000d06c,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x6c));
	/* A28 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A28", 0x4000d070,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x70));
	/* A29 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A29", 0x4000d074,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x74));
	/* A30 */
	update_debug_read_info_mt8875_debug_gen(pdbg_level_2_info,
		"A30", 0x4000d078,
		CONSYS_REG_READ(vir_addr_consys_dbg_gen_pbus_base_mt8875 + 0x78));
}
