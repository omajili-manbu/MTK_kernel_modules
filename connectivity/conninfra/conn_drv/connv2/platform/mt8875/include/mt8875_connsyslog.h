...
#ifndef MT8875_CONNSYSLOG_H
#define MT8875_CONNSYSLOG_H
...
static struct connlog_emi_config g_connsyslog_config_mt8875[CONN_DEBUG_TYPE_END] = {
	/* Wi-Fi config */
	{0, 0,
		{
			{0},
