 ...
 *
 * This file, mt8875_pos_gen.h was automatically generated
...
#ifndef MT8875_POS_GEN_H
#define MT8875_POS_GEN_H

int consys_conninfra_on_power_ctrl_mt8875_gen(
		unsigned int pbus_mode,
		unsigned int trapping,
		unsigned int enable);
int consys_polling_chipid_mt8875_gen(unsigned int *pconsys_ver_id);
unsigned int consys_emi_set_remapping_reg_mt8875_gen(
...
void consys_init_conninfra_sysram_mt8875_gen(void);
void connsys_get_d_die_efuse_mt8875_gen(unsigned int *p_d_die_efuse);
int connsys_d_die_cfg_mt8875_gen(void);
void connsys_wt_slp_top_ctrl_adie6686_mt8875_gen(void);
int connsys_subsys_pll_initial_xtal_26000k_mt8875_gen(void);
int connsys_low_power_setting_mt8875_gen(void);
int consys_conninfra_wakeup_mt8875_gen(void);
