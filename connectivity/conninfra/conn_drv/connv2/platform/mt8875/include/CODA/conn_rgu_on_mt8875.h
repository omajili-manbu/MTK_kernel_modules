 ...
 */
//[File]            : conn_rgu_on.h
//[Revision time]   : Thu Aug 31 15:26:17 2023
...
#define CONN_RGU_ON_BASE                                       (CONN_RGU_ON_BASE_ADDR_MT8875) // 0x40000000
...
#define CONN_RGU_ON_MAWD_MEM_HWCTL_PDN_ADDR                    (CONN_RGU_ON_BASE + 0x0b0) // 00B0
#define CONN_RGU_ON_MAWD_MEM_HWCTL_SLP_ADDR                    (CONN_RGU_ON_BASE + 0x0b4) // 00B4
#define CONN_RGU_ON_MAWD_MEM_SWCTL_PDN_ADDR                    (CONN_RGU_ON_BASE + 0x0b8) // 00B8
#define CONN_RGU_ON_MAWD_MEM_SWCTL_SLP_ADDR                    (CONN_RGU_ON_BASE + 0x0bC) // 00BC
#define CONN_RGU_ON_MAWD_MEM_SWCTL_CKISO_ADDR                  (CONN_RGU_ON_BASE + 0x0c0) // 00C0
#define CONN_RGU_ON_MAWD_MEM_SWCTL_ISOINT_ADDR                 (CONN_RGU_ON_BASE + 0x0c4) // 00C4
...
#define CONN_RGU_ON_GPSSYS_CPU_SW_RST_B_ADDR                   (CONN_RGU_ON_BASE + 0x130) // 0130
...
#define CONN_RGU_ON_GPSSYS_SW_RST_B_ADDR                       (CONN_RGU_ON_BASE + 0x150) // 0150
#define CONN_RGU_ON_SEMA_M0_SW_RST_B_ADDR                      (CONN_RGU_ON_BASE + 0x158) // 0158
#define CONN_RGU_ON_SEMA_M1_SW_RST_B_ADDR                      (CONN_RGU_ON_BASE + 0x15C) // 015C
...
#define CONN_RGU_ON_MAWD_MEM_PDN_ST_ADDR                       (CONN_RGU_ON_BASE + 0x470) // 0470
#define CONN_RGU_ON_MAWD_MEM_SLP_ST_ADDR                       (CONN_RGU_ON_BASE + 0x474) // 0474
#define CONN_RGU_ON_MAWD_MEM_CKISO_ST_ADDR                     (CONN_RGU_ON_BASE + 0x478) // 0478
#define CONN_RGU_ON_MAWD_MEM_ISOINT_ST_ADDR                    (CONN_RGU_ON_BASE + 0x47C) // 047C
...
/* =====================================================================================
  ...
  ---MEM_PWR_CTL (0x18000000 + 0x040)---
    ...
    OSC_RDY_MASK_FOR_MEM_ON[0]   - (RW) conn_infra memory power on check
                                     0: conn_infra mem power on after osc_rdy=1
                                     1: don't' care osc_rdy value
    RESERVED1[31..1]             - (RO) Reserved bits
...
/* =====================================================================================
  ...
  ---SYSRAM_HWCTL_PDN (0x18000000 + 0x050)---
    ...
    SYSRAM_HWCTL_PDN[0]          - (RW) 0: power-on/power-down control by S/W CR *_SWCTL_*
...
#define CONN_RGU_ON_SYSRAM_HWCTL_PDN_SYSRAM_HWCTL_PDN_MASK     0x00000001                // SYSRAM_HWCTL_PDN[0]
...
/* =====================================================================================
  ...
  ---SYSRAM_HWCTL_SLP (0x18000000 + 0x054)---
    ...
    SYSRAM_HWCTL_SLP[0]          - (RW) 0: wakeup/sleep control by S/W CR *_SWCTL_*
                                     1: wakeup/sleep control by H/W
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_SYSRAM_HWCTL_SLP_SYSRAM_HWCTL_SLP_ADDR     CONN_RGU_ON_SYSRAM_HWCTL_SLP_ADDR
#define CONN_RGU_ON_SYSRAM_HWCTL_SLP_SYSRAM_HWCTL_SLP_MASK     0x00000001                // SYSRAM_HWCTL_SLP[0]
...
/* =====================================================================================
  ...
  ---SYSRAM_SWCTL_PDN (0x18000000 + 0x058)---
    ...
    SYSRAM_SWCTL_PDN[0]          - (RW) 0: power-down=0
                                     1: power-down=1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_SYSRAM_SWCTL_PDN_SYSRAM_SWCTL_PDN_ADDR     CONN_RGU_ON_SYSRAM_SWCTL_PDN_ADDR
#define CONN_RGU_ON_SYSRAM_SWCTL_PDN_SYSRAM_SWCTL_PDN_MASK     0x00000001                // SYSRAM_SWCTL_PDN[0]
...
/* =====================================================================================
  ...
  ---SYSRAM_SWCTL_SLP (0x18000000 + 0x05C)---
    ...
    SYSRAM_SWCTL_SLP[0]          - (RW) 0: sleep=0
                                     1: sleep=1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_SYSRAM_SWCTL_SLP_SYSRAM_SWCTL_SLP_ADDR     CONN_RGU_ON_SYSRAM_SWCTL_SLP_ADDR
#define CONN_RGU_ON_SYSRAM_SWCTL_SLP_SYSRAM_SWCTL_SLP_MASK     0x00000001                // SYSRAM_SWCTL_SLP[0]
...
/* =====================================================================================
  ...
  ---SYSRAM_SWCTL_CKISO (0x18000000 + 0x060)---
    ...
    SYSRAM_SWCTL_CKISO[0]        - (RW) 0: ckiso=0
                                     1: ckiso=1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_SYSRAM_SWCTL_CKISO_SYSRAM_SWCTL_CKISO_ADDR CONN_RGU_ON_SYSRAM_SWCTL_CKISO_ADDR
#define CONN_RGU_ON_SYSRAM_SWCTL_CKISO_SYSRAM_SWCTL_CKISO_MASK 0x00000001                // SYSRAM_SWCTL_CKISO[0]
...
/* =====================================================================================
  ...
  ---SYSRAM_SWCTL_ISOINT (0x18000000 + 0x064)---
    ...
    SYSRAM_SWCTL_ISOINT[0]       - (RW) 0: isoint=0
                                     1: isoint=1
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_SYSRAM_SWCTL_ISOINT_SYSRAM_SWCTL_ISOINT_ADDR CONN_RGU_ON_SYSRAM_SWCTL_ISOINT_ADDR
#define CONN_RGU_ON_SYSRAM_SWCTL_ISOINT_SYSRAM_SWCTL_ISOINT_MASK 0x00000001                // SYSRAM_SWCTL_ISOINT[0]
...
/* =====================================================================================
  ...
  ---MAWD_MEM_HWCTL_PDN (0x18000000 + 0x0b0)---

    MAWD_MEM_HWCTL_PDN[4..0]     - (RW) 0: power-on/power-down control by S/W CR *_SWCTL_*
                                     1: power-on/power-down control by H/W
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_HWCTL_PDN_MAWD_MEM_HWCTL_PDN_ADDR CONN_RGU_ON_MAWD_MEM_HWCTL_PDN_ADDR
#define CONN_RGU_ON_MAWD_MEM_HWCTL_PDN_MAWD_MEM_HWCTL_PDN_MASK 0x0000001F                // MAWD_MEM_HWCTL_PDN[4..0]
#define CONN_RGU_ON_MAWD_MEM_HWCTL_PDN_MAWD_MEM_HWCTL_PDN_SHFT 0

/* =====================================================================================

  ---MAWD_MEM_HWCTL_SLP (0x18000000 + 0x0b4)---

    MAWD_MEM_HWCTL_SLP[4..0]     - (RW) 0: wakeup/sleep control by S/W CR *_SWCTL_*
                                     1: wakeup/sleep control by H/W
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_HWCTL_SLP_MAWD_MEM_HWCTL_SLP_ADDR CONN_RGU_ON_MAWD_MEM_HWCTL_SLP_ADDR
#define CONN_RGU_ON_MAWD_MEM_HWCTL_SLP_MAWD_MEM_HWCTL_SLP_MASK 0x0000001F                // MAWD_MEM_HWCTL_SLP[4..0]
#define CONN_RGU_ON_MAWD_MEM_HWCTL_SLP_MAWD_MEM_HWCTL_SLP_SHFT 0

/* =====================================================================================

  ---MAWD_MEM_SWCTL_PDN (0x18000000 + 0x0b8)---

    MAWD_MEM_SWCTL_PDN[4..0]     - (RW) 0: power-down=0
                                     1: power-down=1
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_SWCTL_PDN_MAWD_MEM_SWCTL_PDN_ADDR CONN_RGU_ON_MAWD_MEM_SWCTL_PDN_ADDR
#define CONN_RGU_ON_MAWD_MEM_SWCTL_PDN_MAWD_MEM_SWCTL_PDN_MASK 0x0000001F                // MAWD_MEM_SWCTL_PDN[4..0]
#define CONN_RGU_ON_MAWD_MEM_SWCTL_PDN_MAWD_MEM_SWCTL_PDN_SHFT 0

/* =====================================================================================

  ---MAWD_MEM_SWCTL_SLP (0x18000000 + 0x0bC)---

    MAWD_MEM_SWCTL_SLP[4..0]     - (RW) 0: sleep=0
                                     1: sleep=1
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_SWCTL_SLP_MAWD_MEM_SWCTL_SLP_ADDR CONN_RGU_ON_MAWD_MEM_SWCTL_SLP_ADDR
#define CONN_RGU_ON_MAWD_MEM_SWCTL_SLP_MAWD_MEM_SWCTL_SLP_MASK 0x0000001F                // MAWD_MEM_SWCTL_SLP[4..0]
#define CONN_RGU_ON_MAWD_MEM_SWCTL_SLP_MAWD_MEM_SWCTL_SLP_SHFT 0

/* =====================================================================================

  ---MAWD_MEM_SWCTL_CKISO (0x18000000 + 0x0c0)---

    MAWD_MEM_SWCTL_CKISO[4..0]   - (RW) 0: ckiso=0
                                     1: ckiso=1
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_SWCTL_CKISO_MAWD_MEM_SWCTL_CKISO_ADDR CONN_RGU_ON_MAWD_MEM_SWCTL_CKISO_ADDR
#define CONN_RGU_ON_MAWD_MEM_SWCTL_CKISO_MAWD_MEM_SWCTL_CKISO_MASK 0x0000001F                // MAWD_MEM_SWCTL_CKISO[4..0]
#define CONN_RGU_ON_MAWD_MEM_SWCTL_CKISO_MAWD_MEM_SWCTL_CKISO_SHFT 0

/* =====================================================================================

  ---MAWD_MEM_SWCTL_ISOINT (0x18000000 + 0x0c4)---

    MAWD_MEM_SWCTL_ISOINT[4..0]  - (RW) 0: isoint=0
                                     1: isoint=1
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_SWCTL_ISOINT_MAWD_MEM_SWCTL_ISOINT_ADDR CONN_RGU_ON_MAWD_MEM_SWCTL_ISOINT_ADDR
#define CONN_RGU_ON_MAWD_MEM_SWCTL_ISOINT_MAWD_MEM_SWCTL_ISOINT_MASK 0x0000001F                // MAWD_MEM_SWCTL_ISOINT[4..0]
#define CONN_RGU_ON_MAWD_MEM_SWCTL_ISOINT_MAWD_MEM_SWCTL_ISOINT_SHFT 0
...
/* =====================================================================================
  ...
  ---GPSSYS_CPU_SW_RST_B (0x18000000 + 0x130)---

    GPSSYS_CPU_SW_RST_B[0]       - (RW) GPSSYS CPU software reset (active-low) to GPSSYS CPU
                                     0: reset
                                     1: not reset
    RESERVED1[31..1]             - (RO) Reserved bits
...
#define CONN_RGU_ON_GPSSYS_CPU_SW_RST_B_GPSSYS_CPU_SW_RST_B_MASK 0x00000001                // GPSSYS_CPU_SW_RST_B[0]
...
/* =====================================================================================
  ...
  ---WFSYS_SW_RST_B (0x18000000 + 0x140)---
    ...
    WFSYS_SW_RST_B[0]            - (RW) WFSYS software reset (active-low)
                                     0: reset
                                     1: not reset
    WFSYS_SW_RST_BYPASS[2..1]    - (RW) WFSYS software reset bypass waiting "HW auto-switch bus clock" and "HW auto-control slpprot"
                                     0: not bypass
                                     1: bypass
    ...
    WFSYS_SW_INIT_DONE[4]        - (RW) Used for SW to indicate "WFSYS initial done after software reset"
                                     0: SW INIT. On-going
                                     1: SW INIT. Done
    WFSYS_ON_TOP_RST_VLD_FOR_SEMA[5] - (RW) wfsys_on_top pwr reset trigger semaphore reset or not
                                     0: disable
                                     1: enable
    RESERVED6[31..6]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_WFSYS_SW_RST_B_WFSYS_ON_TOP_RST_VLD_FOR_SEMA_ADDR CONN_RGU_ON_WFSYS_SW_RST_B_ADDR
#define CONN_RGU_ON_WFSYS_SW_RST_B_WFSYS_ON_TOP_RST_VLD_FOR_SEMA_MASK 0x00000020                // WFSYS_ON_TOP_RST_VLD_FOR_SEMA[5]
#define CONN_RGU_ON_WFSYS_SW_RST_B_WFSYS_ON_TOP_RST_VLD_FOR_SEMA_SHFT 5
...
#define CONN_RGU_ON_WFSYS_SW_RST_B_WFSYS_SW_RST_BYPASS_MASK    0x00000006                // WFSYS_SW_RST_BYPASS[2..1]
...
/* =====================================================================================
  ...
  ---BGFSYS_SW_RST_B (0x18000000 + 0x144)---
    ...
    BGFSYS_SW_RST_B[0]           - (RW) BGFSYS software reset (active-low)
                                     0: reset
                                     1: not reset
    BGFSYS_SW_RST_BYPASS[2..1]   - (RW) BGFSYS software reset bypass waiting "HW auto-switch bus clock" and "HW auto-control slpprot"
                                     0: not bypass
                                     1: bypass
    RESERVED3[3]                 - (RO) Reserved bits
    BGFSYS_SW_INIT_DONE[4]       - (RW) Used for SW to indicate "BGFSYS initial done after software reset"
                                     0: SW INIT. On-going
                                     1: SW INIT. Done
    BGFSYS_ON_TOP_RST_VLD_FOR_SEMA[5] - (RW) bgfsys_on_top pwr reset trigger semaphore reset or not
                                     0: disable
                                     1: enable
    RESERVED6[31..6]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_BGFSYS_SW_RST_B_BGFSYS_ON_TOP_RST_VLD_FOR_SEMA_ADDR CONN_RGU_ON_BGFSYS_SW_RST_B_ADDR
#define CONN_RGU_ON_BGFSYS_SW_RST_B_BGFSYS_ON_TOP_RST_VLD_FOR_SEMA_MASK 0x00000020                // BGFSYS_ON_TOP_RST_VLD_FOR_SEMA[5]
#define CONN_RGU_ON_BGFSYS_SW_RST_B_BGFSYS_ON_TOP_RST_VLD_FOR_SEMA_SHFT 5
...
#define CONN_RGU_ON_BGFSYS_SW_RST_B_BGFSYS_SW_RST_BYPASS_MASK  0x00000006                // BGFSYS_SW_RST_BYPASS[2..1]
...
/* =====================================================================================
  ...
  ---GPSSYS_SW_RST_B (0x18000000 + 0x150)---

    GPSSYS_SW_RST_B[0]           - (RW) GPSSYS software reset (active-low)
                                     0: reset
                                     1: not reset
    RESERVED1[3..1]              - (RO) Reserved bits
    GPSSYS_SW_INIT_DONE[4]       - (RW) Used for SW to indicate "GPSSYS initial done after software reset"
                                     0: SW INIT. On-going
                                     1: SW INIT. Done
    RESERVED5[31..5]             - (RO) Reserved bits
...
#define CONN_RGU_ON_GPSSYS_SW_RST_B_GPSSYS_SW_INIT_DONE_MASK   0x00000010                // GPSSYS_SW_INIT_DONE[4]
...
#define CONN_RGU_ON_GPSSYS_SW_RST_B_GPSSYS_SW_RST_B_MASK       0x00000001                // GPSSYS_SW_RST_B[0]
#define CONN_RGU_ON_GPSSYS_SW_RST_B_GPSSYS_SW_RST_B_SHFT       0

/* =====================================================================================

  ---SEMA_M0_SW_RST_B (0x18000000 + 0x158)---
...
#define CONN_RGU_ON_SEMA_M0_SW_RST_B_SEMA_M0_SW_RST_B_MASK     0x00000001                // SEMA_M0_SW_RST_B[0]
#define CONN_RGU_ON_SEMA_M0_SW_RST_B_SEMA_M0_SW_RST_B_SHFT     0

/* =====================================================================================

  ---SEMA_M1_SW_RST_B (0x18000000 + 0x15C)---
...
#define CONN_RGU_ON_SEMA_M1_SW_RST_B_SEMA_M1_SW_RST_B_MASK     0x00000001                // SEMA_M1_SW_RST_B[0]
...
/* =====================================================================================
  ...
  ---MAWD_MEM_PDN_ST (0x18000000 + 0x470)---

    MAWD_MEM_PDN_ST[4..0]        - (RO) 0: power-down=0
                                     1: power-down=1
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_PDN_ST_MAWD_MEM_PDN_ST_ADDR       CONN_RGU_ON_MAWD_MEM_PDN_ST_ADDR
#define CONN_RGU_ON_MAWD_MEM_PDN_ST_MAWD_MEM_PDN_ST_MASK       0x0000001F                // MAWD_MEM_PDN_ST[4..0]
#define CONN_RGU_ON_MAWD_MEM_PDN_ST_MAWD_MEM_PDN_ST_SHFT       0

/* =====================================================================================

  ---MAWD_MEM_SLP_ST (0x18000000 + 0x474)---

    MAWD_MEM_SLP_ST[4..0]        - (RO) 0: sleep=0
                                     1: sleep=1
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_SLP_ST_MAWD_MEM_SLP_ST_ADDR       CONN_RGU_ON_MAWD_MEM_SLP_ST_ADDR
#define CONN_RGU_ON_MAWD_MEM_SLP_ST_MAWD_MEM_SLP_ST_MASK       0x0000001F                // MAWD_MEM_SLP_ST[4..0]
#define CONN_RGU_ON_MAWD_MEM_SLP_ST_MAWD_MEM_SLP_ST_SHFT       0

/* =====================================================================================

  ---MAWD_MEM_CKISO_ST (0x18000000 + 0x478)---

    MAWD_MEM_CKISO_ST[4..0]      - (RO) 0: ckiso=0
                                     1: ckiso=1
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_CKISO_ST_MAWD_MEM_CKISO_ST_ADDR   CONN_RGU_ON_MAWD_MEM_CKISO_ST_ADDR
#define CONN_RGU_ON_MAWD_MEM_CKISO_ST_MAWD_MEM_CKISO_ST_MASK   0x0000001F                // MAWD_MEM_CKISO_ST[4..0]
#define CONN_RGU_ON_MAWD_MEM_CKISO_ST_MAWD_MEM_CKISO_ST_SHFT   0

/* =====================================================================================

  ---MAWD_MEM_ISOINT_ST (0x18000000 + 0x47C)---

    MAWD_MEM_ISOINT_ST[4..0]     - (RO) 0: isoint=0
                                     1: isoint=1
    RESERVED5[31..5]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_RGU_ON_MAWD_MEM_ISOINT_ST_MAWD_MEM_ISOINT_ST_ADDR CONN_RGU_ON_MAWD_MEM_ISOINT_ST_ADDR
#define CONN_RGU_ON_MAWD_MEM_ISOINT_ST_MAWD_MEM_ISOINT_ST_MASK 0x0000001F                // MAWD_MEM_ISOINT_ST[4..0]
#define CONN_RGU_ON_MAWD_MEM_ISOINT_ST_MAWD_MEM_ISOINT_ST_SHFT 0
