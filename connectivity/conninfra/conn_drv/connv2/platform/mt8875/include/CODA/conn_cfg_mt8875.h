 ...
 */
//[File]            : conn_cfg.h
//[Revision time]   : Thu Aug 31 15:24:27 2023
...
#define CONN_CFG_BASE                                          (CONN_CFG_BASE_ADDR_MT8875) // 0x40011000
...
/* =====================================================================================
  ...
  ---EMI_CTL_0 (0x18011000 + 0x100)---
    ...
    EMI_PATH_SLP_PROT_EN_BP[27]  - (RW) bypass check conn2ap emi path sleep protect enable
    EMI_PATH_SLP_PROT_DIS_BP[28] - (RW) bypass check conn2ap emi path sleep protect disable
...
#define CONN_CFG_EMI_CTL_0_EMI_PATH_SLP_PROT_DIS_BP_MASK       0x10000000                // EMI_PATH_SLP_PROT_DIS_BP[28]
#define CONN_CFG_EMI_CTL_0_EMI_PATH_SLP_PROT_DIS_BP_SHFT       28
#define CONN_CFG_EMI_CTL_0_EMI_PATH_SLP_PROT_EN_BP_ADDR        CONN_CFG_EMI_CTL_0_ADDR
#define CONN_CFG_EMI_CTL_0_EMI_PATH_SLP_PROT_EN_BP_MASK        0x08000000                // EMI_PATH_SLP_PROT_EN_BP[27]
#define CONN_CFG_EMI_CTL_0_EMI_PATH_SLP_PROT_EN_BP_SHFT        27
