 ...
 */
//[File]            : conn_cfg_on.h
//[Revision time]   : Thu Aug 31 15:24:46 2023
...
#define CONN_CFG_ON_BASE                                       (CONN_CFG_ON_BASE_ADDR_MT8875) // 0x40001000
...
#define CONN_CFG_ON_CONN_MAWD_WAKE_IND_ADDR                    (CONN_CFG_ON_BASE + 0x140) // 1140
...
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR (CONN_CFG_ON_BASE + 0x488) // 1488
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR    (CONN_CFG_ON_BASE + 0x490) // 1490
...
/* =====================================================================================
  ...
  ---CONN_INFRA_CFG_GPS_MANUAL_CTRL (0x18001000 + 0x10C)---
    ...
    GPS_MANUAL_CTRL[16]          - (RW) gpssys manual control cr(reserved)
    SW_GPS_AP_MODE_EN[17]        - (RW) indicate support gps mcu_mode or gps ap_mode ,default gps mcu_mode
                                     1'b1: GPS AP_MODE
    SW_R2H_RST_MASK_INV[18]      - (RW) mask gps mcu to gps_rgu_on r2h_rst_b
                                     1'b1: unmask
    SW_GPS_TOP_ON_OSC_DIV2_EN[19] - (RW) gps_clkgen_on osc div2 enable
                                     1'b1 : enable divider
...
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_GPS_TOP_ON_OSC_DIV2_EN_ADDR CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_GPS_TOP_ON_OSC_DIV2_EN_MASK 0x00080000                // SW_GPS_TOP_ON_OSC_DIV2_EN[19]
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_GPS_TOP_ON_OSC_DIV2_EN_SHFT 19
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_R2H_RST_MASK_INV_ADDR CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_R2H_RST_MASK_INV_MASK 0x00040000                // SW_R2H_RST_MASK_INV[18]
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_R2H_RST_MASK_INV_SHFT 18
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_GPS_AP_MODE_EN_ADDR CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_GPS_AP_MODE_EN_MASK 0x00020000                // SW_GPS_AP_MODE_EN[17]
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_SW_GPS_AP_MODE_EN_SHFT 17
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_GPS_MANUAL_CTRL_ADDR CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_CFG_GPS_MANUAL_CTRL_GPS_MANUAL_CTRL_MASK 0x00010000                // GPS_MANUAL_CTRL[16]
...
/* =====================================================================================
  ...
  ---CONN_MAWD_WAKE_IND (0x18001000 + 0x140)---

    CONN_MAWD_WAKEUP_IND[0]      - (RW)  xxx 
    RESERVED1[31..1]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_CFG_ON_CONN_MAWD_WAKE_IND_CONN_MAWD_WAKEUP_IND_ADDR CONN_CFG_ON_CONN_MAWD_WAKE_IND_ADDR
#define CONN_CFG_ON_CONN_MAWD_WAKE_IND_CONN_MAWD_WAKEUP_IND_MASK 0x00000001                // CONN_MAWD_WAKEUP_IND[0]
#define CONN_CFG_ON_CONN_MAWD_WAKE_IND_CONN_MAWD_WAKEUP_IND_SHFT 0

/* =====================================================================================

  ---CONN_INFRA_CONN2AP_EINT_MASK (0x18001000 + 0x150)---

    CONN_INFRA_CONN2AP_EINT_MASK[31..0] - (RW) CONN_INFRA_CONN2AP_EINT_MASK
                                     bit1:
                                     bit 0: if 1'b1, mask conn_infra2ap_wakeup_b
                                     bit1: if 1'b1, mask bgf2ap_wakeup_b
                                     bit2: if 1'b1, mask wf2ap_wakeup_b
                                     bit3:  if 1'b1, mask conn2ap_wfdma_irq_b
                                     bit8: if 1'b1, mask conn_bgf_hif_on_host_intb
                                     bit9: if 1'b1, mask conn_gps_hif_on_host_intb
                                     bit12: if 1'b1, mask ccif_wf2ap_sw_irq_b
                                     bit13: if 1'b1, mask ccif_bgf2ap_sw_irq_b
                                     bit16: if 1'b1, mask bgfsys_wdt_irq_b
                                     bit17: if 1'b1, mask wfsys_wdt_irq_b

 =====================================================================================*/
#define CONN_CFG_ON_CONN_INFRA_CONN2AP_EINT_MASK_CONN_INFRA_CONN2AP_EINT_MASK_ADDR CONN_CFG_ON_CONN_INFRA_CONN2AP_EINT_MASK_ADDR
#define CONN_CFG_ON_CONN_INFRA_CONN2AP_EINT_MASK_CONN_INFRA_CONN2AP_EINT_MASK_MASK 0xFFFFFFFF                // CONN_INFRA_CONN2AP_EINT_MASK[31..0]
#define CONN_CFG_ON_CONN_INFRA_CONN2AP_EINT_MASK_CONN_INFRA_CONN2AP_EINT_MASK_SHFT 0
...
/* =====================================================================================
  ...
  ---CONN_INFRA_CFG_PWRCTRL0 (0x18001000 + 0x200)---
    ...
    CONN_INFRA_CFG_SLP_RDY_CONN2AP_DIS_MASK[23..20] - (RW) conn2ap slp protect rdy tx and rx (high -> low) mask for conn_infra_cfg_slp_ctl
                                     bit-20: if 1'b1,conn2ap tx disable rdy  mask
                                     bit-21: if 1'b1, conn2ap rx disable rdy  mask
                                     bit-22: if 1'b1, on2off disable rdy  mask
                                     bit-23: if 1'b1, off2on disable rdy  mask
...
/* =====================================================================================
  ...
  ---OSC_CTL_1 (0x18001000 + 0x304)---
    ...
    RF_LDO_MASK_FOR_XO[17]       - (RW) mask rf_ldo_rdy  to turn-on OSC
                                     1'h0: un-mask
    SLP_CTL_XTAL_ON_MASK_FOR_XO[18] - (RW) mask xtal_on from slp_ctl to turn on OSC
                                     1'b1: mask
    RESERVED19[30..19]           - (RO) Reserved bits
...
#define CONN_CFG_ON_OSC_CTL_1_SLP_CTL_XTAL_ON_MASK_FOR_XO_ADDR CONN_CFG_ON_OSC_CTL_1_ADDR
#define CONN_CFG_ON_OSC_CTL_1_SLP_CTL_XTAL_ON_MASK_FOR_XO_MASK 0x00040000                // SLP_CTL_XTAL_ON_MASK_FOR_XO[18]
#define CONN_CFG_ON_OSC_CTL_1_SLP_CTL_XTAL_ON_MASK_FOR_XO_SHFT 18
...
/* =====================================================================================
  ...
  ---OSC_MASK (0x18001000 + 0x308)---
    ...
    CONN_INFRA_WAKEUP_MAWD[29]   - (RO) indicator: "CONN_INFRA_WAKEUP_MAWD"(from host_csr)
    RESERVED30[31..30]           - (RO) Reserved bits

 =====================================================================================*/
#define CONN_CFG_ON_OSC_MASK_CONN_INFRA_WAKEUP_MAWD_ADDR       CONN_CFG_ON_OSC_MASK_ADDR
#define CONN_CFG_ON_OSC_MASK_CONN_INFRA_WAKEUP_MAWD_MASK       0x20000000                // CONN_INFRA_WAKEUP_MAWD[29]
#define CONN_CFG_ON_OSC_MASK_CONN_INFRA_WAKEUP_MAWD_SHFT       29
...
/* =====================================================================================
  ...
  ---OSC_2X_MASK (0x18001000 + 0x318)---
    ...
    OSC_2X_EN_MASK_14[22]        - (RW) mask OSC_2X enable request
                                     OSC_EN_MASK[14]: set 1'b1 to mask "cr_wakeup_conn_infra_off" used for MAWD driver (from conn_host_csr_top)
    RESERVED23[31..23]           - (RO) Reserved bits

 =====================================================================================*/
#define CONN_CFG_ON_OSC_2X_MASK_OSC_2X_EN_MASK_14_ADDR         CONN_CFG_ON_OSC_2X_MASK_ADDR
#define CONN_CFG_ON_OSC_2X_MASK_OSC_2X_EN_MASK_14_MASK         0x00400000                // OSC_2X_EN_MASK_14[22]
#define CONN_CFG_ON_OSC_2X_MASK_OSC_2X_EN_MASK_14_SHFT         22
...
/* =====================================================================================
  ...
  ---EMI_CTL_0 (0x18001000 + 0x3A0)---
    ...
    CONN_DDR_EN_SW_MODE[2]       - (RW) conn_ddr_en sw mode
                                     1'b1: sw mode
                                     1'b0: hw mode
    CONN_VRF18_SW_MODE[3]        - (RW) conn_vrf18_req sw mode
                                     1'b1: sw mode
                                     1'b0: hw mode
    ...
    SW_CONN_VRF18_REG[7]         - (RW) conn_vrf18_req sw control
    EMI_CTL_SLPPROT_DIS[8]       - (RW) disable slpprot control for emi_ctl
    CONN_DDREN_URGENT_SW_MODE[9] - (RW) conn_ddren_urgent_req sw mode
                                     1'b1: sw mode
                                     1'b0: hw mode
    SW_CONN_DDREN_URGENT_REG[10] - (RW) conn_ddren_urgent_req sw control
    RESERVED11[31..11]           - (RO) Reserved bits

 =====================================================================================*/
#define CONN_CFG_ON_EMI_CTL_0_SW_CONN_DDREN_URGENT_REG_ADDR    CONN_CFG_ON_EMI_CTL_0_ADDR
#define CONN_CFG_ON_EMI_CTL_0_SW_CONN_DDREN_URGENT_REG_MASK    0x00000400                // SW_CONN_DDREN_URGENT_REG[10]
#define CONN_CFG_ON_EMI_CTL_0_SW_CONN_DDREN_URGENT_REG_SHFT    10
#define CONN_CFG_ON_EMI_CTL_0_CONN_DDREN_URGENT_SW_MODE_ADDR   CONN_CFG_ON_EMI_CTL_0_ADDR
#define CONN_CFG_ON_EMI_CTL_0_CONN_DDREN_URGENT_SW_MODE_MASK   0x00000200                // CONN_DDREN_URGENT_SW_MODE[9]
#define CONN_CFG_ON_EMI_CTL_0_CONN_DDREN_URGENT_SW_MODE_SHFT   9
...
#define CONN_CFG_ON_EMI_CTL_0_SW_CONN_VRF18_REG_ADDR           CONN_CFG_ON_EMI_CTL_0_ADDR
#define CONN_CFG_ON_EMI_CTL_0_SW_CONN_VRF18_REG_MASK           0x00000080                // SW_CONN_VRF18_REG[7]
#define CONN_CFG_ON_EMI_CTL_0_SW_CONN_VRF18_REG_SHFT           7
...
#define CONN_CFG_ON_EMI_CTL_0_CONN_VRF18_SW_MODE_ADDR          CONN_CFG_ON_EMI_CTL_0_ADDR
#define CONN_CFG_ON_EMI_CTL_0_CONN_VRF18_SW_MODE_MASK          0x00000008                // CONN_VRF18_SW_MODE[3]
#define CONN_CFG_ON_EMI_CTL_0_CONN_VRF18_SW_MODE_SHFT          3
...
/* =====================================================================================
  ...
  ---GALS_CONN2GPS_SLP_STATUS (0x18001000 + 0x474)---
    ...
    CONN2GPS_GALS_CTRL_PROT_TX_EN_BG[27] - (RO) conn2gps gals sleep protect control sleep protect tx enable from bgsys
...
#define CONN_CFG_ON_GALS_CONN2GPS_SLP_STATUS_CONN2GPS_GALS_CTRL_PROT_TX_EN_BG_ADDR CONN_CFG_ON_GALS_CONN2GPS_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_CONN2GPS_SLP_STATUS_CONN2GPS_GALS_CTRL_PROT_TX_EN_BG_MASK 0x08000000                // CONN2GPS_GALS_CTRL_PROT_TX_EN_BG[27]
#define CONN_CFG_ON_GALS_CONN2GPS_SLP_STATUS_CONN2GPS_GALS_CTRL_PROT_TX_EN_BG_SHFT 27
...
/* =====================================================================================
  ...
  ---GALS_GPS2CONN_SLP_STATUS (0x18001000 + 0x484)---
    ...
    RESERVED24[26..24]           - (RO) Reserved bits
    GPS2CONN_GALS_CTRL_PROT_RX_EN_BG[27] - (RO) gps2conn gals sleep protect control sleep protect rx enable from bgsys
...
#define CONN_CFG_ON_GALS_GPS2CONN_SLP_STATUS_GPS2CONN_GALS_CTRL_PROT_RX_EN_BG_ADDR CONN_CFG_ON_GALS_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_GPS2CONN_SLP_STATUS_GPS2CONN_GALS_CTRL_PROT_RX_EN_BG_MASK 0x08000000                // GPS2CONN_GALS_CTRL_PROT_RX_EN_BG[27]
#define CONN_CFG_ON_GALS_GPS2CONN_SLP_STATUS_GPS2CONN_GALS_CTRL_PROT_RX_EN_BG_SHFT 27
...
/* =====================================================================================
  ...
  ---CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL (0x18001000 + 0x488)---

    CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_EN[0] - (RW) 1: force conn_infra_gals_AXI_LAYER_GPS2CONN_tx sleep protect en
                                     0: conn_infra_gals_AXI_LAYER_GPS2CONN_tx sleep protect en depends on disable control or hardware
    CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_DIS[1] - (RW) if force en == 1'b0 (SE_EN == 1'b0)
                                     1: conn_infra_gals_AXI_LAYER_GPS2CONN_tx sleep protect disable
                                     0: conn_infra_gals_AXI_LAYER_GPS2CONN_tx  sleep protect will control by hardware
    RESERVED2[3..2]              - (RO) Reserved bits
    CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_EN[4] - (RW) 1: force conn_infra_gals_AXI_LAYER_GPS2CONN_rx sleep protect en
                                     0: conn_infra_gals_AXI_LAYER_GPS2CONN_rx sleep protect en depends on disable control or hardware
    CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_DIS[5] - (RW) if force en == 1'b0 (SE_EN == 1'b0)
                                     1: conn_infra_gals_AXI_LAYER_GPS2CONN_rx sleep protect disable
                                     0: conn_infra_gals_AXI_LAYER_GPS2CONN_rx  sleep protect will control by hardware
    RESERVED6[7..6]              - (RO) Reserved bits
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_EN[8] - (RW) timeout function enable
                                     1: enable
                                     0: disable
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_CLR[9] - (RW) clear timeout irq, write 1 to clear, and need to write 0 after write 1
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_TIME[15..10] - (RW) timeout timing set, count with 32k clock
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_FSM_RST[16] - (RW) fsm_reset, 1:reset, 0: release
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_MODE[17] - (RW) tx sleep protect en mode, 1: sw mode, 0: hw mode
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_SW_CTRL[18] - (RW) tx sleep protect sw ctrl
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_MODE[19] - (RW) rx sleep protect en mode, 1: sw mode, 0: hw mode
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_SW_CTRL[20] - (RW) rx sleep protect sw ctrl
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MODE[21] - (RW) tx sleep protect rdy mode, 1: sw mode, 0: hw mode
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_SW_CTRL[22] - (RW) tx sleep protect rdy sw ctrl
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MASK[23] - (RW) tx sleep protect rdy mask
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MODE[24] - (RW) rx sleep protect rdy mode, 1: sw mode, 0: hw mode
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_SW_CTRL[25] - (RW) rx sleep protect rdy sw ctrl
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MASK[26] - (RW) rx sleep protect rdy mask
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_MODE[27] - (RW) gals sleep protect mode, 1: sw, 0: hw
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_SW_EN[28] - (RW) sleep protect sw en
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_0_MASK[29] - (RW) hw enable signal  0 mask
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_1_MASK[30] - (RW) hw enable signal  1 mask
    AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_DUMMY[31] - (RW)  xxx 

 =====================================================================================*/
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_DUMMY_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_DUMMY_MASK 0x80000000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_DUMMY[31]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_DUMMY_SHFT 31
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_1_MASK_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_1_MASK_MASK 0x40000000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_1_MASK[30]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_1_MASK_SHFT 30
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_0_MASK_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_0_MASK_MASK 0x20000000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_0_MASK[29]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_HW_EN_0_MASK_SHFT 29
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_SW_EN_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_SW_EN_MASK 0x10000000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_SW_EN[28]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_SW_EN_SHFT 28
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_MODE_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_MODE_MASK 0x08000000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_MODE[27]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_MODE_SHFT 27
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MASK_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MASK_MASK 0x04000000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MASK[26]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MASK_SHFT 26
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_SW_CTRL_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_SW_CTRL_MASK 0x02000000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_SW_CTRL[25]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_SW_CTRL_SHFT 25
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MODE_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MODE_MASK 0x01000000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MODE[24]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_RDY_MODE_SHFT 24
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MASK_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MASK_MASK 0x00800000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MASK[23]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MASK_SHFT 23
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_SW_CTRL_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_SW_CTRL_MASK 0x00400000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_SW_CTRL[22]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_SW_CTRL_SHFT 22
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MODE_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MODE_MASK 0x00200000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MODE[21]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_RDY_MODE_SHFT 21
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_SW_CTRL_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_SW_CTRL_MASK 0x00100000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_SW_CTRL[20]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_SW_CTRL_SHFT 20
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_MODE_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_MODE_MASK 0x00080000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_MODE[19]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_RX_EN_MODE_SHFT 19
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_SW_CTRL_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_SW_CTRL_MASK 0x00040000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_SW_CTRL[18]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_SW_CTRL_SHFT 18
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_MODE_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_MODE_MASK 0x00020000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_MODE[17]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TX_EN_MODE_SHFT 17
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_FSM_RST_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_FSM_RST_MASK 0x00010000                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_FSM_RST[16]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_FSM_RST_SHFT 16
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_TIME_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_TIME_MASK 0x0000FC00                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_TIME[15..10]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_TIME_SHFT 10
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_CLR_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_CLR_MASK 0x00000200                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_CLR[9]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_CLR_SHFT 9
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_EN_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_EN_MASK 0x00000100                // AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_EN[8]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_AXI_LAYER_GPS2CONN_GALS_SLPPROT_CTRL_TIMEOUT_EN_SHFT 8
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_DIS_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_DIS_MASK 0x00000020                // CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_DIS[5]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_DIS_SHFT 5
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_EN_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_EN_MASK 0x00000010                // CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_EN[4]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_EN_SHFT 4
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_DIS_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_DIS_MASK 0x00000002                // CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_DIS[1]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_DIS_SHFT 1
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_EN_ADDR CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_ADDR
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_EN_MASK 0x00000001                // CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_EN[0]
#define CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_EN_SHFT 0

/* =====================================================================================

  ---GALS_AXI_LAYER_GPS2CONN_SLP_STATUS (0x18001000 + 0x490)---

    RESERVED0[11..0]             - (RO) Reserved bits
    AXI_LAYER_GPS2CONN_GALS_CTRL_DIS_TIMEOUT[12] - (RO) AXI_LAYER_GPS2CONN gals sleep protect contorol sleep protect disable timeout
    AXI_LAYER_GPS2CONN_GALS_CTRL_EN_TIMEOUT[13] - (RO) AXI_LAYER_GPS2CONN gals sleep protect contorol sleep protect enable timeout
    RESERVED14[14]               - (RO) Reserved bits
    AXI_LAYER_GPS2CONN_GALS_CTRL_TIMEOUT[15] - (RO) AXI_LAYER_GPS2CONN gals sleep protect contorol timeout
    RESERVED16[18..16]           - (RO) Reserved bits
    AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RDY_OUT[19] - (RO) AXI_LAYER_GPS2CONN gals sleep protect control protect ready
    RESERVED20[21..20]           - (RO) Reserved bits
    AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_RDY[22] - (RO) AXI_LAYER_GPS2CONN gals sleep protect rx ready
    AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_RDY[23] - (RO) AXI_LAYER_GPS2CONN gals sleep protect tx ready
    RESERVED24[26..24]           - (RO) Reserved bits
    AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN_BG[27] - (RO) AXI_LAYER_GPS2CONN gals sleep protect control sleep protect rx enable from bgsys
    AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN[28] - (RO) AXI_LAYER_GPS2CONN gals sleep protect control sleep protect rx enable
    AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_EN[29] - (RO) AXI_LAYER_GPS2CONN gals sleep protect control sleep protect tx enable
    RESERVED30[30]               - (RO) Reserved bits
    AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_EN[31] - (RO) AXI_LAYER_GPS2CONN gals sleep protect control sleep protect enable

 =====================================================================================*/
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_EN_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_EN_MASK 0x80000000                // AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_EN[31]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_EN_SHFT 31
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_EN_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_EN_MASK 0x20000000                // AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_EN[29]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_EN_SHFT 29
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN_MASK 0x10000000                // AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN[28]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN_SHFT 28
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN_BG_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN_BG_MASK 0x08000000                // AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN_BG[27]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_EN_BG_SHFT 27
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_RDY_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_RDY_MASK 0x00800000                // AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_RDY[23]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_RDY_SHFT 23
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_RDY_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_RDY_MASK 0x00400000                // AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_RDY[22]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_RDY_SHFT 22
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RDY_OUT_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RDY_OUT_MASK 0x00080000                // AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RDY_OUT[19]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RDY_OUT_SHFT 19
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_TIMEOUT_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_TIMEOUT_MASK 0x00008000                // AXI_LAYER_GPS2CONN_GALS_CTRL_TIMEOUT[15]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_TIMEOUT_SHFT 15
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_EN_TIMEOUT_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_EN_TIMEOUT_MASK 0x00002000                // AXI_LAYER_GPS2CONN_GALS_CTRL_EN_TIMEOUT[13]
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_EN_TIMEOUT_SHFT 13
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_DIS_TIMEOUT_ADDR CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_ADDR
#define CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_SLP_STATUS_AXI_LAYER_GPS2CONN_GALS_CTRL_DIS_TIMEOUT_MASK 0x00001000                // AXI_LAYER_GPS2CONN_GALS_CTRL_DIS_TIMEOUT[12]
...
/* =====================================================================================
  ...
  ---HOST_CSR_IRQ_EN (0x18001000 + 0x600)---
    ...
    CONN_GPS_CR_HOST_SET_FW_OWN_IRQ_EN[8] - (RW) 1'b0 : Host set fw own irq to gps disable
                                     1'b1 : Host set fw own irq to gps enable
    CONN_GPS_CR_HOST_CLR_FW_OWN_IRQ_EN[9] - (RW) 1'b0 : Host clear fw own irq to gps disable
                                     1'b1 : Host clear fw own irq to gps enable
    RESERVED10[31..10]           - (RO) Reserved bits

 =====================================================================================*/
#define CONN_CFG_ON_HOST_CSR_IRQ_EN_CONN_GPS_CR_HOST_CLR_FW_OWN_IRQ_EN_ADDR CONN_CFG_ON_HOST_CSR_IRQ_EN_ADDR
#define CONN_CFG_ON_HOST_CSR_IRQ_EN_CONN_GPS_CR_HOST_CLR_FW_OWN_IRQ_EN_MASK 0x00000200                // CONN_GPS_CR_HOST_CLR_FW_OWN_IRQ_EN[9]
#define CONN_CFG_ON_HOST_CSR_IRQ_EN_CONN_GPS_CR_HOST_CLR_FW_OWN_IRQ_EN_SHFT 9
#define CONN_CFG_ON_HOST_CSR_IRQ_EN_CONN_GPS_CR_HOST_SET_FW_OWN_IRQ_EN_ADDR CONN_CFG_ON_HOST_CSR_IRQ_EN_ADDR
#define CONN_CFG_ON_HOST_CSR_IRQ_EN_CONN_GPS_CR_HOST_SET_FW_OWN_IRQ_EN_MASK 0x00000100                // CONN_GPS_CR_HOST_SET_FW_OWN_IRQ_EN[8]
#define CONN_CFG_ON_HOST_CSR_IRQ_EN_CONN_GPS_CR_HOST_SET_FW_OWN_IRQ_EN_SHFT 8
