...
//[Revision time]   : Thu Aug 31 15:26:36 2023
...
#define CONN_WT_SLP_CTL_REG_BASE                               (CONN_WT_SLP_CTL_REG_BASE_ADDR_MT8875) // 0x40003000
...
/* =====================================================================================
  ...
  ---WB_CK_STA (0x18003000 + 0x0A8)---
    ...
    BT1_WAKE_EN[15]              - (RO) GPS L5 slelection
