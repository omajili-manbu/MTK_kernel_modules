 ...
 */
//[File]            : conn_cfg_on.h
//[Revision time]   : Wed Sep 10 14:04:21 2025
...
#define CONN_CFG_ON_BASE                                       (CONN_REG_CONN_INFRA_CFG_ON_ADDR) // (0x18001000 + CONN_INFRA_REMAPPING_OFFSET)
...
/* =====================================================================================
  ...
  ---ADIE_CTL (0x18001000 + 0x010)---
    ...
    ADIE_GPS_SEL_SPI0_OR_SPI1[5] - (RW) ADIE relative control from gpssys is issused to conn_rfspi_ctl or inst2_conn_rfspi_ctl
                                     1'h0: to conn_rfspi_ctl
                                     1'h1: to inst2_conn_rfspi_ctl
    ADIE_FM_SEL_SPI0_OR_SPI1[6]  - (RW) ADIE relative control from conn_fm_ctrl is issused to conn_rfspi_ctl or inst2_conn_rfspi_ctl
                                     1'h0: to conn_rfspi_ctl
                                     1'h1: to inst2_conn_rfspi_ctl
    ADIE_BT_SEL_SPI0_OR_SPI1[7]  - (RW) ADIE relative control from bgsys is issused to conn_rfspi_ctl or inst2_conn_rfspi_ctl
                                     1'h0: to conn_rfspi_ctl
                                     1'h1: to inst2_conn_rfspi_ctl
    ADIE_WF_SEL_SPI0_OR_SPI1[8]  - (RW) ADIE relative control from wfsys is issused to conn_rfspi_ctl or inst2_conn_rfspi_ctl
                                     1'h0: to conn_rfspi_ctl
                                     1'h1: to inst2_conn_rfspi_ctl
    RESERVED9[31..9]             - (RO) Reserved bits

 =====================================================================================*/
#define CONN_CFG_ON_ADIE_CTL_ADIE_WF_SEL_SPI0_OR_SPI1_ADDR     CONN_CFG_ON_ADIE_CTL_ADDR
#define CONN_CFG_ON_ADIE_CTL_ADIE_WF_SEL_SPI0_OR_SPI1_MASK     0x00000100                // ADIE_WF_SEL_SPI0_OR_SPI1[8]
#define CONN_CFG_ON_ADIE_CTL_ADIE_WF_SEL_SPI0_OR_SPI1_SHFT     8
#define CONN_CFG_ON_ADIE_CTL_ADIE_BT_SEL_SPI0_OR_SPI1_ADDR     CONN_CFG_ON_ADIE_CTL_ADDR
#define CONN_CFG_ON_ADIE_CTL_ADIE_BT_SEL_SPI0_OR_SPI1_MASK     0x00000080                // ADIE_BT_SEL_SPI0_OR_SPI1[7]
#define CONN_CFG_ON_ADIE_CTL_ADIE_BT_SEL_SPI0_OR_SPI1_SHFT     7
#define CONN_CFG_ON_ADIE_CTL_ADIE_FM_SEL_SPI0_OR_SPI1_ADDR     CONN_CFG_ON_ADIE_CTL_ADDR
#define CONN_CFG_ON_ADIE_CTL_ADIE_FM_SEL_SPI0_OR_SPI1_MASK     0x00000040                // ADIE_FM_SEL_SPI0_OR_SPI1[6]
#define CONN_CFG_ON_ADIE_CTL_ADIE_FM_SEL_SPI0_OR_SPI1_SHFT     6
#define CONN_CFG_ON_ADIE_CTL_ADIE_GPS_SEL_SPI0_OR_SPI1_ADDR    CONN_CFG_ON_ADIE_CTL_ADDR
#define CONN_CFG_ON_ADIE_CTL_ADIE_GPS_SEL_SPI0_OR_SPI1_MASK    0x00000020                // ADIE_GPS_SEL_SPI0_OR_SPI1[5]
#define CONN_CFG_ON_ADIE_CTL_ADIE_GPS_SEL_SPI0_OR_SPI1_SHFT    5
