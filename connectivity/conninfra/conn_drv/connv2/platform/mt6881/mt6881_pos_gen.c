 ...
 *
 * This file, mt6881_pos_gen.c was automatically generated
 * by the tool from the POS data DE provided.
 * It should not be modified by hand.
 *
 * Reference POS file,
 * - Cxxxxl_power_on_sequence_20251001_code_gen_20251113.xlsx
 * - Cxxxxl_conn_infra_sub_task_20251119 (1).xlsx
 * - conn_infra_cmdbt_instr_autogen_250911.txt
 */
...
const unsigned int g_cmdbt_dwn_value_ary_mt6881[1024] = {
	...
	0x31000100, 0x1600B078, 0x16011804, 0x16100001, 0x16110000, 0x31000100, 0x06000000, 0x00000000,
...
void consys_set_if_pinmux_mt6881_gen(
		...
		unsigned int enable)
{
	...
	vir_addr_consys_gen_iocfg_rt_base =
		ioremap(CONSYS_GEN_IOCFG_RT_BASE_ADDR, 0xB0);
	...
	if (enable == 1) {
		if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
			/* set pinmux for the interface between D-die and A-die (Aux1) */
			#ifndef CONFIG_FPGA_EARLY_PORTING
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE25_OFFSET_ADDR, 0x1010000, 0x7070000);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE26_OFFSET_ADDR, 0x1010101, 0x7070707);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE27_OFFSET_ADDR, 0x1010101, 0x7070707);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE28_OFFSET_ADDR, 0x1, 0x7);
			#endif

			/* set pinmux driving to 001 setting */
			#ifndef CONFIG_FPGA_EARLY_PORTING
			CONSYS_REG_WRITE_MASK(vir_addr_consys_gen_iocfg_rt_base +
				CONSYS_GEN_DRV_CFG0_OFFSET_ADDR, 0x9200000, 0x3FE00000);
			CONSYS_REG_WRITE_MASK(vir_addr_consys_gen_iocfg_rt_base +
				CONSYS_GEN_DRV_CFG1_OFFSET_ADDR, 0x1249249, 0x7FFFFFF);
			#endif
			...
			#endif
		} else if (consys_get_adie_chipid_mt6881() == ADIE_6631) {
			/* set pinmux for the interface between D-die and A-die (Aux1) */
			#ifndef CONFIG_FPGA_EARLY_PORTING
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE25_OFFSET_ADDR, 0x1010000, 0x7070000);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE26_OFFSET_ADDR, 0x1010101, 0x7070707);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE27_OFFSET_ADDR, 0x10101, 0x70707);
			#endif
			...
			CONSYS_REG_WRITE_MASK(vir_addr_consys_gen_iocfg_rt_base +
				CONSYS_GEN_DRV_CFG0_OFFSET_ADDR, 0x9200000, 0x3FE00000);
			CONSYS_REG_WRITE_MASK(vir_addr_consys_gen_iocfg_rt_base +
				CONSYS_GEN_DRV_CFG1_OFFSET_ADDR, 0x49249, 0x1FFFFF);
			#endif
			...
			CONSYS_REG_WRITE_MASK(vir_addr_consys_gen_iocfg_rt_base +
				CONSYS_GEN_PUPD_CFG0_OFFSET_ADDR, 0x0, 0xA);
			#endif
		} else if (consys_get_adie_chipid_mt6881() == ADIE_6686) {
			/* set pinmux for the interface between D-die and A-die (Aux1) */
			#ifndef CONFIG_FPGA_EARLY_PORTING
		...
		if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
			/* set pinmux for the interface between D-die and A-die (set Aux0) */
			#ifndef CONFIG_FPGA_EARLY_PORTING
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE25_OFFSET_ADDR, 0x0, 0x7070000);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE26_OFFSET_ADDR, 0x0, 0x7070707);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE27_OFFSET_ADDR, 0x0, 0x7070707);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE28_OFFSET_ADDR, 0x0, 0x7);
			#endif

			/* set pinmux PUPD setting as PD */
			#ifndef CONFIG_FPGA_EARLY_PORTING
			CONSYS_REG_WRITE_MASK(vir_addr_consys_gen_iocfg_rt_base +
			...
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE26_OFFSET_ADDR, 0x0, 0x7070707);
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE27_OFFSET_ADDR, 0x0, 0x70707);
			#endif
...
int consys_conninfra_on_power_ctrl_mt6881_gen(unsigned int enable)
{
	int check = 0;
...
int consys_polling_chipid_mt6881_gen(unsigned int *pconsys_ver_id)
{
	int check = 0;
	int retry = 0;
...
unsigned int consys_emi_set_remapping_reg_mt6881_gen(
...
void consys_init_conninfra_sysram_mt6881_gen(void)
{
	#ifndef CONFIG_FPGA_EARLY_PORTING
	#ifndef CFG_CONNINFRA_ON_CTP
...
void consys_config_multibit_cr_dmux_upd_mt6881_gen(void)
{
	int check = 0;
	...
	/* Set conn_infra_multibit_cr_dmux_upd for DMUX update */
	CONSYS_SET_BIT(CONN_BUS_CR_BASE +
		0x78, (0x1U << 0));

	/* Polling/ read (TBD) conn_infra_multibit_cr_dmux_upd for DMUX update */
	check = 0;
	CONSYS_REG_BIT_POLLING(CONN_BUS_CR_BASE +
		0x78,
		0, 0, 0, 1000, check);
	if (check != 0) {
		pr_notice("Polling/ read fail, Status=0x%08x\n",
			CONSYS_REG_READ(CONN_BUS_CR_BASE +
				0x78));
	}
}

void connsys_get_d_die_efuse_mt6881_gen(unsigned int *p_d_die_efuse)
{
	if (CONN_CFG_BASE == 0) {
		pr_notice("CONN_CFG_BASE is not defined\n");
		return;
...
int connsys_d_die_cfg_mt6881_gen(void)
{
...
void connsys_wt_slp_top_ctrl_adie6637_mt6881_gen(void)
{
...
void connsys_wt_slp_top_ctrl_adie6631_mt6881_gen(void)
{
	if (CONN_WT_SLP_CTL_REG_BASE == 0) {
		pr_notice("CONN_WT_SLP_CTL_REG_BASE is not defined\n");
		return;
...
void connsys_wt_slp_top_ctrl_adie6686_mt6881_gen(void)
{
...
int connsys_a_die_switch_to_gpio_mode_mt6881_gen(void)
{
	if (GPIO_REG_BASE == 0) {
		pr_notice("GPIO_REG_BASE is not defined\n");
		return -1;
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		/* CONN_WF_CTRL2(GPIO110) swtich to GPIO mode, GPIO output value low */
		#ifndef CONFIG_FPGA_EARLY_PORTING
		if ((consys_co_clock_type_mt6881() == CONNSYS_CLOCK_SCHEMATIC_26M_COTMS) ||
			(consys_co_clock_type_mt6881() == CONNSYS_CLOCK_SCHEMATIC_26M_EXTCXO)) {
			CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_MODE27_OFFSET_ADDR, 0x0, 0x70000);
			CONSYS_CLR_BIT(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_DOUT3_OFFSET_ADDR, (0x1U << 14));
			CONSYS_SET_BIT(GPIO_REG_BASE +
				CONSYS_GEN_GPIO_DIR3_SET_OFFSET_ADDR, (0x1U << 14));
		}
		#endif

		/* CONN_WF_CTRL2(GPIO110) swtich to GPIO mode, GPIO output value high */
		#ifndef CONFIG_FPGA_EARLY_PORTING
		if ((consys_co_clock_type_mt6881() == CONNSYS_CLOCK_SCHEMATIC_52M_COTMS) ||
...
void consys_m10_srclken_cfg_mt6881_gen(
		unsigned int curr_status,
		unsigned int next_status,
		unsigned int enable)
{
	...
	if (enable == 1) {
		if ((bt_or_wifi_or_fm_on == true) && (consys_get_adie_chipid_mt6881() == ADIE_6686)) {
		...
		/* SW flow set PMRC_EN[10] =1'b0 in srcclkena_rc_CODA */
		#ifndef CONFIG_FPGA_EARLY_PORTING
		if ((bt_wifi_fm_off == true) &&
			(consys_get_adie_chipid_mt6881() == ADIE_6686)) {
...
int connsys_a_die_switch_to_conn_mode_mt6881_gen(void)
{
	if (GPIO_REG_BASE == 0) {
		pr_notice("GPIO_REG_BASE is not defined\n");
		return -1;
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		/* CONN_WF_CTRL2 (GPIO110) swtich to CONN mode */
		#ifndef CONFIG_FPGA_EARLY_PORTING
		CONSYS_REG_WRITE_MASK(GPIO_REG_BASE +
			CONSYS_GEN_GPIO_MODE27_OFFSET_ADDR, 0x10000, 0x70000);
		#endif
	}
...
int connsys_a_die_cfg_adie6637_deassert_adie_reset_mt6881_gen(void)
{
...
int connsys_a_die_cfg_adie6637_read_adie_id_mt6881_gen(
		...
		unsigned int *phw_ver_id)
{
	...
	/* read MT6637 ID */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_CHIP_ID, &chip_id);
...
int connsys_a_die_cfg_adie6637_PART1_mt6881_gen(void)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_WRI_CTR2, 0x7700);
	#endif

	/* set WF low power cmd as DBDC mode & legacy interface */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_SMCTK11, 0x21);
	#endif
...
int connsys_a_die_efuse_read_adie6637_check_efuse_valid_mt6881_gen(
		...
		bool *pefuse_valid)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_EFUSE_CTRL, &efuse_ctrl);
	efuse_ctrl &= ~(0x40000000);
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_EFUSE_CTRL, efuse_ctrl);
	#endif
	...
	efuse_ctrl |= ((0x40000000 + (efuse_addr << 16)) & 0x43ff00c0);
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_EFUSE_CTRL, efuse_ctrl);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	retry = 0;
	consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_EFUSE_CTRL, &ret);
...
void connsys_a_die_efuse_read_adie6637_get_efuse_count_mt6881_gen(unsigned int *pefuse_count)
{
	if (pefuse_count != NULL)
		*pefuse_count = 4;
}

int connsys_a_die_efuse_read_adie6637_get_efuse0_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse0)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_EFUSE_RDATA0, &efuse_rdata0);
		if (check)
			return check;
		if (pefuse0 != NULL)
...
int connsys_a_die_efuse_read_adie6637_get_efuse1_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse1)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_EFUSE_RDATA1, &efuse_rdata1);
		if (check)
			return check;
		if (pefuse1 != NULL)
...
int connsys_a_die_efuse_read_adie6637_get_efuse2_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse2)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_EFUSE_RDATA2, &efuse_rdata2);
		if (check)
			return check;
		if (pefuse2 != NULL)
...
int connsys_a_die_efuse_read_adie6637_get_efuse3_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse3)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_EFUSE_RDATA3, &efuse_rdata3);
		if (check)
			return check;
		if (pefuse3 != NULL)
...
int connsys_a_die_thermal_cal_adie6637_conf_mt6881_gen(
		bool efuse_valid,
		...
		int *poffset)
{
	...
	if ((efuse_valid) && ((pefuse_list != NULL) && (efuse_size > 1) && (pefuse_list[1] & (0x1U << 7)))) {
		consys_spi_write_offset_range_nolock_mt6881(
...
int connsys_a_die_cfg_adie6637_PART2_mt6881_gen(unsigned int hw_ver_id)
{
	/* disable CAL LDO */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF2_POS_01, 0xE8002);
	#endif

	/* disable CAL LDO */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF2_POS_02, 0xE8002);
	#endif

	/* initial IR value for WF0 THADC */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF2_TIME_COUNT_01, 0x2008);
	#endif

	/* initial IR value for WF1 THADC */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF2_TIME_COUNT_02, 0x2008);
	#endif

	/* DA_WF0_SW_RFDIGLDO Wakeup Sleep Sequence Update */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF1_RFLDO_TIME, 0xF000B);
	#endif

	/* DA_WF1_SW_RFDIGLDO Wakeup Sleep Sequence Update */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF1_RFDIG_OFF_TIME, 0xC000C);
	#endif

	/* set DA_BT0_BG_EN_RFDIG On/Off time counter */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_BT0_BG_TIME, 0x20003);
	#endif

	/* set bt_iso_en time counter */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_BT0_ISO_TIME, 0x1000B);
	#endif

	/* set bt_xobuf_time counter */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_BT0_XOBUF_TIME, 0x10004);
	#endif

	/* set bt_ck_en time counter */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_BT0_CKEN_TIME, 0x20003);
	#endif

	/* set BT_WAKEUPSLEEP_PON_OFF counter Threshold to 8us */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WAKEUPSLEEP_PON_OFF, 0x150008);
	#endif

	/* Update WF XOBUF disable, WF sys will enable XOBUF when WF Power On */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_TOP_XO_02, 0x88000000);
	#endif

	/* Update WF XOBUF disable, WF sys will enable XOBUF when WF Power On */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_TOP_XO_03, 0x0);
	#endif

	/* Update BT/FM/GPS XOBUF disable, this will use drvier to config in BGF platform */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_TOP_XO_07, 0x0);
	#endif

	/* Update BT AIQ SW to normal mode */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_ENCAL_WFBT_IF_SW_01, 0x5);
	#endif

	/* Update to always Power On FMSYS in ADIE */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_FMCTL4, 0x35);
	#endif

	/* BT/TOP SPI CK PU/PD no pull after hw POS */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_TOP_PULL, 0xA6AAAA44);
	#endif

	if (hw_ver_id == 0x8a01) {
		/* Update CR of VCONST_BG WF0 Only For E2 Update */
		#ifndef CONFIG_FPGA_EARLY_PORTING
		consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF0_BG, 0xE008);
		#endif

		/* Update CR of VCONST_BG WF1 Only For E2 Update */
		#ifndef CONFIG_FPGA_EARLY_PORTING
		consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF1_BG, 0xE008);
		#endif
	}

	/* EN WF0 CAL/TRX LDO bleeding current both update for E1 and E2 POS */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF0_TOP_01, 0xE440A);
	#endif

	/* EN WF1 CAL/TRX LDO bleeding current both update for E1 and E2 POS */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_WF1_TOP_01, 0xE401A);
	#endif

	return 0;
}

int connsys_a_die_cfg_adie6631_deassert_adie_reset_mt6881_gen(void)
{
	if (CONN_CFG_ON_BASE == 0) {
		pr_notice("CONN_CFG_ON_BASE is not defined\n");
		return -1;
...
int connsys_a_die_cfg_adie6631_read_adie_id_mt6881_gen(
		unsigned int *padie_id,
		unsigned int *phw_ver_id)
{
	#ifndef CONFIG_FPGA_EARLY_PORTING
	...
	/* read A-die ID */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_CHIP_ID, &chip_id);
...
int connsys_a_die_efuse_read_adie6631_check_efuse_valid_mt6881_gen(
		unsigned int efuse_addr,
		bool *pefuse_valid)
{
	#ifndef CONFIG_FPGA_EARLY_PORTING
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_EFUSE, 0x4);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	efuse_valid = false;
	consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_VALID, &efuse_valid);
...
void connsys_a_die_efuse_read_adie6631_get_efuse_count_mt6881_gen(unsigned int *pefuse_count)
{
	if (pefuse_count != NULL)
		*pefuse_count = 8;
}

int connsys_a_die_efuse_read_adie6631_get_efuse0_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse0)
{
	#ifndef CONFIG_FPGA_EARLY_PORTING
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_RDATA0, &efuse_rdata0);
		if (check)
			return check;
		if (pefuse0 != NULL)
			*pefuse0 = efuse_rdata0;
...
int connsys_a_die_efuse_read_adie6631_get_efuse1_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse1)
{
	#ifndef CONFIG_FPGA_EARLY_PORTING
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_RDATA1, &efuse_rdata1);
		if (check)
			return check;
		if (pefuse1 != NULL)
			*pefuse1 = efuse_rdata1;
...
int connsys_a_die_efuse_read_adie6631_get_efuse2_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse2)
{
	#ifndef CONFIG_FPGA_EARLY_PORTING
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_RDATA2, &efuse_rdata2);
		if (check)
			return check;
		if (pefuse2 != NULL)
			*pefuse2 = efuse_rdata2;
...
int connsys_a_die_efuse_read_adie6631_get_efuse3_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse3)
{
	#ifndef CONFIG_FPGA_EARLY_PORTING
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_RDATA3, &efuse_rdata3);
		if (check)
			return check;
		if (pefuse3 != NULL)
			*pefuse3 = efuse_rdata3;
...
int connsys_a_die_efuse_read_adie6631_get_efuse4_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse4)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_RDATA4, &efuse_rdata4);
		if (check)
			return check;
		if (pefuse4 != NULL)
...
int connsys_a_die_efuse_read_adie6631_get_efuse5_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse5)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_RDATA5, &efuse_rdata5);
		if (check)
			return check;
		if (pefuse5 != NULL)
...
int connsys_a_die_efuse_read_adie6631_get_efuse6_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse6)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_RDATA6, &efuse_rdata6);
		if (check)
			return check;
		if (pefuse6 != NULL)
...
int connsys_a_die_efuse_read_adie6631_get_efuse7_info_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse7)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	if (efuse_valid) {
		check = consys_spi_read_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_EFUSE_RDATA7, &efuse_rdata7);
		if (check)
			return check;
		if (pefuse7 != NULL)
...
int connsys_a_die_thermal_cal_adie6631_conf_mt6881_gen(
		bool efuse_valid,
		unsigned int *pefuse_list,
		unsigned int efuse_size,
		int *pslop_molecule,
...
int connsys_a_die_cfg_adie6631_PART2_mt6881_gen(unsigned int hw_ver_id)
{
	if (CONN_THERM_CTL_BASE == 0) {
		pr_notice("CONN_THERM_CTL_BASE is not defined\n");
		return -1;
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_RG_WF_CLK_EN, 0xFFFFFFFF);
	#endif

	/* set A-die GPIO */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_RG_0X000, 0xFFFFFFFF);
	#endif

	/* turn on A-die Wi-Fi wakeup FSM */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_RG_0X080, 0xFFFFFFFF);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_RG_0X0CC, 0x80);
	#endif

	/* turn off A-die Wi-Fi wakeup FSM */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_RG_0X080, 0x0);
	#endif
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_RG_WF_CLK_EN, 0x0);
	#endif

	/* change A-die clock buffer default value */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_RG_0X0C8, 0x64D34700);
	#endif

	/* turn off A-die TOP clock for power saving */
	#ifndef CONFIG_FPGA_EARLY_PORTING
	consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6631_ATOP_RG_TOP_CLK_EN, 0x0);
	#endif
...
int connsys_a_die_cfg_deassert_adie_reset_mt6881_gen(
		unsigned int curr_status,
		unsigned int next_status)
{
	unsigned int curr_bt = 0;
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		connsys_a_die_cfg_adie6637_deassert_adie_reset_mt6881_gen();
	} else if (consys_get_adie_chipid_mt6881() == ADIE_6631 ||
		(consys_get_adie_chipid_mt6881() == ADIE_6686 &&
		bt_or_wifi_or_fm_on == true)) {
		connsys_a_die_cfg_adie6631_deassert_adie_reset_mt6881_gen();
	} else
		return -1;
...
int connsys_a_die_cfg_read_adie_id_mt6881_gen(
		unsigned int curr_status,
		unsigned int next_status,
		unsigned int *padie_id,
		unsigned int *phw_ver_id)
{
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		check = connsys_a_die_cfg_adie6637_read_adie_id_mt6881_gen(padie_id, phw_ver_id);
	} else if (consys_get_adie_chipid_mt6881() == ADIE_6631 ||
		(consys_get_adie_chipid_mt6881() == ADIE_6686 &&
		bt_or_wifi_or_fm_on == true)) {
		check = connsys_a_die_cfg_adie6631_read_adie_id_mt6881_gen(padie_id, phw_ver_id);
	} else
		return -1;
...
int connsys_a_die_efuse_read_get_efuse_info_mt6881_gen(
		unsigned int curr_status,
		unsigned int next_status,
		...
		int *poffset)
{
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		connsys_a_die_cfg_adie6637_PART1_mt6881_gen();
		connsys_a_die_efuse_read_adie6637_check_efuse_valid_mt6881_gen(0x0, &efuse_valid);
		connsys_a_die_efuse_read_adie6637_get_efuse_count_mt6881_gen(&efuse_size);
		...
		ret[0] = connsys_a_die_efuse_read_adie6637_get_efuse0_info_mt6881_gen(efuse_valid, &(efuse_list[0]));
		CONSYS_REG_WRITE(psysram_efuse_list[0], efuse_list[0]);

		ret[1] = connsys_a_die_efuse_read_adie6637_get_efuse1_info_mt6881_gen(efuse_valid, &(efuse_list[1]));
		CONSYS_REG_WRITE(psysram_efuse_list[1], efuse_list[1]);

		ret[2] = connsys_a_die_efuse_read_adie6637_get_efuse2_info_mt6881_gen(efuse_valid, &(efuse_list[2]));
		CONSYS_REG_WRITE(psysram_efuse_list[2], efuse_list[2]);

		ret[3] = connsys_a_die_efuse_read_adie6637_get_efuse3_info_mt6881_gen(efuse_valid, &(efuse_list[3]));
		...
		connsys_a_die_thermal_cal_adie6637_conf_mt6881_gen(
			efuse_valid, efuse_list, efuse_size, pslop_molecule, pthermal_b, poffset);

		connsys_a_die_efuse_read_adie6637_check_efuse_valid_mt6881_gen(0x1D0, &efuse_valid);
		connsys_a_die_efuse_read_adie6637_get_efuse2_info_mt6881_gen(efuse_valid, &(chip_info_list[1]));
		connsys_a_die_efuse_read_adie6637_get_efuse3_info_mt6881_gen(efuse_valid, &(chip_info_list[2]));
	} else if (consys_get_adie_chipid_mt6881() == ADIE_6631 ||
		(consys_get_adie_chipid_mt6881() == ADIE_6686 &&
		bt_or_wifi_or_fm_on == true)) {
		connsys_a_die_efuse_read_adie6631_check_efuse_valid_mt6881_gen(0x0, &efuse_valid);
		connsys_a_die_efuse_read_adie6631_get_efuse_count_mt6881_gen(&efuse_size);
		...
		ret[0] = connsys_a_die_efuse_read_adie6631_get_efuse0_info_mt6881_gen(efuse_valid, &(efuse_list[0]));
		CONSYS_REG_WRITE(psysram_efuse_list[0], efuse_list[0]);

		ret[1] = connsys_a_die_efuse_read_adie6631_get_efuse1_info_mt6881_gen(efuse_valid, &(efuse_list[1]));
		CONSYS_REG_WRITE(psysram_efuse_list[1], efuse_list[1]);

		ret[2] = connsys_a_die_efuse_read_adie6631_get_efuse2_info_mt6881_gen(efuse_valid, &(efuse_list[2]));
		CONSYS_REG_WRITE(psysram_efuse_list[2], efuse_list[2]);

		ret[3] = connsys_a_die_efuse_read_adie6631_get_efuse3_info_mt6881_gen(efuse_valid, &(efuse_list[3]));
		CONSYS_REG_WRITE(psysram_efuse_list[3], efuse_list[3]);

		ret[4] = connsys_a_die_efuse_read_adie6631_get_efuse4_info_mt6881_gen(efuse_valid, &(efuse_list[4]));
		CONSYS_REG_WRITE(psysram_efuse_list[4], efuse_list[4]);

		ret[5] = connsys_a_die_efuse_read_adie6631_get_efuse5_info_mt6881_gen(efuse_valid, &(efuse_list[5]));
		CONSYS_REG_WRITE(psysram_efuse_list[5], efuse_list[5]);

		ret[6] = connsys_a_die_efuse_read_adie6631_get_efuse6_info_mt6881_gen(efuse_valid, &(efuse_list[6]));
		CONSYS_REG_WRITE(psysram_efuse_list[6], efuse_list[6]);

		ret[7] = connsys_a_die_efuse_read_adie6631_get_efuse7_info_mt6881_gen(efuse_valid, &(efuse_list[7]));
		CONSYS_REG_WRITE(psysram_efuse_list[7], efuse_list[7]);

		pr_info("efuse(0x0) = [0x%08x, 0x%08x, 0x%08x, 0x%08x, 0x%08x, 0x%08x, 0x%08x, 0x%08x]",
		...
		if (ret[0] || ret[1] || ret[2] || ret[3] || ret[4] || ret[5] || ret[6] || ret[7]) {
			pr_notice("efuse(0x0) read error: [%d, %d, %d, %d, %d, %d, %d, %d]",
				ret[0], ret[1], ret[2], ret[3], ret[4], ret[5], ret[6], ret[7]);
		}

		connsys_a_die_thermal_cal_adie6631_conf_mt6881_gen(
			efuse_valid, efuse_list, efuse_size, pslop_molecule, pthermal_b, poffset);
	} else
		return -1;
...
int connsys_a_die_cfg_PART2_mt6881_gen(
		unsigned int curr_status,
		unsigned int next_status,
		unsigned int hw_ver_id)
{
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		connsys_a_die_cfg_adie6637_PART2_mt6881_gen(hw_ver_id);
	} else if (consys_get_adie_chipid_mt6881() == ADIE_6631 ||
		(consys_get_adie_chipid_mt6881() == ADIE_6686 &&
		bt_or_wifi_or_fm_on == true)) {
		connsys_a_die_cfg_adie6631_PART2_mt6881_gen(hw_ver_id);
	} else
		return -1;
...
void connsys_wt_slp_top_power_saving_ctrl_adie6637_sleep_mode_1_mt6881_gen(void)
{
	if (CONN_WT_SLP_CTL_REG_BASE == 0) {
		pr_notice("CONN_WT_SLP_CTL_REG_BASE is not defined\n");
		return;
...
void connsys_wt_slp_top_power_saving_ctrl_adie6637_sleep_mode_2_mt6881_gen(void)
{
	if (CONN_WT_SLP_CTL_REG_BASE == 0) {
		pr_notice("CONN_WT_SLP_CTL_REG_BASE is not defined\n");
		return;
...
void connsys_wt_slp_top_power_saving_ctrl_adie6637_sleep_mode_3_mt6881_gen(void)
{
	if (CONN_WT_SLP_CTL_REG_BASE == 0) {
		pr_notice("CONN_WT_SLP_CTL_REG_BASE is not defined\n");
		return;
...
void connsys_wt_slp_top_power_saving_ctrl_adie6631_mt6881_gen(void)
{
	if (CONN_WT_SLP_CTL_REG_BASE == 0) {
		pr_notice("CONN_WT_SLP_CTL_REG_BASE is not defined\n");
		return;
	...
	/* set wt_slp CR for A-die power saving  (ref. A-die power control) */
	CONSYS_REG_WRITE_MASK(CONN_WT_SLP_CTL_REG_BASE +
		CONSYS_GEN_WB_SLP_CTL_OFFSET_ADDR, 0x1, 0x1F);
	CONSYS_REG_WRITE(CONN_WT_SLP_CTL_REG_BASE +
...
void connsys_wt_slp_top_power_saving_ctrl_adie6631_for_vrfio18_oc_mt6881_gen(void)
{
	if (CONN_WT_SLP_CTL_REG_BASE == 0) {
		pr_notice("CONN_WT_SLP_CTL_REG_BASE is not defined\n");
		return;
	...
	CONSYS_REG_WRITE(CONN_WT_SLP_CTL_REG_BASE +
		CONSYS_GEN_WB_BG_OFF7_OFFSET_ADDR, 0xFFFFFFF);
}

void connsys_wt_slp_top_power_saving_ctrl_adie6637_mt6881_gen(
		unsigned int hw_version,
		unsigned int sleep_mode)
{
	if (sleep_mode == 1)
		connsys_wt_slp_top_power_saving_ctrl_adie6637_sleep_mode_1_mt6881_gen();
	else if (sleep_mode == 2)
		connsys_wt_slp_top_power_saving_ctrl_adie6637_sleep_mode_2_mt6881_gen();
	else if (sleep_mode == 3)
		connsys_wt_slp_top_power_saving_ctrl_adie6637_sleep_mode_3_mt6881_gen();
	else {
...
int connsys_afe_wbg_cal_mt6881_gen(
		...
		unsigned int spi_semaphore_timeout_usec)
{
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		...
		if (consys_sema_acquire_timeout_mt6881(spi_semaphore_index, spi_semaphore_timeout_usec) == CONN_SEMA_GET_FAIL) {
			pr_notice("[SPI WRITE] Require semaphore fail\n");
			return CONNINFRA_SPI_OP_FAIL;
		}

		consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_ENCAL_WBTAC_IF_SW, 0x80000000);

		consys_sema_release_mt6881(spi_semaphore_index);
		#endif
	}
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		...
		consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_ENCAL_WBTAC_IF_SW, 0x5);
...
int connsys_subsys_pll_initial_xtal_26000k_mt6881_gen(void)
{
	if (CONN_AFE_CTL_BASE == 0) {
		pr_notice("CONN_AFE_CTL_BASE is not defined\n");
		return -1;
...
int connsys_low_power_setting_mt6881_gen(void)
{
	...
	/* set conn_infra_off bus ahb/axi layer timeout - step 1 set timing */
	CONSYS_REG_WRITE_MASK(CONN_BUS_CR_BASE +
		CONSYS_GEN_CONN_INFRA_OFF_BUS_TIMEOUT_CTRL_OFFSET_ADDR, 0x268, 0x7F8);

	/* set conn_infra_off bus apb layer timeout - step 1 set timing */
	CONSYS_REG_WRITE_MASK(CONN_BUS_CR_BASE +
		CONSYS_GEN_CONN_INFRA_OFF_BUS_TIMEOUT_CTRL_OFFSET_ADDR, 0x1000, 0x7F800);
	...
	CONSYS_REG_WRITE_MASK(CONN_BUS_CR_ON_BASE +
		CONSYS_GEN_CONN_INFRA_VON_BUS_TIMEOUT_CTRL_OFFSET_ADDR, 0x20, 0x7F8);
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
	CONSYS_SET_BIT(CONN_CLKGEN_TOP_BASE +
		CONSYS_GEN_CLKGEN_RFSPI_INST2_CK_CTRL_OFFSET_ADDR, (0x1U << 0));
	#endif

	if ((consys_get_adie_chipid_mt6881() == ADIE_6631) &&
		(consys_get_adie_chipid_mt6881() == ADIE_6686)) {
	...
	for (i = 0; i < 1024; i++) {
		CONSYS_REG_WRITE(vir_addr_consys_gen_conn_infra_sysram_base_offset +
			addr_offset, g_cmdbt_dwn_value_ary_mt6881[i]);
		addr_offset += 0x4;
	}
...
int consys_conninfra_wakeup_mt6881_gen(void)
{
...
int connsys_adie_top_ck_en_ctl_mt6881_gen(unsigned int enable)
{
	#ifndef CONFIG_FPGA_EARLY_PORTING
	int check = 0;
	#endif
...
int connsys_adie_clock_buffer_setting_mt6881_gen(
		unsigned int curr_status,
		unsigned int next_status,
		unsigned int hw_version,
		unsigned int spi_semaphore_index,
		unsigned int spi_semaphore_timeout_usec)
{
	...
	if (consys_get_adie_chipid_mt6881() == ADIE_6637) {
		...
		#ifndef CONFIG_FPGA_EARLY_PORTING
		connsys_adie_top_ck_en_ctl_mt6881_gen(1);
		#endif
		...
		#ifndef CONFIG_FPGA_EARLY_PORTING
		if (wifi_on == 1) {
			consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ATOP_RG_TOP_XO_2, 0xFE000000);
			consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ATOP_RG_TOP_XO_3, 0xE0000000);
		}
		#endif
		...
		if (bt_on == 1 || gps_on == 1 || fm_on == 1) {
			consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ATOP_RG_TOP_XO_7, 0x7);
		}
		#endif
		...
		#ifndef CONFIG_FPGA_EARLY_PORTING
		if (wifi_on == 0) {
			consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ATOP_RG_TOP_XO_2, 0x88000000);
			consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ATOP_RG_TOP_XO_3, 0x0);
		}
		#endif
		...
		if (bt_gps_fm_off == true) {
			consys_spi_write_nolock_mt6881(SYS_SPI_TOP, CONSYS_GEN_ATOP_RG_TOP_XO_7, 0x0);
		}
		#endif
		...
		#ifndef CONFIG_FPGA_EARLY_PORTING
		connsys_adie_top_ck_en_ctl_mt6881_gen(0);
		#endif
	}
...
int consys_conninfra_sleep_mt6881_gen(void)
{
	if (CONN_HOST_CSR_TOP_BASE == 0) {
		pr_notice("CONN_HOST_CSR_TOP_BASE is not defined\n");
		return -1;
	...
	CONSYS_REG_WRITE(CONN_HOST_CSR_TOP_BASE +
		CONSYS_GEN_CONN_INFRA_WAKEPU_TOP_OFFSET_ADDR, 0x494E0000);
