...
struct conninfra_plat_data __weak mt6881_6637_plat_data = {};
struct conninfra_plat_data __weak mt6881_6631_plat_data = {};
struct conninfra_plat_data __weak mt6881_6631_6686_plat_data = {};
...
const struct of_device_id apconninfra_of_ids[] = {
	...
	{
		.compatible = "mediatek,mt6881-6637-consys",
	#if IS_ENABLED(CONFIG_MTK_COMBO_CHIP_CONSYS_6881)
		.data = (void*)&mt6881_6637_plat_data,
	#endif
	},
	{
		.compatible = "mediatek,mt6881-6631-consys",
	#if IS_ENABLED(CONFIG_MTK_COMBO_CHIP_CONSYS_6881)
		.data = (void*)&mt6881_6631_plat_data,
	#endif
	},
	{
		.compatible = "mediatek,mt6881-6631-6686-consys",
	#if IS_ENABLED(CONFIG_MTK_COMBO_CHIP_CONSYS_6881)
		.data = (void*)&mt6881_6631_6686_plat_data,
	#endif
	},
	{}
};
