...
********************************************************************************
*/
int connv3_plt_pinctrl_init_mt8875(struct platform_device *pdev);
int connv3_plt_pinctrl_deinit_mt8875(void);
int connv3_plt_pinctrl_setup_pre_mt8875(void);
int connv3_plt_pinctrl_setup_done_mt8875(void);
int connv3_plt_pinctrl_remove_mt8875(void);
int connv3_plt_pinctrl_dfd_trigger_mt8875(bool enable);

const struct connv3_platform_pinctrl_ops g_connv3_platform_pinctrl_ops_mt8875 = {
	.pinctrl_init = connv3_plt_pinctrl_init_mt8875,
	.pinctrl_deinit = connv3_plt_pinctrl_deinit_mt8875,
	.pinctrl_setup_pre = connv3_plt_pinctrl_setup_pre_mt8875,
	.pinctrl_setup_done = connv3_plt_pinctrl_setup_done_mt8875,
	.pinctrl_remove = connv3_plt_pinctrl_remove_mt8875,
	.pinctrl_dfd_trigger = connv3_plt_pinctrl_dfd_trigger_mt8875,
};

int connv3_plt_pinctrl_is_dfd_pin_init_done_mt8875(void)
{
...
int connv3_plt_pinctrl_init_mt8875(struct platform_device *pdev)
{
	...
	if (IS_ERR_OR_NULL(g_pinctrl_ptr))
		...
		/* Setup all pin to initial state */
...
int connv3_plt_pinctrl_setup_pre_mt8875(void)
{
	...
	connv3_plt_pinctrl_dfd_trigger_mt8875(false);
	return 0;
}
