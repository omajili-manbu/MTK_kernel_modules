...
********************************************************************************
*/
#define PLATFORM_SOC_CHIP		0x8875
...
extern int connv3_plt_pinctrl_is_dfd_pin_init_done_mt8875(void);
...
u32 connv3_soc_get_chipid_mt8875(void);
static u32 connv3_get_adie_chipid_mt8875(void);
static u32 connv3_reset_type_support_mt8875(void);
static u8* connv3_get_custom_option_mt8875(u32 *size);
static u32 connv3_clk_init_mt8875(
	struct platform_device *pdev,
	struct connv3_dev_cb *dev_cb);
static u32 connv3_check_platform_status_mt8875(void);
...
bool g_is_co_clock_mt8875 = false;

struct connv3_platform_clock_ops g_connv3_clock_ops_mt8875 = {
	.clk_initial_setting = connv3_clk_init_mt8875,
};

struct connv3_hw_ops_struct g_connv3_hw_ops_mt8875 = {
	.connsys_plt_get_chipid = connv3_soc_get_chipid_mt8875,
	.connsys_plt_get_adie_chipid = connv3_get_adie_chipid_mt8875,
	.connsys_plt_reset_type_support = connv3_reset_type_support_mt8875,
	.connsys_plt_get_custom_option = connv3_get_custom_option_mt8875,
	.connsys_plt_check_status = connv3_check_platform_status_mt8875,
};

const struct connv3_coredump_platform_ops g_connv3_dump_ops_mt8875 = {
	.connv3_dump_plt_get_chipid = connv3_get_adie_chipid_mt8875,
	.connv3_dump_plt_exception_filter = connv3_dump_exception_filter,
};

extern struct connv3_hw_ops_struct g_consys_hw_ops_mt8875;
extern struct connv3_platform_pmic_ops g_connv3_platform_pmic_ops_mt8875;
extern struct connv3_platform_pinctrl_ops g_connv3_platform_pinctrl_ops_mt8875;
extern const struct connv3_platform_dbg_ops g_connv3_hw_dbg_mt6653;

const struct connv3_plat_data g_connv3_mt8875_plat_data = {
	.chip_id = PLATFORM_SOC_CHIP,
	.consys_hw_version = CONN_HW_VER,
	.hw_ops = &g_connv3_hw_ops_mt8875,
	.platform_pmic_ops = &g_connv3_platform_pmic_ops_mt8875,
	.platform_pinctrl_ops = &g_connv3_platform_pinctrl_ops_mt8875,
	.platform_coredump_ops = &g_connv3_dump_ops_mt8875,
	.platform_dbg_ops = &g_connv3_hw_dbg_mt6653,
	.platform_clock_ops = &g_connv3_clock_ops_mt8875,
};
...
u32 connv3_get_adie_chipid_mt8875(void)
{
	return CONN_ADIE_ID;
}
...
static u32 connv3_reset_type_support_mt8875(void)
{
	return connv3_plt_pinctrl_is_dfd_pin_init_done_mt8875();
}
...
static bool connv3_sku_detection_mt8875(struct platform_device *pdev)
{
	...
	struct connv3_dev_cb *dev_cb)
{
	...
	if (conn_adaptor_is_internal() || drdi_detect) {
		g_is_co_clock_mt8875 = connv3_sku_detection_mt8875(pdev);
		pr_info("[%s][INTERNAL] drdi-detect=<%d> g_is_co_clock_mt8875=%d\n", __func__, drdi_detect, g_is_co_clock_mt8875);
	} else {
		ret = of_property_read_u32(pdev->dev.of_node, "co-clock", &value);
		if (ret)
			pr_notice("[%s][EXTERNAL] read co_clock prop fail\n", __func__);
		else
			g_is_co_clock_mt8875 = (bool)value;
		pr_info("[%s][EXTERNAL] g_is_co_clock_mt8875=%d\n", __func__, value);
	}

	if (!g_is_co_clock_mt8875) {
...
u32 connv3_check_platform_status_mt8875(void)
{
	connv3_plt_pmic_vbat_status_mt8875();
	return 0;
}

u8* connv3_get_custom_option_mt8875(u32 *size)
{
	...
	if (!is_init) {
		 ...
		 * For 8875 with 6687, it is always true.
		 */
		g_custom_param[2] = 0x0;
