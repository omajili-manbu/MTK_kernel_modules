...
const struct connv3_dbg_command mt6653_pwr_dump[] = {
	...
	{true, 0x2006015c, 0x7, 0x3, true, 0x20060a04},
	{true, 0x2006015c, 0x7, 0x6, true, 0x20060a04},
	{false, 0, 0, 0, true, 0x200601a0},
	{false, 0, 0, 0, true, 0x200601a4},
	{false, 0, 0, 0, true, 0x200601a8},
	{false, 0, 0, 0, true, 0x200601ac},
	{false, 0, 0, 0, true, 0x200601b0},
};

const struct connv3_dump_list mt6653_dmp_list_pwr_dump = {
	"SLEEP", "slp_wakeup_check", sizeof(mt6653_pwr_dump)/sizeof(struct connv3_dbg_command),
	10, mt6653_pwr_dump,
};
