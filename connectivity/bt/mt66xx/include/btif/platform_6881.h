...
#ifndef _PLATFORM_6881_H
#define _PLATFORM_6881_H
...
#define CONN_INFRA_CFG_ID		(0x02050406)

#define MET_EMI_ADDR	(0x2BC00)
#define BT_SSPM_TIMER	(0)
#define USE_CONN2AP_IRQ 1
...
static inline void bgfsys_ccif_off(void)
{
	...
	bgf2md_base = ioremap(0x10256000, 0x100);
	if (bgf2md_base == NULL) {
		BTMTK_ERR("%s: remapping bgf2md_base fail", __func__);
		return;
	}

	/* set PCCIF5 RX ACK, 0x10256014[0:7] = 8'b1 */
