 ...
 * Filename:
 * ---------
 *	 warholov13bultramipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "warholov13bultramipiraw_Sensor.h"

static void set_group_hold(void *arg, u8 en);
static void warholov13bultra_set_dummy(struct subdrv_ctx *ctx);
static int warholov13bultra_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int warholov13bultra_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int warholov13bultra_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int ultra_vsync_notify(struct subdrv_ctx *ctx, unsigned int sof_cnt, u64 sof_ts);
static int warholov13bultra_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warholov13bultra_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warholov13bultra_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warholov13bultra_set_multi_dig_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warholov13bultra_set_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warholov13bultra_get_csi_param(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id, struct mtk_csi_param *csi_param);
static bool is_long_exp = false;
/* STRUCT */
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, warholov13bultra_set_test_pattern},
	{SENSOR_FEATURE_SET_FRAMELENGTH, warholov13bultra_set_frame_length},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, warholov13bultra_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SET_ESHUTTER, warholov13bultra_set_shutter},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, warholov13bultra_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME, warholov13bultra_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_DIG_GAIN, warholov13bultra_set_multi_dig_gain}
};
...
{\
	...
	.mode_setting_table = warholov13bultra_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(warholov13bultra_preview_setting),\
...
{\
	...
	.mode_setting_table = warholov13bultra_normal_video_setting,\
	.mode_setting_len = ARRAY_SIZE(warholov13bultra_normal_video_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = warholov13bultra_custom1_setting,\
	.mode_setting_len = ARRAY_SIZE(warholov13bultra_custom1_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = warholov13bultra_custom2_setting,\
	.mode_setting_len = ARRAY_SIZE(warholov13bultra_custom2_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = warholov13bultra_custom3_setting,\
	.mode_setting_len = ARRAY_SIZE(warholov13bultra_custom3_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
{\
	...
	.mode_setting_table = warholov13bultra_custom4_setting,\
	.mode_setting_len = ARRAY_SIZE(warholov13bultra_custom4_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
// mode 11: 1280*720@120fps
#define custom5_struct  \
{\
	.frame_desc = frame_desc_custom5,\
	.num_entries = ARRAY_SIZE(frame_desc_custom5),\
	.mode_setting_table = warholov13bultra_custom5_setting,\
	.mode_setting_len = ARRAY_SIZE(warholov13bultra_custom5_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	custom5_struct			    //mode 11
};

static struct subdrv_static_ctx static_ctx = {
	.sensor_id = WARHOLOV13BULTRA_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = warholov13bultra_ana_gain_table,
	.ana_gain_table_size = sizeof(warholov13bultra_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.init_setting_table = warholov13bultra_init_setting,
	.init_setting_len = ARRAY_SIZE(warholov13bultra_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.get_id = warholov13bultra_get_imgsensor_id,
	.init_ctx = init_ctx,
	.open = common_open,
	...
	.get_csi_param = warholov13bultra_get_csi_param,
...
const struct subdrv_entry warholov13bultra_mipi_raw_entry = {
	.name = SENSOR_DRVNAME_WARHOLOV13BULTRA_MIPI_RAW,
	.id = WARHOLOV13BULTRA_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int warholov13bultra_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (ctx->frame_length > (ctx->exposure[0] + ctx->s_ctx.exposure_margin))
		warholov13bultra_set_dummy(ctx);
...
static int warholov13bultra_set_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (is_long_exp){
		DRV_LOG_MUST(ctx, "skip warholov13bultra_set_frame_length\n");
		return ERROR_NONE;
	}
...
static int warholov13bultra_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	warholov13bultra_set_shutter_frame_length(ctx, para, len);
	return 0;
}
static int warholov13bultra_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
...
static int warholov13bultra_get_csi_param(struct subdrv_ctx *ctx,
