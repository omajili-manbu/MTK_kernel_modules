 ...
 *===================================================================
 *******************************************************************/
#include "s5kjn1litemipiraw_Sensor.h"

static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static u16 get_gain2reg(u32 gain);
static int s5kjn1lite_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int s5kjn1lite_set_test_pattern_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int s5kjn1lite_set_ctrl_locker(struct subdrv_ctx *ctx, u32 cid, bool *is_lock);
static int s5kjn1lite_chk_streaming_st(void *arg);

/* STRUCT */

static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, s5kjn1lite_set_test_pattern},
	{SENSOR_FEATURE_SET_TEST_PATTERN_DATA, s5kjn1lite_set_test_pattern_data},
};
...
static struct subdrv_static_ctx_ext_ops static_ext_ops = {
	...
	.chk_streaming_st = s5kjn1lite_chk_streaming_st,
...
static struct subdrv_ops ops = {
	...
	.set_ctrl_locker = s5kjn1lite_set_ctrl_locker,
};


const struct subdrv_entry s5kjn1lite_mipi_raw_entry = {
	.name = "s5kjn1lite_mipi_raw",
	.ops = &ops,
	.is_fw_support = TRUE,
...
static int s5kjn1lite_set_ctrl_locker(struct subdrv_ctx *ctx,
