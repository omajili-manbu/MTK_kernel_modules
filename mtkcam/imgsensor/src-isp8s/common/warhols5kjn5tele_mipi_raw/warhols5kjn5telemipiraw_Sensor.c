 ...
 * Filename:
 * ---------
 *	 warhols5kjn5telemipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "warhols5kjn5telemipiraw_Sensor.h"

static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static int warhols5kjn5tele_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int warhols5kjn5tele_get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int warhols5kjn5tele_control(struct subdrv_ctx *ctx, enum MSDK_SCENARIO_ID_ENUM scenario_id,
		MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data);
static int warhols5kjn5tele_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static int tele_vsync_notify(struct subdrv_ctx *ctx, unsigned int sof_cnt, u64 sof_ts);
static int warhols5kjn5tele_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warhols5kjn5tele_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warhols5kjn5tele_set_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
void warhols5kjn5tele_set_long_exposure(struct subdrv_ctx *ctx);
void warhols5kjn5tele_write_frame_length(struct subdrv_ctx *ctx, u32 fll);
static int warhols5kjn5tele_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warhols5kjn5tele_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warhols5kjn5tele_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int warhols5kjn5tele_set_multi_dig_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, warhols5kjn5tele_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, warhols5kjn5tele_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, warhols5kjn5tele_seamless_switch},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME,warhols5kjn5tele_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_GAIN, warhols5kjn5tele_set_gain},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, warhols5kjn5tele_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_ESHUTTER, warhols5kjn5tele_set_shutter},
	{SENSOR_FEATURE_SET_MULTI_DIG_GAIN, warhols5kjn5tele_set_multi_dig_gain},
	{SENSOR_FEATURE_SET_AWB_GAIN, warhols5kjn5tele_set_awb_gain},
};
...
static struct mtk_sensor_saturation_info warhols5kjn5_saturation_info_10bit = {
	.gain_ratio = 1000,
	.OB_pedestal = 64,
	.saturation_level = 1023,
};

static struct mtk_sensor_saturation_info warhols5kjn5_saturation_info_12bit = {
	.gain_ratio = 4000,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_isz = {
	...
	.i4Crop = {
		...
		{0, 384}, {0, 0}, {0, 0}, {0, 0}, {2048, 1536},
		// <cust6> <cust7> <cust8> <cust9> <cust10>
		{2048, 1536}, {2048, 1536}, {0, 0}, {2048, 1536}, {0, 0},
		// <cust11> <cust12> <cust13> <cust14> <cust15>
		{0, 0}, {0, 0}, {0, 0}, {0, 0}, {2048, 1792},
		// <cust16> <cust17> <cust18> <cust19> <cust20>
		{0, 0}, {0, 256}, {0, 0}, {2048, 1536},  {2048, 1536},
		// <cust21> <cust22> <cust23> <cust24> <cust25>
		{0, 0}, {0, 0}, {0, 0}, {2048, 1536},  {0, 0},
		// <cust26> <cust27>
		{2048, 1536}, {0, 0},
...
#define PRE_MODE	.frame_desc = frame_desc_prev,\
	...
	.mode_setting_table = warhols5kjn5tele_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_preview_setting),\
	.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HD_CAP_MODE,\
	.seamless_switch_mode_setting_table = warhols5kjn5tele_preview_setting,\
	.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_preview_setting),\
	.hdr_mode = HDR_NONE,\
	.raw_cnt = 1,\
	.exp_cnt = 1,\
	.pclk = 920000000,\
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	// complete 11
	{
		...
		.mode_setting_table = warhols5kjn5tele_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_normal_video_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1609_MODE,
	...
	//hs_video mode 3 : same as custom1 mode 5
	//60fps
	//complete 14
	{
		.frame_desc = frame_desc_cus1,
		.num_entries = ARRAY_SIZE(frame_desc_cus1),
		.mode_setting_table = warhols5kjn5tele_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom1_setting),
	...
	//complete 15
	{
		...
		.mode_setting_table = warhols5kjn5tele_slim_video_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_slim_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	//complete 16 : smvr 240fps
	{
		.frame_desc = frame_desc_hs_vid,
		.num_entries = ARRAY_SIZE(frame_desc_hs_vid),
		.mode_setting_table = warhols5kjn5tele_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	//complete 5
	{
		...
		.mode_setting_table = warhols5kjn5tele_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom4_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom4_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom4_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
		...
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_LE].max = BASEGAIN * 48,
		.multi_exposure_ana_gain_range[IMGSENSOR_EXPOSURE_LE].min = BASEGAIN,
		.imgsensor_winsize_info = {
			.full_w = 8192,
			.full_h = 6144,
	...
	// custom5 mode 9 : full size crop quad 4:3
	//4096x3072
	//complete 4
	{
		.frame_desc = frame_desc_cus5,
		.num_entries = ARRAY_SIZE(frame_desc_cus5),
		.mode_setting_table = warhols5kjn5tele_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom5_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom5_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom5_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//custom6 mode 10 : full size crop bayer 4:3 
	//4096x3072
	//complete 3
	{
		.frame_desc = frame_desc_cus6,
		.num_entries = ARRAY_SIZE(frame_desc_cus6),
		.mode_setting_table = warhols5kjn5tele_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom6_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom6_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom6_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	// custom7 mode 11 : full size bayer 4:3
	//8192x6144
	//complete 0
	{
		.frame_desc = frame_desc_cus7,
		.num_entries = ARRAY_SIZE(frame_desc_cus7),
		.mode_setting_table = warhols5kjn5tele_custom7_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom7_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_HD_CAP_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom7_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom7_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//custom9 mode 13: 2x bokeh 10bit 24fps
	//same as preview
	{
		.frame_desc = frame_desc_prev,
		.num_entries = ARRAY_SIZE(frame_desc_prev),
	...
	//custom10 mode 14: T + W人像
	//4096x3072
	//same as preview
	{
		PRE_MODE
	},
	//custom11 mode 15: binning
	//complete 7
	{
		.frame_desc = frame_desc_prev,
		.num_entries = ARRAY_SIZE(frame_desc_prev),
	...
	//custom12 mode 16:  stagger 2
	//complete 10 
	{
		.frame_desc = frame_desc_cus12,
		.num_entries = ARRAY_SIZE(frame_desc_cus12),
		.mode_setting_table = warhols5kjn5tele_custom12_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom12_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_NORMAL_CAP_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom12_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom12_setting),
	...
	//complete 7
	{
		...
		.mode_setting_table = warhols5kjn5tele_custom13_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom13_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom13_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom13_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 8
	{
		...
		.mode_setting_table = warhols5kjn5tele_custom14_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom14_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom14_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom14_setting),
		...
		.saturation_info = &warhols5kjn5_saturation_info_12bit,
	},
	//custom 15 mode 19:
	//4096x2560
	//complete 9
	{
		...
		.mode_setting_table = warhols5kjn5tele_custom15_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom15_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1610_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom15_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom15_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	// custom19 mode 23 : full size crop quad 4:3 
	//4096x3072
	{
		.frame_desc = frame_desc_cus5,
		.num_entries = ARRAY_SIZE(frame_desc_cus5),
	...
	//custom20 mode 24 : full size crop bayer 4:3 
	//4096x3072
	{
		.frame_desc = frame_desc_cus6,
		.num_entries = ARRAY_SIZE(frame_desc_cus6),
	...
	//custom21 mode 25: 1x bokeh leica
	//4096x3072
	//same as preview
	{
		.frame_desc = frame_desc_prev,
	...
	// complete 11
	{
		...
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_normal_video_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1609_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_normal_video_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_normal_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
	...
	//complete 12 dag
	{
		...
		.mode_setting_table = warhols5kjn5tele_custom23_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom23_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1609_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom23_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom23_setting),
		.hdr_mode = HDR_RAW_DCG_COMPOSE,
		.raw_cnt = 1,
		.exp_cnt = 2,
		.pclk = 920000000,
	...
	//complete 13
	{
		...
		.mode_setting_table = warhols5kjn5tele_custom24_setting,
		.mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom24_setting),
		.seamless_switch_group = SEAMLESS_SWITCH_GROUP_VIDEO_1609_MODE,
		.seamless_switch_mode_setting_table = warhols5kjn5tele_custom24_setting,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(warhols5kjn5tele_custom24_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 920000000,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = WARHOLS5KJN5TELE_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = warhols5kjn5tele_ana_gain_table,
	.ana_gain_table_size = sizeof(warhols5kjn5tele_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.exposure_step = 2,
	.exposure_margin = 12,
	.saturation_info = &warhols5kjn5_saturation_info_10bit,
...
//	.reg_addr_auto_extend = PARAM_UNDEFINED,
	...
	.init_setting_table = warhols5kjn5tele_init_setting,
	.init_setting_len = ARRAY_SIZE(warhols5kjn5tele_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	.get_id = warhols5kjn5tele_get_imgsensor_id,
	.init_ctx = init_ctx,
	.open = common_open,
	.get_info = common_get_info,
	.get_resolution = common_get_resolution,
	.control = warhols5kjn5tele_control,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_DVDD, {1000000, 1000000}, 1000},
	{HW_ID_RST,   {1},       0},
	{HW_ID_MCLK,  {24},	   0},
	{HW_ID_MCLK_DRIVING_CURRENT, {4}, 10000},
};

const struct subdrv_entry warhols5kjn5tele_mipi_raw_entry = {
	.name = "warhols5kjn5tele_mipi_raw",
	.id = WARHOLS5KJN5TELE_SENSOR_ID,
	.pw_seq = pw_seq,
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	switch (switch_group)
	{
		...
		case SEAMLESS_SWITCH_GROUP_HD_CAP_MODE:
...
static int warhols5kjn5tele_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	warhols5kjn5tele_set_long_exposure(ctx);
	/* write framelength */
	if (set_auto_flicker(ctx, 0) || frame_length || !ctx->s_ctx.reg_addr_auto_extend)
		warhols5kjn5tele_write_frame_length(ctx, ctx->frame_length);
	else if (ctx->s_ctx.reg_addr_auto_extend)
		warhols5kjn5tele_write_frame_length(ctx, ctx->min_frame_length);
	/* write shutter */
...
static int warhols5kjn5tele_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	warhols5kjn5tele_set_shutter_frame_length(ctx, para, len);
	return 0;
}
...
static int warhols5kjn5tele_set_multi_dig_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	for (i = 0;
		...
		if (ctx->s_ctx.reg_addr_dig_gain[i].addr[0]) {
			DRV_LOG_MUST(ctx, "write_reg %d times, %4x gain\n", i, rg_gains[i]);
...
void warhols5kjn5tele_update_mode_info(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id)
{
	if (scenario_id >= ctx->s_ctx.sensor_mode_num)
	{
		DRV_LOGE(ctx, "invalid sid:%u, mode_num:%u\n",
...
void warhols5kjn5tele_set_multi_shutter_frame_length_dol(struct subdrv_ctx *ctx,
...
static int warhols5kjn5tele_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (ctx->s_ctx.mode[ctx->current_scenario_id].hdr_mode == HDR_RAW_STAGGER) {
		...
		if ( max(calc_fl[0], calc_fl[1]) > 10384) {
			fll	= max(calc_fl[0], calc_fl[1]) + 4000;
		}

		DRV_LOG(ctx,
			"fll(%u);calc_fl[0](%u) calc_fl[1]%u,exp-LE/ME/SE (%u/%u/%u),shutter-LE/ME/SE (%u/%u/%u)\
			read_margin(%u)\
			readout_length(%d)\n",\
			fll,calc_fl[0],calc_fl[1],ctx->exposure[0],ctx->exposure[1],ctx->exposure[2],\
			(u32)shutters[0], (u32)shutters[1], (u32)shutters[2],\
			ctx->s_ctx.mode[ctx->current_scenario_id].read_margin,\
			ctx->s_ctx.mode[ctx->current_scenario_id].readout_length
		);
...
void warhols5kjn5tele_set_long_exposure(struct subdrv_ctx *ctx)
{
	...
	if (shutter > max_shutter_reg_value) {
		...
		while (ctx->frame_length >= MAX_FL_REG_VALUE) {
			...
			set_i2c_buffer(ctx, ctx->s_ctx.reg_addr_frame_length_lshift, f_shift);
...
void warhols5kjn5tele_write_lens(struct subdrv_ctx *ctx)
{
	u16 len_macro = 0;
	u16 len_inf = 0;
	u8 *pbuf = NULL;
...
static void	set_seamless_dgain(struct subdrv_ctx *ctx, u32 dgain)
{
	u32 reg_dgain = 0;

	reg_dgain = dgain2reg(ctx, dgain);

	subdrv_i2c_wr_u16(ctx, 0xFCFC, 0x4000);

	subdrv_i2c_wr_u16(ctx, ctx->s_ctx.reg_addr_dig_gain[0].addr[0], (reg_dgain) & 0xFFFF);

	DRV_LOG_MUST(ctx, "dgain(%d) reg_dgain(%d) \n",dgain, reg_dgain);
}
...
static int warhols5kjn5tele_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	warhols5kjn5tele_update_mode_info(ctx, scenario_id);
	...
	warhols5kjn5tele_set_awb_gain(ctx, (u8 *)&g_last_awb_gain, &retLen);
	i2c_table_write(ctx,
		ctx->s_ctx.mode[scenario_id].seamless_switch_mode_setting_table,
		ctx->s_ctx.mode[scenario_id].seamless_switch_mode_setting_len);

	if (ctx->s_ctx.mode[scenario_id].ana_gain_max && (ae_ctrl->gain.le_gain > ctx->s_ctx.mode[scenario_id].ana_gain_max))
	{
		set_seamless_dgain(ctx, (1024 * ae_ctrl->gain.le_gain)/ctx->s_ctx.mode[scenario_id].ana_gain_max);
		ae_ctrl->gain.le_gain = ctx->s_ctx.mode[scenario_id].ana_gain_max;
	} else if ( ae_ctrl->gain.le_gain > ctx->s_ctx.mode[scenario_id].multi_exposure_ana_gain_range[0].max){
		set_seamless_dgain(ctx, (1024 * ae_ctrl->gain.le_gain)/ctx->s_ctx.mode[scenario_id].multi_exposure_ana_gain_range[0].max);
		ae_ctrl->gain.le_gain = ctx->s_ctx.mode[scenario_id].multi_exposure_ana_gain_range[0].max;
	} else {
		set_seamless_dgain(ctx, 1024);
	}
	...
	if (ae_ctrl) {
		...
		case HDR_RAW_STAGGER:
			warhols5kjn5tele_set_multi_shutter_frame_length_dol(ctx, (u64 *)&ae_ctrl->exposure, exp_cnt, 0);
			set_multi_gain(ctx, (u32 *)&ae_ctrl->gain, exp_cnt);
			break;
		case HDR_RAW_DCG_COMPOSE:
			set_multi_shutter_frame_length(ctx, (u64 *)&ae_ctrl->exposure, 1, 0);
			warhols5kjn5tele_set_gain(ctx, (u8 *)&ae_ctrl->gain.le_gain,len);
			break;
		default:
			warhols5kjn5tele_set_shutter_frame_length(ctx, (u8 *)&ae_ctrl->exposure.le_exposure,len);
...
//		warhols5kjn5tele_write_lens(ctx);
