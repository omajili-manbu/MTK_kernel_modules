...
static int imx06c_disable_fast_mode(struct subdrv_ctx *ctx);
...
static struct subdrv_ops ops = {
	...
	.disable_fast_mode = imx06c_disable_fast_mode,
};
...
static int imx06c_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	DRV_LOG_MUST(ctx, "get seamless switch i2c start time(%llu)\n",
		seamless_i2c_start_time);
