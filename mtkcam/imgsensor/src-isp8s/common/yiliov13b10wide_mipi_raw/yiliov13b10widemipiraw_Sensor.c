 ...
 * Filename:
 * ---------
 *	 yiliov13b10widemipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "yiliov13b10widemipiraw_Sensor.h"

static void set_group_hold(void *arg, u8 en);
static void yiliov13b10wide_set_dummy(struct subdrv_ctx *ctx);
static int yiliov13b10wide_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int  yiliov13b10wide_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int ultra_vsync_notify(struct subdrv_ctx *ctx, unsigned int sof_cnt, u64 sof_ts);
static int yiliov13b10wide_set_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yiliov13b10wide_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yiliov13b10wide_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yiliov13b10wide_set_multi_dig_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int yiliov13b10wide_get_csi_param(struct subdrv_ctx *ctx, enum SENSOR_SCENARIO_ID_ENUM scenario_id, struct mtk_csi_param *csi_param);

/* STRUCT */
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, yiliov13b10wide_set_test_pattern},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, yiliov13b10wide_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_SET_ESHUTTER, yiliov13b10wide_set_shutter},
	{SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME, yiliov13b10wide_set_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_SHUTTER_FRAME_TIME, yiliov13b10wide_set_multi_shutter_frame_length},
	{SENSOR_FEATURE_SET_MULTI_DIG_GAIN, yiliov13b10wide_set_multi_dig_gain}
};
...
// mode 2: 4208*2368@30fps, noraml video
...
// mode 5: 2104*1184@60fps 60fps video
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
	...
	.iMirrorFlip = 0,
	.i4PosL = {
		{22, 14}, {38, 14}, {14, 18},  {30, 18},
		{22, 30}, {38, 30}, {14, 34},  {30, 34},
	},
	.i4PosR = {
		{22, 10}, {38, 10}, {14, 22},  {30, 22},
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_video =
{
	...
	.iMirrorFlip = 0,
	.i4PosL = {
		{22, 6},  {38, 6}, {14, 10}, {30, 10},
		{22, 22}, {38, 22}, {14, 26}, {30, 26},
	},
	.i4PosR = {
		{22, 2}, {38, 2}, {14, 14}, {30, 14},
...
{\
	...
	.mode_setting_table = yiliov13b10wide_preview_setting,\
	.mode_setting_len = ARRAY_SIZE(yiliov13b10wide_preview_setting),\
...
{\
	...
	.mode_setting_table = yiliov13b10wide_normal_video_setting,\
	.mode_setting_len = ARRAY_SIZE(yiliov13b10wide_normal_video_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
// mode 5: 2048*1152@60fps 60fps video
#define custom1_struct  \
{\
	.frame_desc = frame_desc_custom1,\
	.num_entries = ARRAY_SIZE(frame_desc_custom1),\
	.mode_setting_table = yiliov13b10wide_custom1_setting,\
	.mode_setting_len = ARRAY_SIZE(yiliov13b10wide_custom1_setting),\
	.seamless_switch_group = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_table = PARAM_UNDEFINED,\
	.seamless_switch_mode_setting_len = PARAM_UNDEFINED,\
	.hdr_mode = HDR_NONE,\
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = YILIOV13B10WIDE_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 1,
	.ana_gain_table = yiliov13b10wide_ana_gain_table,
	.ana_gain_table_size = sizeof(yiliov13b10wide_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 4,
	...
	.init_setting_table = yiliov13b10wide_init_setting,
	.init_setting_len = ARRAY_SIZE(yiliov13b10wide_init_setting),
	.mode = mode_struct,
...
static struct subdrv_ops ops = {
	...
	.get_csi_param = yiliov13b10wide_get_csi_param,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_DVDD1,  {1200000, 1200000}, 1000},//dvdd vcam ldo
...
const struct subdrv_entry yiliov13b10wide_mipi_raw_entry = {
	.name = "yiliov13b10wide_mipi_raw",
	.id = YILIOV13B10WIDE_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int yiliov13b10wide_set_shutter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	yiliov13b10wide_set_shutter_frame_length(ctx, para, len);
	return 0;
}
static int yiliov13b10wide_set_multi_shutter_frame_length(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
...
static int yiliov13b10wide_get_csi_param(struct subdrv_ctx *ctx,
	...
	struct mtk_csi_param *csi_param)
{
	...
	default:
		...
		csi_param->dphy_data_settle = 0x0e;
		csi_param->dphy_clk_settle = 0x0e;
