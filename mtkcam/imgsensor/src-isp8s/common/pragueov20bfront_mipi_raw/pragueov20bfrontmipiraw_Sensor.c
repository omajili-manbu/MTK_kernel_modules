 ...
 * Filename:
 * ---------
 *     PRAGUEOV20BFRONTmipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "pragueov20bfrontmipiraw_Sensor.h"


#define DEBUG_LOG_EN 0
#define PFX "PRAGUEOV20BFRONT_camera_sensor"
...
static int pragueov20bfront_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{
		...
		.func = pragueov20bfront_set_test_pattern
	},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	...
	{
		.mode_setting_table = pragueov20bfront_preview_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_preview_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{
		.mode_setting_table = pragueov20bfront_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_normal_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{
		.mode_setting_table = pragueov20bfront_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_hs_video_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{
		.mode_setting_table = pragueov20bfront_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_custom1_setting),
	...
	{
		.mode_setting_table = pragueov20bfront_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_custom2_setting),
		.mode_setting_table_for_md = pragueov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(pragueov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 50000000,
	...
	{
		.mode_setting_table = pragueov20bfront_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_custom3_setting),
		.mode_setting_table_for_md = pragueov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(pragueov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
	...
	{	/* mode : 8  640x480@30FPS */
		.mode_setting_table = pragueov20bfront_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_custom4_setting),
		.mode_setting_table_for_md = pragueov20bfront_md1_setting,
		.mode_setting_len_for_md = ARRAY_SIZE(pragueov20bfront_md1_setting),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
	...
	/* custom 5 mode 9 : 16:10video 30fps 2560x1600@30FPS */
	{
		.mode_setting_table = pragueov20bfront_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_custom5_setting),
		.mode_setting_table_for_md = PARAM_UNDEFINED,
		.mode_setting_len_for_md = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
	...
	/* custom 6 mode 10 : 16:10video 60fps 2560x1600@60FPS */
	{
		.mode_setting_table = pragueov20bfront_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(pragueov20bfront_custom6_setting),
		.mode_setting_table_for_md = PARAM_UNDEFINED,
		.mode_setting_len_for_md = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = PRAGUEOV20BFRONT_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 64,
	.ana_gain_table = pragueov20bfront_ana_gain_table,
	.ana_gain_table_size = sizeof(pragueov20bfront_ana_gain_table),
	.tuning_iso_base = 50,
	.exposure_def = 0x3D0,
	.exposure_min = 2,
	...
	.init_setting_table = pragueov20bfront_init_setting,
	.init_setting_len = ARRAY_SIZE(pragueov20bfront_init_setting),
	.mode = mode_struct,
...
static struct subdrv_pw_seq_entry aov_pw_seq[] = {
	...
	{HW_ID_RST, {0}, 1000},
	{HW_ID_MCLK1_DRIVING_CURRENT, {4}, 1000},
...
const struct subdrv_entry pragueov20bfront_mipi_raw_entry = {
	.name = "pragueov20bfront_mipi_raw",
	.id = PRAGUEOV20BFRONT_SENSOR_ID,
	.pw_seq = pw_seq,
