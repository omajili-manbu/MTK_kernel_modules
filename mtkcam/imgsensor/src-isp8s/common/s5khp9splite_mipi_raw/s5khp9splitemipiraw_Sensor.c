 ...
 *============================================================================
 ****************************************************************************/
#include "s5khp9splitemipiraw_Sensor.h"
...
static int s5khp9splite_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int s5khp9splite_set_test_pattern_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int s5khp9splite_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int vsync_notify(struct subdrv_ctx *ctx,	unsigned int sof_cnt, u64 sof_ts);
static int s5khp9splite_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int s5khp9splite_i3c_pre_config(struct subdrv_ctx *ctx);
static int s5khp9splite_set_ctrl_locker(struct subdrv_ctx *ctx, u32 cid, bool *is_lock);
static int s5khp9splite_chk_streaming_st(void *arg);

static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, s5khp9splite_set_test_pattern},
	{SENSOR_FEATURE_SET_TEST_PATTERN_DATA, s5khp9splite_set_test_pattern_data},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, s5khp9splite_seamless_switch},
	{SENSOR_FEATURE_SET_AWB_GAIN, s5khp9splite_set_awb_gain},
};
...
static struct subdrv_static_ctx_ext_ops static_ext_ops = {
	...
	.chk_streaming_st = s5khp9splite_chk_streaming_st,
};
...
static struct subdrv_ops ops = {
	...
	.i3c_pre_config = s5khp9splite_i3c_pre_config,
	.set_ctrl_locker = s5khp9splite_set_ctrl_locker,
};

const struct subdrv_entry s5khp9splite_mipi_raw_entry = {
	.name = "s5khp9splite_mipi_raw",
	.ops = &ops,
	.is_fw_support = TRUE,
...
static int s5khp9splite_set_ctrl_locker(struct subdrv_ctx *ctx,
