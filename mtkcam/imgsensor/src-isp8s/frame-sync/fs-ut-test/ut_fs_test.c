	...
	for (i = 0;
		...
		default:
			...
			if (g_ext_ctrls[i].do_seamless_switch_at_n_run == g_counter) {
				...
				/* setup seamless switch info */
				seamless_info.seamless_pf_ctrl = *p_pf_ctrl;
				seamless_info.max_fl_lc = 0xffff;
				seamless_info.fl_active_delay = 2;

				seamless_info.prop.ctrl_receive_time_us = 50000;
				...
				seamless_info.prop.with_gph_delay = 1;

				printf(PURPLE
					"[UT seamless ctrl] call seamless switch, g_counter:%u => switch info(fdelay:%u/ctrl_rece:%u/orig_rdoutT:%u/prsh_len_lc:%u/gph_delay:%u)\n"
					NONE,
					g_counter,
					...
					seamless_info.prop.orig_readout_time_us,
					seamless_info.prop.prsh_length_lc,
					seamless_info.prop.with_gph_delay);
