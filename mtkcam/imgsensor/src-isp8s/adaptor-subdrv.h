...
struct subdrv_ctx {
	...
	u32 sw_max_frame_length; /* max frame length by mode assign, for stagger mode to set hw limitation */
	int ana_gain_min;
	int ana_gain_max;
	int ana_gain_step;
	int ana_gain_def;
