 ...
 *============================================================================
 ****************************************************************************/
#define PFX "ARISTOTLEIMX596_camera_sensor"
...
#include "aristotleimx596_ana_gain_table.h"
#include "aristotleimx596mipiraw_Sensor.h"
//#include "aristotleimx596_seamless_switch.h"
#include "aristotleimx596_eeprom.h"
...
//#define aristotleimx596_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u16(__VA_ARGS__)
#define aristotleimx596_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[aristotleimx596]"
...
static kal_uint32 aristotleimx596_awb_gain(struct subdrv_ctx *ctx,
		struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	return ERROR_NONE;
}

static void aristotleimx596_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
{
	IMX596_LOG_DBG("+\n");
	aristotleimx596_table_write_cmos_sensor(ctx, aristotleimx596_init_setting,
		sizeof(aristotleimx596_init_setting)/sizeof(kal_uint16));
...
{
	IMX596_LOG_DBG("+\n");
	aristotleimx596_table_write_cmos_sensor(ctx, aristotleimx596_preview_setting,
		sizeof(aristotleimx596_preview_setting) / sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
} /* preview_setting */
...
{
	IMX596_LOG_DBG("+\n");
	aristotleimx596_table_write_cmos_sensor(ctx, aristotleimx596_normal_video_setting,
		sizeof(aristotleimx596_normal_video_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
...
{
	IMX596_LOG_DBG("+\n");
	aristotleimx596_table_write_cmos_sensor(ctx, aristotleimx596_hs_video_setting,
		sizeof(aristotleimx596_hs_video_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
...
{
	IMX596_LOG_DBG("+\n");
	aristotleimx596_table_write_cmos_sensor(ctx, aristotleimx596_custom1_setting,
		sizeof(aristotleimx596_custom1_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
...
static int vsync_notify(struct subdrv_ctx *ctx, unsigned int sof_cnt)
{
	...
	IMX596_LOG_INF("sensormode(%d) sof_cnt(%d) sensor_output_cnt(%d)\n",
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OUTPUT_FORMAT_BY_SCENARIO:
		...
		IMX596_LOG_DBG("SENSOR_FEATURE_GET_OUTPUT_FORMAT_BY_SCENARIO get:%llu\n",*(feature_data + 1));
	break;
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(aristotleimx596_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)aristotleimx596_ana_gain_table,
			sizeof(aristotleimx596_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		 *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 2200000;
		 break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		aristotleimx596_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry aristotleimx596_mipi_raw_entry = {
	.name = "aristotleimx596_mipi_raw",
	.id = ARISTOTLEIMX596_SENSOR_ID,
	.pw_seq = pw_seq,
