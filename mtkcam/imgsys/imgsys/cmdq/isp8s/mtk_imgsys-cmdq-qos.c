...
#if DVFS_QOS_READY
void mtk_imgsys_mmqos_init_plat8s(struct mtk_imgsys_dev *imgsys_dev)
{
...
void mtk_imgsys_mmqos_uninit_plat8s(struct mtk_imgsys_dev *imgsys_dev)
{
	struct mtk_imgsys_qos *qos_info = &imgsys_dev->qos_info;
	int idx = 0;
...
void mtk_imgsys_mmqos_monitor_plat8s(struct mtk_imgsys_dev *imgsys_dev, u32 state)
{
	struct mtk_imgsys_qos *qos_info = &imgsys_dev->qos_info;
...
void mtk_imgsys_mmqos_set_by_scen_plat8s(struct mtk_imgsys_dev *imgsys_dev,
				...
				bool isSet)
{
	...
	if (imgsys_cmdq_is_stream_off() == 0 && isSet == 1) {
		if (imgsys_qos_dbg_enable_plat8s())
		...
		if (fps) {
			...
			if (cur_interval >= frame_duration &&
				...
				mtk_imgsys_mmqos_monitor_plat8s(imgsys_dev,
...
void mtk_imgsys_mmqos_reset_plat8s(struct mtk_imgsys_dev *imgsys_dev)
{
...
void mtk_imgsys_mmqos_bw_cal_plat8s(struct mtk_imgsys_dev *imgsys_dev,
...
void mtk_imgsys_mmqos_ts_cal_plat8s(struct mtk_imgsys_dev *imgsys_dev,
				struct mtk_imgsys_cb_param *cb_param, uint32_t hw_comb)
{
	...
	if (imgsys_cmdq_is_stream_off() == 0) {
		qos_info = &imgsys_dev->qos_info;
