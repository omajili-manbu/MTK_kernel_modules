...
const struct cust_data imgsys_data_mt6993[] = {
	...
	.imgsys_modules = imgsys_isp8s_modules_mt6993,
	.imgsys_modules_num = MTK_IMGSYS_MODULE_NUM_6993,
...
const struct cust_data imgsys_data_mt6881[] = {
	[0] = {
	.clks = imgsys_isp8s_clks_mt6881,
	.clk_num = MTK_IMGSYS_CLK_NUM_MT6881,
	.module_pipes = module_pipe_isp8s,
	.mod_num = ARRAY_SIZE(module_pipe_isp8s),
	.pipe_settings = pipe_settings_isp8s,
	.pipe_num = ARRAY_SIZE(pipe_settings_isp8s),
	.imgsys_modules = imgsys_isp8s_modules_mt6881,
	.imgsys_modules_num = MTK_IMGSYS_MODULE_NUM_6881,
	.dump = imgsys_debug_dump_routine,
#ifdef IMGSYS_TF_DUMP_8S_C
	.imgsys_ports = imgsys_dma_port_mt6881,
	.imgsys_ports_num = ARRAY_SIZE(imgsys_dma_port_mt6881),
#else
	.imgsys_ports_num = 0,
#endif
	},
