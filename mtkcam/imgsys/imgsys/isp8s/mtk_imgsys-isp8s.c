...
int imgsys_omc_dbg_en;
module_param(imgsys_omc_dbg_en, int, 0644);

int imgsys_me_dbg_en;
module_param(imgsys_me_dbg_en, int, 0644);

int imgsys_mae_dbg_en;
module_param(imgsys_mae_dbg_en, int, 0644);

int imgsys_dfp_dbg_en;
module_param(imgsys_dfp_dbg_en, int, 0644);
...
static const struct of_device_id mtk_imgsys_of_match[] = {
	{ .compatible = "mediatek,imgsys-isp8s-mt6993", .data = (void *)&imgsys_data_mt6993},
	{ .compatible = "mediatek,imgsys-isp8s-mt6881", .data = (void *)&imgsys_data_mt6881},
	{}
};
