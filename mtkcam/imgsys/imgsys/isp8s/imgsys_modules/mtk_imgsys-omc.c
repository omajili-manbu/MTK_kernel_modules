...
#define OMC_REG_DMATOP_DMA_DBG_SEL    (0xEA8)
			...
			unsigned int mode)
{
	...
	if (priv_data->need_update_desc) {
		...
		omc_buf_info.offset = priv_data->desc_offset;
		omc_buf_info.len =
	...
	if (priv_data->need_flush_tdr) {
		...
		omc_buf_info.offset = priv_data->tdr_offset;
...
for (i = 0x1d; i <= 0x20; i += 2) {
	...
	/* core debug (0~8) */
	for (i = 0; i < 9; i++) {
		writel((0x5<<12) | (i<<8), (omcRegBA + OMC_REG_DBG_SET + ofst));
		sel_value[i] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_SET + ofst));
		debug_value[i] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));
	}
	...
	/* DMA debug info */
	pr_info("%s:DMA debug info (veci,veci2.wpeo,wpeo2,wmask) ready/req/line cnt/pixel cnt info",__func__);

	writel((0xE << 12) | 0, (omcRegBA + OMC_REG_DBG_SET + ofst));
	sel_value[0] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_SET + ofst));
	debug_value[0] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0xE << 12) | 1, (omcRegBA + OMC_REG_DBG_SET + ofst));
	sel_value[1] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_SET + ofst));
	debug_value[1] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0xE << 12) | 5, (omcRegBA + OMC_REG_DBG_SET + ofst));
	sel_value[2] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_SET + ofst));
	debug_value[2] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0xE << 12) | 6, (omcRegBA + OMC_REG_DBG_SET + ofst));
	sel_value[3] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_SET + ofst));
	debug_value[3] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0xE << 12) | 7, (omcRegBA + OMC_REG_DBG_SET + ofst));
	sel_value[4] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_SET + ofst));
	debug_value[4] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0xE << 12) | 9, (omcRegBA + OMC_REG_DBG_SET + ofst));
	sel_value[5] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_SET + ofst));
	debug_value[5] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	pr_info("%s:[dbg_sel:0x%x]dbg_port:0x%x, [0x%x]0x%x, [0x%x]0x%x, [0x%x]0x%x, [0x%x]0x%x, [0x%x]0x%x, [0x%x]0x%x",
		__func__, (OMC_REG_DBG_SET + ofst), (OMC_REG_DBG_PORT + ofst),
		sel_value[0], debug_value[0], sel_value[1], debug_value[1], sel_value[2], debug_value[2],
		sel_value[3], debug_value[3], sel_value[4], debug_value[4], sel_value[5], debug_value[5]);

	writel((0x1 << 12) | 0, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[0] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[0] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x1 << 12) | 1, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[1] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[1] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x1 << 12) | 5, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[2] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[2] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x1 << 12) | 6, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[3] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[3] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x1 << 12) | 7, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[4] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[4] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	pr_info("%s:[dbg_sel:0x%x]dbg_port:0x%x, [0x%x]0x%x, [0x%x]0x%x, [0x%x]0x%x, [0x%x]0x%x, [0x%x]0x%x,",
		__func__, (OMC_REG_DMATOP_DMA_DBG_SEL + ofst), (OMC_REG_DBG_PORT + ofst),
		sel_value[0], debug_value[0], sel_value[1], debug_value[1], sel_value[2], debug_value[2],
		sel_value[3], debug_value[3], sel_value[4], debug_value[4]);

	writel((0x2 << 12) | 0, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[0] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[0] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x2 << 12) | 1, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[1] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[1] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x2 << 12) | 5, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[2] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[2] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x2 << 12) | 6, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[3] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[3] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x2 << 12) | 7, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[4] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[4] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));
	...
	writel((0x3 << 12) | 0, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[0] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[0] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x3 << 12) | 1, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[1] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[1] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x3 << 12) | 5, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[2] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[2] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x3 << 12) | 6, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[3] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[3] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));

	writel((0x3 << 12) | 7, (omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	sel_value[4] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DMATOP_DMA_DBG_SEL + ofst));
	debug_value[4] = (unsigned int)ioread32((void *)(omcRegBA + OMC_REG_DBG_PORT + ofst));
