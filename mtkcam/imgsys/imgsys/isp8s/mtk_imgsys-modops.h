...
const struct module_ops imgsys_isp8s_modules_mt6993[] = {
	...
	[IMGSYS_MOD_DIP] = {
		...
		.updatecq = NULL,
		.update_wbuf = imgsys_dip_updatecq,
		.cmdq_set = imgsys_dip_cmdq_set_hw_initial_value,
		.chk_pwr = imgsys_dip_check_power_domain,
	...
	[IMGSYS_MOD_PQDIP] = {
		...
		.updatecq = NULL,
		.update_wbuf = imgsys_pqdip_updatecq,
	...
	[IMGSYS_MOD_ME] = {
		...
		.set = imgsys_me_set_hw_initial_value,
		.updatecq = NULL,
		.update_wbuf = imgsys_me_updatecq,
		.cmdq_set = imgsys_me_cmdq_set_hw_initial_value,
		.chk_pwr = NULL,
	...
	[IMGSYS_MOD_WPE] = {
		...
		.updatecq = NULL,
		.update_wbuf = imgsys_wpe_updatecq,
	...
	[IMGSYS_MOD_OMC] = {
		.module_id = IMGSYS_MOD_OMC,
		.init = imgsys_omc_set_initial_value,
		.set = imgsys_omc_set_hw_initial_value,
		.updatecq = NULL,
		.update_wbuf = imgsys_omc_updatecq,
		.cmdq_set = imgsys_omc_cmdq_set_hw_initial_value,
		.chk_pwr = NULL,
		.dump = imgsys_omc_debug_dump,
		.done_chk = imgsys_omc_done_chk,
		.uninit = imgsys_omc_uninit,
	},
	[IMGSYS_MOD_ADL] = {
	...
	[IMGSYS_MOD_DFP] = {
		...
		.updatecq = NULL,
		.cmdq_set = imgsys_dfp_cmdq_set_hw_initial_value,
		.chk_pwr = NULL,
...
const struct module_ops imgsys_isp8s_modules_mt6881[] = {
	[IMGSYS_MOD_TRAW] = {
		.module_id = IMGSYS_MOD_TRAW,
		.init = imgsys_traw_set_initial_value,
		.set = imgsys_traw_set_initial_value_hw,
...
#define MTK_IMGSYS_MODULE_NUM_6993	ARRAY_SIZE(imgsys_isp8s_modules_mt6993)
#define MTK_IMGSYS_MODULE_NUM_6881	ARRAY_SIZE(imgsys_isp8s_modules_mt6881)
