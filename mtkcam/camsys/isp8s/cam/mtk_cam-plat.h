...
struct plat_v4l2_data {
	...
	int (*get_slave_sv_idx)(int *slave_sv_idx);
	int (*get_single_sv_opp_idx)(unsigned int *opp_idx);
	int (*is_sv_pdp_supported)(unsigned int sv_id, unsigned int tag_idx, bool *is_supported);
	/* mraw */
...
struct plat_data_hw {
	 ...
	 */
	bool has_pixel_mode_constraints;
...
/* platform data list */
	...
	extern struct camsys_platform_data mt6993_data;
#endif

#ifdef CAMSYS_ISP8S_MT6881
	extern struct camsys_platform_data mt6881_data;
#endif
