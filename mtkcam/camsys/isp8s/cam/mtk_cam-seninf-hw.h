...
struct mtk_cam_seninf_ops {
	...
	int (*_set_outmux_rdy_msk_cq_rdy_status)(struct seninf_ctx *ctx, u8 outmux, bool rdy_status);
	...
	int (*_get_outmux_curr_tag_vc_by_tag)(struct seninf_ctx *ctx, u8 outmux, u8 tag_id, u8 *vc, bool *vc_en);
