...
static int get_slave_sv_idx(int *slave_sv_idx)
{
	*slave_sv_idx = -1;
...
static int is_sv_pdp_supported(unsigned int sv_id, unsigned int tag_idx,
	bool *is_supported)
{
	if (tag_idx >= 6)
		*is_supported = false;
	else if (sv_id == 0 || sv_id == 1)
		*is_supported = (tag_idx == 4);
	else
		*is_supported = false;
...
{
	const unsigned int max_fifo_img_p1[CAMSV_END] = {1024, 896, 384, 0, 0, 0};
	const unsigned int max_fifo_img_p2[CAMSV_END] = {896, 896, 0, 0, 0, 0};
	const unsigned int max_fifo_img_p3[CAMSV_END] = {0, 0, 0, 0, 0, 0};

	if (dev_id >= CAMSV_2) {
		pr_info("%s unexpected dev_id(%d) only camsv a/b need fifo monitor\n",
			__func__, dev_id);
		*fifo_core1 = 0;
		*fifo_core2 = 0;
		*fifo_core3 = 0;
...
static int module_base[] = {
	[CAM_VCORE]     = 0x1B80D000,
	[CAM_MAIN_RAWA] = 0x1a7d0000,
	[CAM_MAIN_RAWB] = 0x1a9d0000,
	[CAM_MAIN_RAWC] = 0x0,
	[CAM_MAIN_RMSA] = 0x1a7f0000,
	[CAM_MAIN_RMSB] = 0x1a9f0000,
	[CAM_MAIN_RMSC] = 0x0,
	[CAM_MAIN_YUVA] = 0x1a810000,
	[CAM_MAIN_YUVB] = 0x1aa10000,
	[CAM_MAIN_YUVC] = 0x0,
	[CAM_MRAW] = 0x1a680000,
	[PM_RAWA] = 0x0,
	[PM_RAWB] = 0x0,
...
static const struct plat_v4l2_data mt6881_v4l2_data = {
	.raw_pipeline_num = 2,
	...
	.timestamp_buffer_ofst = offsetof(struct mtk_cam_uapi_meta_raw_stats_0,
					  timestamp),
	.shading_tbl_ofst = 0x4468, /* TODO: check shading table offset */
	.reserved_camsv_dev_id = 0,
	...
	.get_slave_sv_idx = get_slave_sv_idx,
	...
	.is_sv_pdp_supported = is_sv_pdp_supported,
};

static const struct plat_data_hw mt6881_hw_data = {
	.cammux_id_raw_start = 3,  /* TBC(AY) */
	...
	.bwr_support = false,
	.qof_support = false,
	.qos_remap_support = false,
	.dvc_support = false,
	.fmon_support = false,
	.rms_mtc_freerun_support = false,
	.max_main_pipe_w = 6632,
	.max_main_pipe_twin_w = 6200,
	.pixel_mode_max = 1,
	.has_pixel_mode_constraints = true,
	.default_opp_freq_hz = 564000000,
	.default_opp_volt_uv = 650000,
};

struct camsys_platform_data mt6881_data = {
	.platform = "mt6881",
	.v4l2 = &mt6881_v4l2_data,
	.hw = &mt6881_hw_data,
};
