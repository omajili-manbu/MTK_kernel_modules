...
/* ISP8 */
static __maybe_unused struct dma_debug_item dbg_LSCI_R1[] = {
	{0x00000012, "lsci_r1 32(hex) 0000"},
	{0x00000112, "lsci_r1 state_checksum"},
	{0x00000212, "lsci_r1 line_pix_cnt_tmp"},
	{0x00000312, "lsci_r1 line_pix_cnt"},
	{0x00000412, "lsci_r1 important_status"},
	{0x00000512, "lsci_r1 cmd_data_cnt"},
	{0x00000612, "lsci_r1 tilex_byte_cnt"},
	{0x00000712, "lsci_r1 tiley_cnt"},
	{0x00000812, "lsci_r1 burst_line_cnt"},
};

static __maybe_unused struct dma_debug_item dbg_LSCI_R2[] = {
	{0x00000013, "lsci_r2 32(hex) 0000"},
	{0x00000113, "lsci_r2 state_checksum"},
	{0x00000213, "lsci_r2 line_pix_cnt_tmp"},
	{0x00000313, "lsci_r2 line_pix_cnt"},
	{0x00000413, "lsci_r2 important_status"},
	{0x00000513, "lsci_r2 cmd_data_cnt"},
	{0x00000613, "lsci_r2 tilex_byte_cnt"},
	{0x00000713, "lsci_r2 tiley_cnt"},
	{0x00000813, "lsci_r2 burst_line_cnt"},
};

static __maybe_unused struct dma_debug_item dbg_cq_bus[] = {
	{0x00000087, "cq bus d135"},
	{0x00000088, "cq bus d136"},
	{0x000000AF, "cq bus d175"},
	{0x000000B0, "cq bus d176"},
};
