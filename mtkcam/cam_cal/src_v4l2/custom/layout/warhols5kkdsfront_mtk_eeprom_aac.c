...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF67, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT warhols5kkdsfront_mtk_eeprom_aac = {
	.name = "warhols5kkdsfront_mtk_eeprom_aac",
