...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF3BFD61, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x000012D6, 0x000005DE, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT yiliov13b10wide_mtk_eeprom_qtech = {
	.name = "yiliov13b10wide_mtk_eeprom_qtech",
