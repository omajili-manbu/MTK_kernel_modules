...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF67116c, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001CF4, 0x00000A28, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT warholovx9500wide_mtk_eeprom_aac = {
	.name = "warholovx9500wide_mtk_eeprom_aac",
