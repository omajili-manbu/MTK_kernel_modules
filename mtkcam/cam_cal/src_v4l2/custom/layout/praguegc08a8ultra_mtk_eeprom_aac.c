...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00001508, 0x0000009A, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x000014D0, 0x0000000F, xiaomi_do_module_version},
		{0x00000001, 0x00001548, 0x00000010, xiaomi_do_part_number},
		{0x00000001, 0x00004EC8, 0x0000074C, xiaomi_do_single_lsc},
		{0x00000001, 0x00004E08, 0x00000010, xiaomi_do_2a_gain},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT praguegc08a8ultra_mtk_eeprom_aac = {
	.name = "praguegc08a8ultra_mtk_eeprom_aac",
	.check_layout_function = layout_check,
	.read_function = PRAGUE_GC08A8_OTP_read_region,
